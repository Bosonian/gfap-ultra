(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function e(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=e(n);fetch(n.href,r)}})();class X{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{},screenHistory:[]},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}notify(){this.listeners.forEach(t=>t(this.state))}getState(){return{...this.state}}setState(t){this.state={...this.state,...t},this.notify()}navigate(t){console.log(`Navigating from ${this.state.currentScreen} to ${t}`);const e=[...this.state.screenHistory];this.state.currentScreen!==t&&!e.includes(this.state.currentScreen)&&e.push(this.state.currentScreen),this.setState({currentScreen:t,screenHistory:e})}goBack(){const t=[...this.state.screenHistory];if(console.log("goBack() - current history:",t),console.log("goBack() - current screen:",this.state.currentScreen),t.length>0){const e=t.pop();return console.log("goBack() - navigating to:",e),this.setState({currentScreen:e,screenHistory:t}),!0}return console.log("goBack() - no history available"),!1}goHome(){this.setState({currentScreen:"triage1",screenHistory:[]})}setFormData(t,e){const a={...this.state.formData};a[t]={...e},this.setState({formData:a})}getFormData(t){return this.state.formData[t]||{}}setValidationErrors(t){this.setState({validationErrors:t})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(t){this.setState({results:t})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const t={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{},screenHistory:[]};this.setState(t),console.log("Store reset with new session:",t.sessionId)}logEvent(t,e={}){const a={timestamp:Date.now(),session:this.state.sessionId,event:t,data:e};console.log("Event:",a)}getSessionDuration(){return Date.now()-this.state.startTime}}const u=new X;function f(i){const t=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let e='<div class="progress-indicator">';return t.forEach((a,n)=>{const r=a.id===i,o=a.id<i;e+=`
  ...
  `}function ue(i){const t=document.getElementById("useGpsButton"),e=document.getElementById("manualLocationButton"),a=document.querySelector(".location-manual"),n=document.getElementById("locationInput"),r=document.getElementById("searchLocationButton"),o=document.getElementById("strokeCenterResults");t&&t.addEventListener("click",()=>{me(i,o)}),e&&e.addEventListener("click",()=>{a.style.display=a.style.display==="none"?"block":"none"}),r&&r.addEventListener("click",()=>{const c=n.value.trim();c&&x(c,i,o)}),n&&n.addEventListener("keypress",c=>{if(c.key==="Enter"){const l=n.value.trim();l&&x(l,i,o)}})}function me(i,t){if(!navigator.geolocation){L(s("geolocationNotSupported"),t);return}t.innerHTML=`<div class="loading">${s("gettingLocation")}...</div>`,navigator.geolocation.getCurrentPosition(e=>{const{latitude:a,longitude:n}=e.coords;N(a,n,i,t)},e=>{let a=s("locationError");switch(e.code){case e.PERMISSION_DENIED:a=s("locationPermissionDenied");break;case e.POSITION_UNAVAILABLE:a=s("locationUnavailable");break;case e.TIMEOUT:a=s("locationTimeout");break}L(a,t)},{enableHighAccuracy:!0,timeout:1e4,maximumAge:3e5})}async function x(i,t,e){e.innerHTML=`<div class="loading">${s("searchingLocation")}...</div>`;const a=/^(-?\d+\.?\d*)\s*,\s*(-?\d+\.?\d*)$/,n=i.trim().match(a);if(n){const r=parseFloat(n[1]),o=parseFloat(n[2]);if(r>=47.2&&r<=55.1&&o>=5.9&&o<=15){e.innerHTML=`
        <div class="location-success">
          <p>📍 Coordinates: ${r.toFixed(4)}, ${o.toFixed(4)}</p>
        </div>
      `,setTimeout(()=>{N(r,o,t,e)},500);return}else{L("Coordinates appear to be outside Germany. Please check the values.",e);return}}try{let r=i.trim();!r.toLowerCase().includes("bayern")&&!r.toLowerCase().includes("bavaria")&&!r.toLowerCase().includes("deutschland")&&!r.toLowerCase().includes("germany")&&(r=r+", Bayern, Deutschland");const c=`https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(r)}&countrycodes=de&format=json&limit=3&addressdetails=1`,l=await fetch(c,{method:"GET",headers:{Accept:"application/json","User-Agent":"iGFAP-StrokeTriage/2.1.0"}});if(!l.ok)throw new Error(`Geocoding API error: ${l.status}`);const d=await l.json();if(d&&d.length>0){let m=d[0];for(const b of d)if(b.address&&b.address.state==="Bayern"){m=b;break}const h=parseFloat(m.lat),y=parseFloat(m.lon),T=m.display_name||i;e.innerHTML=`
        <div class="location-success">
          <p>📍 Found: ${T}</p>
  ...
  `;try{const o=await ce(i,t,n),c=`
    ...
    `;a.innerHTML=c}catch(o){console.warn("Travel time calculation failed, falling back to distance:",o);const c=de(i,t,n),l=`
      <div class="location-info">
        <p><strong>${s("yourLocation")}:</strong> ${i.toFixed(4)}, ${t.toFixed(4)}</p>
        ${r}
      </div>
  ...
  `:""}function j(i,t,e){if(!t)return"";const a=Math.round((t.probability||0)*100),n=he(a,i),r=a>D[i].critical,o=a>D[i].high,c={ich:"🩸",lvo:"🧠"},l={ich:s("ichProbability"),lvo:s("lvoProbability")},d={ich:"ICH",lvo:S.getCurrentLanguage()==="de"?"Großgefäßverschluss":"Large Vessel Occlusion"};return`
  ...
  `}function ve(i,t){const{ich:e,lvo:a}=i,n=(e==null?void 0:e.module)==="Limited"||(e==null?void 0:e.module)==="Coma"||(a==null?void 0:a.notPossible)===!0;return e==null||e.module,n?fe(e):be(e,a)}function fe(i,t,e){const a=i&&i.probability>.6?V():"",n=q(),r=W();return`
    <div class="container">
      ${f(3)}
  ...
  `}function be(i,t,e,a){const n=Math.round(((i==null?void 0:i.probability)||0)*100),r=Math.round(((t==null?void 0:t.probability)||0)*100),o=i&&i.probability>.6?V():"",c=q(),l=W(),d=n<30&&r>50;return`
    <div class="container">
      ${f(3)}
...
//# sourceMappingURL=index-CmSY4eIt.js.map
