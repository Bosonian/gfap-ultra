(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=e(a);fetch(a.href,n)}})();class A{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{}},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}notify(){this.listeners.forEach(t=>t(this.state))}getState(){return{...this.state}}setState(t){this.state={...this.state,...t},this.notify()}navigate(t){console.log(`Navigating from ${this.state.currentScreen} to ${t}`),this.setState({currentScreen:t})}setFormData(t,e){const s={...this.state.formData};s[t]={...e},this.setState({formData:s})}getFormData(t){return this.state.formData[t]||{}}setValidationErrors(t){this.setState({validationErrors:t})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(t){this.setState({results:t})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const t={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{}};this.setState(t),console.log("Store reset with new session:",t.sessionId)}logEvent(t,e={}){const s={timestamp:Date.now(),session:this.state.sessionId,event:t,data:e};console.log("Event:",s)}getSessionDuration(){return Date.now()-this.state.startTime}}const d=new A;function f(i){const t=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let e='<div class="progress-indicator">';return t.forEach((s,a)=>{const n=s.id===i,r=s.id<i;e+=`
  ...
  `;return s.positive.length>0&&s.positive.forEach(n=>{const r=Math.abs(n.weight*100),o=Math.min(r*2,100);a+=`
    ...
    `),a+="</div>",a}function E(i,t){const e=Number(i),s=g[t];return e>=s.critical?"🔴 CRITICAL RISK":e>=s.high?"🟠 HIGH RISK":e>=30?"🟡 MODERATE RISK":"🟢 LOW RISK"}function N(i,t){const{ich:e,lvo:s}=i;let a="",n="";if(e){const c=Math.round(e.probability*100);a=`
      <div class="result-card ${c>g.ich.critical?"critical":"ich"}">
        ...
        <p><strong>Risk Level:</strong> ${E(c,"ich")}</p>
      </div>
    `}if(s)if(s.notPossible)n=`
      ...
      `;else{const c=Math.round(s.probability*100);n=`
        <div class="result-card ${c>g.lvo.critical?"critical":"lvo"}">
          ...
          <p><strong>Risk Level:</strong> ${E(c,"lvo")}</p>
        </div>
      `}const r=e&&e.probability>.6?M():"",o=q(e,s);return`
    <div class="container">
      ${f(3)}
  ...
  `}function j(i,t,e){const s=[];return e.required&&!t&&t!==0&&s.push("This field is required"),e.min!==void 0&&t!==""&&!isNaN(t)&&parseFloat(t)<e.min&&s.push(`Value must be at least ${e.min}`),e.max!==void 0&&t!==""&&!isNaN(t)&&parseFloat(t)>e.max&&s.push(`Value must be at most ${e.max}`),e.pattern&&!e.pattern.test(t)&&s.push("Invalid format"),s}function z(i){let t=!0;const e={};return Object.entries(C).forEach(([s,a])=>{const n=i.elements[s];if(n){const r=j(s,n.value,a);r.length>0&&(e[s]=r,t=!1)}}),{isValid:t,validationErrors:e}}function V(i,t){Object.entries(t).forEach(([e,s])=>{const a=i.querySelector(`[name="${e}"]`);if(a){const n=a.closest(".input-group");if(n){n.classList.add("error"),n.querySelectorAll(".error-message").forEach(o=>o.remove());const r=document.createElement("div");r.className="error-message",r.innerHTML=`<span class="error-icon">⚠️</span> ${s[0]}`,n.appendChild(r)}}})}function B(i){i.querySelectorAll(".input-group.error").forEach(t=>{t.classList.remove("error"),t.querySelectorAll(".error-message").forEach(e=>e.remove())})}class m extends Error{constructor(t,e,s){super(t),this.name="APIError",this.status=e,this.url=s}}function y(i){const t={...i};return Object.keys(t).forEach(e=>{const s=t[e];(typeof s=="boolean"||s==="on"||s==="true"||s==="false")&&(t[e]=s===!0||s==="on"||s==="true"?1:0)}),t}async function k(i,t){const e=new AbortController,s=setTimeout(()=>e.abort(),v.requestTimeout);try{const a=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t),signal:e.signal,mode:"cors"});if(clearTimeout(s),!a.ok){let r=`HTTP ${a.status}`;try{const o=await a.json();r=o.error||o.message||r}catch{r=`${r}: ${a.statusText}`}throw new m(r,a.status,i)}return await a.json()}catch(a){throw clearTimeout(s),a.name==="AbortError"?new m("Request timeout - please try again",408,i):a instanceof m?a:new m("Network error - please check your connection and try again",0,i)}}async function G(i){const t=y(i);try{const e=await k(h.COMA_ICH,t);return{probability:e.probability||e.ich_probability,drivers:e.drivers||null,confidence:e.confidence||.75,module:"Coma"}}catch(e){throw console.error("Coma ICH prediction failed:",e),new m(`Failed to get ICH prediction: ${e.message}`,e.status,h.COMA_ICH)}}async function U(i){const t=y(i);try{const e=await k(h.LDM_ICH,t);return{probability:e.probability||e.ich_probability,drivers:e.drivers||null,confidence:e.confidence||.65,module:"Limited Data"}}catch(e){throw console.error("Limited Data ICH prediction failed:",e),new m(`Failed to get ICH prediction: ${e.message}`,e.status,h.LDM_ICH)}}async function K(i){var s,a,n,r,o,c;const t={age_years:i.age_years,systolic_bp:i.systolic_bp,diastolic_bp:i.diastolic_bp,gfap_value:i.gfap_value,fast_ed_score:i.fast_ed_score,headache:i.headache||0,vigilanzminderung:i.vigilanzminderung||0,armparese:i.armparese||0,beinparese:i.beinparese||0,eye_deviation:i.eye_deviation||0,atrial_fibrillation:i.atrial_fibrillation||0,anticoagulated_noak:i.anticoagulated_noak||0,antiplatelets:i.antiplatelets||0},e=y(t);try{const l=await k(h.FULL_STROKE,e),u={probability:l.ich_probability||((s=l.ich)==null?void 0:s.probability),drivers:l.ich_drivers||((a=l.ich)==null?void 0:a.drivers),confidence:l.ich_confidence||((n=l.ich)==null?void 0:n.confidence)||.85,module:"Full Stroke"},b={probability:l.lvo_probability||((r=l.lvo)==null?void 0:r.probability),drivers:l.lvo_drivers||((o=l.lvo)==null?void 0:o.drivers),confidence:l.lvo_confidence||((c=l.lvo)==null?void 0:c.confidence)||.85,module:"Full Stroke"};return{ich:u,lvo:b}}catch(l){throw console.error("Full Stroke prediction failed:",l),new m(`Failed to get stroke predictions: ${l.message}`,l.status,h.FULL_STROKE)}}function Y(i){d.logEvent("triage1_answer",{comatose:i}),_(i?"coma":"triage2")}function J(i){d.logEvent("triage2_answer",{examinable:i}),_(i?"full":"limited")}function _(i){d.logEvent("navigate",{from:d.getState().currentScreen,to:i}),d.navigate(i),window.scrollTo(0,0)}function W(){d.hasUnsavedData()&&!confirm("Are you sure you want to start over? All entered data will be lost.")||(d.logEvent("reset"),d.reset())}async function Q(i,t){i.preventDefault();const e=i.target,s=e.dataset.module,a=z(e);if(!a.isValid){V(t,a.validationErrors);return}const n=new FormData(e),r={};n.forEach((l,u)=>{const b=e.elements[u];if(b&&b.type==="checkbox")r[u]=b.checked;else{const w=parseFloat(l);r[u]=isNaN(w)?l:w}}),d.setFormData(s,r);const o=e.querySelector("button[type=submit]"),c=o?o.innerHTML:"";o&&(o.disabled=!0,o.innerHTML='<span class="loading-spinner"></span> Analyzing...');try{let l;switch(s){case"coma":l={ich:await G(r),lvo:null};break;case"limited":l={ich:await U(r),lvo:{notPossible:!0}};break;case"full":l=await K(r);break;default:throw new Error("Unknown module: "+s)}d.setResults(l),d.logEvent("models_complete",{module:s,results:l}),_("results")}catch(l){console.error("Error running models:",l);let u="An error occurred during analysis. Please try again.";l instanceof m&&(u=l.message),X(t,u),o&&(o.disabled=!1,o.innerHTML=c)}}function X(i,t){i.querySelectorAll(".critical-alert").forEach(a=>{var n,r;(r=(n=a.querySelector("h4"))==null?void 0:n.textContent)!=null&&r.includes("Error")&&a.remove()});const e=document.createElement("div");e.className="critical-alert",e.innerHTML=`<h4><span class="alert-icon">⚠️</span> Error</h4><p>${t}</p>`;const s=i.querySelector(".container");s?s.prepend(e):i.prepend(e),setTimeout(()=>e.remove(),1e4)}function Z(i){const t=document.createElement("div");t.className="sr-only",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");const e={triage1:"Coma assessment",triage2:"Examination capability assessment",coma:"Coma module",limited:"Limited data module",full:"Full stroke assessment",results:"Assessment results"};t.textContent=`Navigated to ${e[i]||i}`,document.body.appendChild(t),setTimeout(()=>t.remove(),1e3)}function ee(i){const t={triage1:"Initial Assessment - Stroke Triage Assistant",triage2:"Examination Capability - Stroke Triage Assistant",coma:"Coma Module - Stroke Triage Assistant",limited:"Limited Data Module - Stroke Triage Assistant",full:"Full Stroke Module - Stroke Triage Assistant",results:"Assessment Results - Stroke Triage Assistant"};document.title=t[i]||"Stroke Triage Assistant"}function te(){setTimeout(()=>{const i=document.querySelector("h2");i&&(i.setAttribute("tabindex","-1"),i.focus(),setTimeout(()=>i.removeAttribute("tabindex"),100))},100)}function L(i){const t=d.getState(),{currentScreen:e,results:s,startTime:a}=t;i.innerHTML="";let n="";switch(e){case"triage1":n=S();break;case"triage2":n=I();break;case"coma":n=D();break;case"limited":n=T();break;case"full":n=$();break;case"results":n=N(s);break;default:n=S()}i.innerHTML=n;const r=i.querySelector("form[data-module]");if(r){const o=r.dataset.module;ie(r,o)}se(i),Z(e),ee(e),te()}function ie(i,t){const e=d.getFormData(t);!e||Object.keys(e).length===0||Object.entries(e).forEach(([s,a])=>{const n=i.elements[s];n&&(n.type==="checkbox"?n.checked=a===!0||a==="on"||a==="true":n.value=a)})}function se(i){i.querySelectorAll('input[type="number"]').forEach(e=>{e.addEventListener("blur",()=>{B(i)})}),i.querySelectorAll("[data-action]").forEach(e=>{e.addEventListener("click",s=>{const{action:a,value:n}=s.currentTarget.dataset,r=n==="true";switch(a){case"triage1":Y(r);break;case"triage2":J(r);break;case"reset":W();break}})}),i.querySelectorAll("form[data-module]").forEach(e=>{e.addEventListener("submit",s=>{Q(s,i)})});const t=i.querySelector("#printResults");t&&t.addEventListener("click",()=>window.print())}class ae{constructor(){this.container=null,this.unsubscribe=null}async init(){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.init());return}if(this.container=document.getElementById("appContainer"),!this.container){console.error("App container not found");return}this.unsubscribe=d.subscribe(()=>{L(this.container)}),this.setupGlobalEventListeners(),this.initializeTheme(),this.startAutoSave(),this.setupSessionTimeout(),this.setCurrentYear(),L(this.container),console.log("Stroke Triage Assistant initialized")}setupGlobalEventListeners(){const t=document.getElementById("darkModeToggle");t&&t.addEventListener("click",()=>this.toggleDarkMode()),this.setupHelpModal(),this.setupFooterLinks(),document.addEventListener("keydown",e=>{if(e.key==="Escape"){const s=document.getElementById("helpModal");s&&s.classList.contains("show")&&(s.classList.remove("show"),s.setAttribute("aria-hidden","true"))}}),window.addEventListener("beforeunload",e=>{d.hasUnsavedData()&&(e.preventDefault(),e.returnValue="You have unsaved data. Are you sure you want to leave?")})}setupHelpModal(){const t=document.getElementById("helpButton"),e=document.getElementById("helpModal"),s=e==null?void 0:e.querySelector(".modal-close");t&&e&&(t.addEventListener("click",()=>{e.classList.add("show"),e.setAttribute("aria-hidden","false")}),s==null||s.addEventListener("click",()=>{e.classList.remove("show"),e.setAttribute("aria-hidden","true")}),e.addEventListener("click",a=>{a.target===e&&(e.classList.remove("show"),e.setAttribute("aria-hidden","true"))}))}setupFooterLinks(){var t,e;(t=document.getElementById("privacyLink"))==null||t.addEventListener("click",s=>{s.preventDefault(),this.showPrivacyPolicy()}),(e=document.getElementById("disclaimerLink"))==null||e.addEventListener("click",s=>{s.preventDefault(),this.showDisclaimer()})}initializeTheme(){const t=localStorage.getItem("theme"),e=document.getElementById("darkModeToggle");(t==="dark"||!t&&window.matchMedia("(prefers-color-scheme: dark)").matches)&&(document.body.classList.add("dark-mode"),e&&(e.textContent="☀️"))}toggleDarkMode(){const t=document.getElementById("darkModeToggle");document.body.classList.toggle("dark-mode");const e=document.body.classList.contains("dark-mode");t&&(t.textContent=e?"☀️":"🌙"),localStorage.setItem("theme",e?"dark":"light")}startAutoSave(){setInterval(()=>{this.saveCurrentFormData()},v.autoSaveInterval)}saveCurrentFormData(){this.container.querySelectorAll("form[data-module]").forEach(e=>{const s=new FormData(e),a=e.dataset.module;if(a){const n={};s.forEach((c,l)=>{const u=e.elements[l];u&&u.type==="checkbox"?n[l]=u.checked:n[l]=c});const r=d.getFormData(a);JSON.stringify(r)!==JSON.stringify(n)&&d.setFormData(a,n)}})}setupSessionTimeout(){setTimeout(()=>{confirm("Your session has been idle for 30 minutes. Would you like to continue?")?this.setupSessionTimeout():d.reset()},v.sessionTimeout)}setCurrentYear(){const t=document.getElementById("currentYear");t&&(t.textContent=new Date().getFullYear())}showPrivacyPolicy(){alert("Privacy Policy: This tool processes data locally. No patient data is stored or transmitted.")}showDisclaimer(){alert("Medical Disclaimer: This tool is for clinical decision support only. Always use clinical judgment and follow local protocols.")}destroy(){this.unsubscribe&&this.unsubscribe()}}const ne=new ae;ne.init();
//# sourceMappingURL=index-BDfNn8f-.js.map
