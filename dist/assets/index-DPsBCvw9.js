var Ee=Object.defineProperty;var Le=(a,e,t)=>e in a?Ee(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var O=(a,e,t)=>Le(a,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=t(n);fetch(n.href,s)}})();class Te{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{},screenHistory:[]},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}notify(){this.listeners.forEach(e=>e(this.state))}getState(){return{...this.state}}setState(e){this.state={...this.state,...e},this.notify()}navigate(e){console.log(`Navigating from ${this.state.currentScreen} to ${e}`);const t=[...this.state.screenHistory];this.state.currentScreen!==e&&!t.includes(this.state.currentScreen)&&t.push(this.state.currentScreen),this.setState({currentScreen:e,screenHistory:t})}goBack(){const e=[...this.state.screenHistory];if(console.log("goBack() - current history:",e),console.log("goBack() - current screen:",this.state.currentScreen),e.length>0){const t=e.pop();return console.log("goBack() - navigating to:",t),this.setState({currentScreen:t,screenHistory:e}),!0}return console.log("goBack() - no history available"),!1}goHome(){this.setState({currentScreen:"triage1",screenHistory:[]})}setFormData(e,t){const i={...this.state.formData};i[e]={...t},this.setState({formData:i})}getFormData(e){return this.state.formData[e]||{}}setValidationErrors(e){this.setState({validationErrors:e})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(e){this.setState({results:e})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const e={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{},screenHistory:[]};this.setState(e),console.log("Store reset with new session:",e.sessionId)}logEvent(e,t={}){const i={timestamp:Date.now(),session:this.state.sessionId,event:e,data:t};console.log("Event:",i)}getSessionDuration(){return Date.now()-this.state.startTime}}const p=new Te;function A(a){const e=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let t='<div class="progress-indicator">';return e.forEach((i,n)=>{const s=i.id===a,o=i.id<a;t+=`
  ...
  `}const $={COMA_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_coma_ich",LDM_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_limited_data_ich",FULL_STROKE:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_full_stroke"},me={ich:{medium:25,high:50},lvo:{medium:25,high:50}},E={min:29,max:10001},U={autoSaveInterval:18e4,sessionTimeout:30*60*1e3,requestTimeout:1e4},Ae={age_years:{required:!0,min:0,max:120},systolic_bp:{required:!0,min:60,max:300},diastolic_bp:{required:!0,min:30,max:200},gfap_value:{required:!0,min:E.min,max:E.max},fast_ed_score:{required:!0,min:0,max:9}};function Me(){return`
    <div class="container">
      ${A(2)}
      ...
      <form data-module="coma">
        <div class="input-grid">
          <div class="input-group">
            ...
            <input type="number" id="gfap_value" name="gfap_value" min="${E.min}" max="${E.max}" step="0.1" required aria-describedby="gfap-help">
            <div id="gfap-help" class="input-help">
              ${r("gfapRange").replace("{min}",E.min).replace("{max}",E.max)}
            </div>
          </div>
        </div>
      ...
      <form data-module="limited">
        <div class="input-grid">
          ...
          <div class="input-group">
            ...
            <div class="input-with-unit">
              <input type="number" name="gfap_value" id="gfap_value" min="${E.min}" max="${E.max}" step="0.1" required inputmode="decimal">
  ...
  `}const Ie={age_years:"ageLabel",age:"ageLabel",systolic_bp:"systolicLabel",diastolic_bp:"diastolicLabel",systolic_blood_pressure:"systolicLabel",diastolic_blood_pressure:"diastolicLabel",blood_pressure_systolic:"systolicLabel",blood_pressure_diastolic:"diastolicLabel",gfap_value:"gfapLabel",gfap:"gfapLabel",gfap_level:"gfapLabel",fast_ed_score:"fastEdLabel",fast_ed:"fastEdLabel",fast_ed_total:"fastEdLabel",vigilanzminderung:"vigilanzLabel",vigilance_reduction:"vigilanzLabel",reduced_consciousness:"vigilanzLabel",armparese:"armPareseLabel",arm_paresis:"armPareseLabel",arm_weakness:"armPareseLabel",beinparese:"beinPareseLabel",leg_paresis:"beinPareseLabel",leg_weakness:"beinPareseLabel",eye_deviation:"eyeDeviationLabel",blickdeviation:"eyeDeviationLabel",headache:"headacheLabel",kopfschmerzen:"headacheLabel",atrial_fibrillation:"atrialFibLabel",vorhofflimmern:"atrialFibLabel",anticoagulated_noak:"anticoagLabel",anticoagulation:"anticoagLabel",antiplatelets:"antiplateletsLabel",thrombozytenaggregationshemmer:"antiplateletsLabel"},De=[{pattern:/_score$/,replacement:" Score"},{pattern:/_value$/,replacement:" Level"},{pattern:/_bp$/,replacement:" Blood Pressure"},{pattern:/_years?$/,replacement:" (years)"},{pattern:/^ich_/,replacement:"Brain Bleeding "},{pattern:/^lvo_/,replacement:"Large Vessel "},{pattern:/parese$/,replacement:"Weakness"},{pattern:/deviation$/,replacement:"Movement"}];function z(a){if(!a)return"";const e=Ie[a.toLowerCase()];if(e){const i=r(e);if(i&&i!==e)return i}let t=a.toLowerCase();return De.forEach(({pattern:i,replacement:n})=>{t=t.replace(i,n)}),t=t.replace(/_/g," ").replace(/\b\w/g,i=>i.toUpperCase()).trim(),t}function Ne(a){return z(a).replace(/\s*\([^)]*\)\s*/g,"").trim()}function _e(a,e=""){return a==null||a===""?"":typeof a=="boolean"?a?"✓":"✗":typeof a=="number"?e.includes("bp")||e.includes("blood_pressure")?`${a} mmHg`:e.includes("gfap")?`${a} pg/mL`:e.includes("age")?`${a} years`:e.includes("score")||Number.isInteger(a)?a.toString():a.toFixed(1):a.toString()}function Be(a,e){if(console.log("=== DRIVER RENDERING SECTION ==="),console.log("🧠 ICH result received:",{probability:a==null?void 0:a.probability,hasDrivers:!!(a!=null&&a.drivers),module:a==null?void 0:a.module}),console.log("🩸 LVO result received:",{probability:e==null?void 0:e.probability,hasDrivers:!!(e!=null&&e.drivers),module:e==null?void 0:e.module,notPossible:e==null?void 0:e.notPossible}),!(a!=null&&a.drivers)&&!(e!=null&&e.drivers))return console.log("❌ No drivers available for rendering"),"";let t=`
    <div class="drivers-section">
      <div class="drivers-header">
        <h3><span class="driver-header-icon">🎯</span> ${r("riskAnalysis")}</h3>
        <p class="drivers-subtitle">${r("riskAnalysisSubtitle")}</p>
      </div>
      <div class="enhanced-drivers-grid">
  `;return a!=null&&a.drivers&&(console.log("🧠 Rendering ICH drivers panel"),t+=ie(a.drivers,"ICH","ich",a.probability)),e!=null&&e.drivers&&!e.notPossible&&(console.log("🩸 Rendering LVO drivers panel"),t+=ie(e.drivers,"LVO","lvo",e.probability)),t+=`
      </div>
    </div>
  `,t}function ie(a,e,t,i){if(console.log(`--- ${e} Driver Panel Debug ---`),console.log("Raw drivers input:",a),console.log("Title:",e,"Type:",t,"Probability:",i),!a||Object.keys(a).length===0)return console.log(`No drivers data for ${e}`),`
      <div class="enhanced-drivers-panel ${t}">
        <div class="panel-header">
          <div class="panel-icon ${t}">${t==="ich"?"🩸":"🧠"}</div>
          <div class="panel-title">
            <h4>${e} ${r("riskFactors")}</h4>
            <span class="panel-subtitle">${r("noDriverData")}</span>
          </div>
        </div>
        <p class="no-drivers-message">
          ${r("driverInfoNotAvailable")}
        </p>
      </div>
    `;const n=a;if(console.log(`${e} drivers ready for display:`,n),n.kind==="unavailable")return`
      <div class="enhanced-drivers-panel ${t}">
        <div class="panel-header">
          ...
          <div class="panel-title">
            <h4>${e} ${r("riskFactors")}</h4>
            <span class="panel-subtitle">${r("driverAnalysisUnavailable")}</span>
          </div>
        </div>
        <p class="no-drivers-message">
          ${r("driverAnalysisNotAvailable")}
        </p>
      </div>
    `;const s=n.positive.sort((c,u)=>Math.abs(u.weight)-Math.abs(c.weight)).slice(0,3),o=n.negative.sort((c,u)=>Math.abs(u.weight)-Math.abs(c.weight)).slice(0,3);console.log(`🎯 ${e} Final displayed drivers:`),console.log("  Top positive:",s.map(c=>`${c.label}: +${(Math.abs(c.weight)*100).toFixed(1)}%`)),console.log("  Top negative:",o.map(c=>`${c.label}: -${(Math.abs(c.weight)*100).toFixed(1)}%`));const d=Math.max(...s.map(c=>Math.abs(c.weight)),...o.map(c=>Math.abs(c.weight)),.01);let l=`
    <div class="enhanced-drivers-panel ${t}">
      <div class="panel-header">
        <div class="panel-icon ${t}">${t==="ich"?"🩸":"🧠"}</div>
        <div class="panel-title">
          <h4>${e} ${r("riskFactors")}</h4>
          <span class="panel-subtitle">${r("contributingFactors")}</span>
        </div>
      </div>
      ...
      <div class="drivers-split-view">
        <div class="drivers-column positive-column">
          <div class="column-header">
            ...
            <span class="column-title">${r("increaseRisk")}</span>
          </div>
          <div class="compact-drivers">
  `;return s.length>0?s.forEach(c=>{const u=Math.abs(c.weight*100),m=Math.abs(c.weight)/d*100,b=z(c.label);l+=`
      ...
      `}):l+=`<div class="no-factors">${r("noPositiveFactors")}</div>`,l+=`
          </div>
        </div>
        ...
        <div class="drivers-column negative-column">
          <div class="column-header">
            <span class="column-icon">↓</span>
            <span class="column-title">${r("decreaseRisk")}</span>
          </div>
          <div class="compact-drivers">
  `,o.length>0?o.forEach(c=>{const u=Math.abs(c.weight*100),m=Math.abs(c.weight)/d*100,b=z(c.label);l+=`
        <div class="compact-driver-item">
          <div class="compact-driver-label">${b}</div>
  ...
  `}function He(a){const e=document.getElementById("useGpsButton"),t=document.getElementById("manualLocationButton"),i=document.querySelector(".location-manual"),n=document.getElementById("locationInput"),s=document.getElementById("searchLocationButton"),o=document.getElementById("strokeCenterResults");e&&e.addEventListener("click",()=>{Oe(a,o)}),t&&t.addEventListener("click",()=>{i.style.display=i.style.display==="none"?"block":"none"}),s&&s.addEventListener("click",()=>{const d=n.value.trim();d&&ne(d,a,o)}),n&&n.addEventListener("keypress",d=>{if(d.key==="Enter"){const l=n.value.trim();l&&ne(l,a,o)}})}function Oe(a,e){if(!navigator.geolocation){N(r("geolocationNotSupported"),e);return}e.innerHTML=`<div class="loading">${r("gettingLocation")}...</div>`,navigator.geolocation.getCurrentPosition(t=>{const{latitude:i,longitude:n}=t.coords;G(i,n,a,e)},t=>{let i=r("locationError");switch(t.code){case t.PERMISSION_DENIED:i=r("locationPermissionDenied");break;case t.POSITION_UNAVAILABLE:i=r("locationUnavailable");break;case t.TIMEOUT:i=r("locationTimeout");break}N(i,e)},{enableHighAccuracy:!0,timeout:1e4,maximumAge:3e5})}async function ne(a,e,t){t.innerHTML=`<div class="loading">${r("searchingLocation")}...</div>`;const i=/^(-?\d+\.?\d*)\s*,\s*(-?\d+\.?\d*)$/,n=a.trim().match(i);if(n){const s=parseFloat(n[1]),o=parseFloat(n[2]);if(s>=47.2&&s<=52.5&&o>=5.9&&o<=15){t.innerHTML=`
        <div class="location-success">
          <p>📍 Coordinates: ${s.toFixed(4)}, ${o.toFixed(4)}</p>
        </div>
      `,setTimeout(()=>{G(s,o,e,t)},500);return}else{N("Coordinates appear to be outside Germany. Please check the values.",t);return}}try{let s=a.trim();!s.toLowerCase().includes("deutschland")&&!s.toLowerCase().includes("germany")&&!s.toLowerCase().includes("bayern")&&!s.toLowerCase().includes("bavaria")&&!s.toLowerCase().includes("nordrhein")&&!s.toLowerCase().includes("baden")&&(s=s+", Deutschland");const d=`https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(s)}&countrycodes=de&format=json&limit=3&addressdetails=1`,l=await fetch(d,{method:"GET",headers:{Accept:"application/json","User-Agent":"iGFAP-StrokeTriage/2.1.0"}});if(!l.ok)throw new Error(`Geocoding API error: ${l.status}`);const c=await l.json();if(c&&c.length>0){let u=c[0];const m=["Bayern","Baden-Württemberg","Nordrhein-Westfalen"];for(const h of c)if(h.address&&m.includes(h.address.state)){u=h;break}const b=parseFloat(u.lat),y=parseFloat(u.lon),g=u.display_name||a;t.innerHTML=`
        <div class="location-success">
          <p>📍 Found: ${g}</p>
          <small style="color: #666;">Lat: ${b.toFixed(4)}, Lng: ${y.toFixed(4)}</small>
        </div>
      `,setTimeout(()=>{G(b,y,e,t)},1e3)}else N(`
      ...
      `,t)}catch(s){console.warn("Geocoding failed:",s),N(`
      <strong>Unable to search location.</strong><br>
      <small>Please try entering coordinates directly (e.g., "48.1351, 11.5820")</small>
    `,t)}}async function G(a,e,t,i){var d,l;const n={lat:a,lng:e},s=Fe.routePatient({location:n,ichProbability:((d=t==null?void 0:t.ich)==null?void 0:d.probability)||0,timeFromOnset:(t==null?void 0:t.timeFromOnset)||null,clinicalFactors:(t==null?void 0:t.clinicalFactors)||{}});if(!s||!s.destination){i.innerHTML=`
    ...
    `;return}const o=Ve(s,t);i.innerHTML=`
    <div class="location-info">
      <p><strong>${r("yourLocation")}:</strong> ${a.toFixed(4)}, ${e.toFixed(4)}</p>
      <p><strong>Detected State:</strong> ${re(s.state)}</p>
    </div>
    <div class="loading">${r("calculatingTravelTimes")}...</div>
  `;try{const c=pe[s.state],u=[...c.neurosurgicalCenters,...c.comprehensiveStrokeCenters,...c.regionalStrokeUnits,...c.thrombolysisHospitals||[]],m=s.destination;m.distance=q(a,e,m.coordinates.lat,m.coordinates.lng);try{const g=await se(a,e,m.coordinates.lat,m.coordinates.lng);m.travelTime=g.duration,m.travelSource=g.source}catch{m.travelTime=Math.round(m.distance/.8),m.travelSource="estimated"}const b=u.filter(g=>g.id!==m.id).map(g=>({...g,distance:q(a,e,g.coordinates.lat,g.coordinates.lng)})).sort((g,h)=>g.distance-h.distance).slice(0,3);for(const g of b)try{const h=await se(a,e,g.coordinates.lat,g.coordinates.lng);g.travelTime=h.duration,g.travelSource=h.source}catch{g.travelTime=Math.round(g.distance/.8),g.travelSource="estimated"}const y=`
      <div class="location-info">
        <p><strong>${r("yourLocation")}:</strong> ${a.toFixed(4)}, ${e.toFixed(4)}</p>
        <p><strong>State:</strong> ${re(s.state)}</p>
        ${o}
      </div>
    ...
    `;i.innerHTML=y}catch(c){console.warn("Enhanced routing failed, using basic display:",c),i.innerHTML=`
      <div class="location-info">
        <p><strong>${r("yourLocation")}:</strong> ${a.toFixed(4)}, ${e.toFixed(4)}</p>
        ${o}
      </div>
    ...
    `}}function re(a){return{bayern:"Bayern (Bavaria)",badenWuerttemberg:"Baden-Württemberg",nordrheinWestfalen:"Nordrhein-Westfalen (NRW)"}[a]||a}function Ve(a,e){var n;const t=Math.round((((n=e==null?void 0:e.ich)==null?void 0:n.probability)||0)*100);let i="🏥";return a.urgency==="IMMEDIATE"?i="🚨":a.urgency==="TIME_CRITICAL"?i="⏰":a.urgency==="URGENT"&&(i="⚠️"),`
  ...
  `}function oe(a,e,t){const i=[];a.neurosurgery&&i.push("🧠 Neurosurgery"),a.thrombectomy&&i.push("🩸 Thrombectomy"),a.thrombolysis&&i.push("💉 Thrombolysis");const n=a.network?`<span class="network-badge">${a.network}</span>`:"";return`
  ...
  `}function N(a,e){e.innerHTML=`
    <div class="location-error">
      <p>⚠️ ${a}</p>
      <p><small>${r("tryManualEntry")}</small></p>
    </div>
  `}function ze(a,e){const t=Number(a),i=me[e];return t>=i.high?"🔴 HIGH RISK":t>=i.medium?"🟡 MEDIUM RISK":"🟢 LOW RISK"}const K={moderate:{min:10},high:{min:20},critical:{min:30}};function j(a){if(!a||a<=0)return{volume:0,volumeRange:{min:0,max:0},riskLevel:"low",mortalityRate:"~0%",isValid:!0,calculation:"No hemorrhage detected"};const e=Math.min(a,1e4);a>1e4&&console.warn(`GFAP value ${a} exceeds expected range, capped at 10,000 pg/ml`);try{const t=.0192+.4533*Math.log10(e),i=Math.pow(10,t),n={min:i*.7,max:i*1.3},s=qe(i),o=We(i),d=i<1?"<1":i.toFixed(1);return{volume:i,displayVolume:d,volumeRange:{min:n.min.toFixed(1),max:n.max.toFixed(1)},riskLevel:s,mortalityRate:o,isValid:!0,calculation:`Based on GFAP ${a} pg/ml`,threshold:i>=30?"SURGICAL":i>=20?"HIGH_RISK":"MANAGEABLE"}}catch(t){return console.error("Volume calculation error:",t),{volume:0,volumeRange:{min:0,max:0},riskLevel:"low",mortalityRate:"Unknown",isValid:!1,calculation:"Calculation error",error:t.message}}}function qe(a){return a>=K.critical.min?"critical":a>=K.high.min?"high":a>=K.moderate.min?"moderate":"low"}function We(a){return a<10?"5-10%⁴":a<30?`${Math.round(10+(a-10)*9/20)}%⁴`:a<50?`${Math.round(19+(a-30)*25/20)}%³`:a<60?`${Math.round(44+(a-50)*47/10)}%²`:a<80?`${Math.round(91+(a-60)*5/20)}%¹`:"96-100%¹"}function Ke(a){return a<1?"<1 ml":a<10?`${a.toFixed(1)} ml`:`${Math.round(a)} ml`}function Ue(a){if(!a||a<=0)return`
    ...
    `;const e=Ke(a),t=`volume-canvas-${Math.random().toString(36).substr(2,9)}`;return`
...
`)}static exportAsJSON(){const e=this.getStoredData();return JSON.stringify(e,null,2)}static downloadData(e="csv"){try{const t=e==="csv"?this.exportAsCSV():this.exportAsJSON(),i=`igfap-research-${Date.now()}.${e}`,n=new Blob([t],{type:e==="csv"?"text/csv":"application/json"}),s=URL.createObjectURL(n),o=document.createElement("a");return o.href=s,o.download=i,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(s),console.log(`📥 Downloaded research data: ${i}`),!0}catch(t){return console.error("Failed to download research data:",t),!1}}static clearData(){try{return localStorage.removeItem(this.STORAGE_KEY),console.log("🗑️ Research data cleared"),!0}catch(e){return console.warn("Failed to clear research data:",e),!1}}static getDataSummary(){var s,o;const e=this.getStoredData();if(!e.entries||e.entries.length===0)return{totalEntries:0,dateRange:null,avgDifference:null};const t=e.entries,i=t.map(d=>{var l,c;return(c=(l=d.comparison)==null?void 0:l.differences)==null?void 0:c.absolute}).filter(d=>d!=null),n=i.length>0?i.reduce((d,l)=>d+Math.abs(l),0)/i.length:0;return{totalEntries:t.length,dateRange:{first:(s=t[0])==null?void 0:s.timestamp,last:(o=t[t.length-1])==null?void 0:o.timestamp},avgAbsoluteDifference:Math.round(n*10)/10,storageSize:JSON.stringify(e).length}}static generateEntryId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}static getSessionId(){let e=sessionStorage.getItem("research_session_id");return e||(e="session_"+Date.now().toString(36),sessionStorage.setItem("research_session_id",e)),e}}O(P,"STORAGE_KEY","igfap_research_data"),O(P,"MAX_ENTRIES",1e3);function Je(a,e,t){try{if(!C())return;const i={inputs:{age:t.age_years||t.age,gfap:t.gfap_value||t.gfap,module:a.module||"unknown"},main:{probability:a.probability,module:a.module,confidence:a.confidence},legacy:e,comparison:e?x.compareModels(a,e):null};P.logComparison(i)}catch(i){console.warn("Research logging failed (non-critical):",i)}}function C(a=null){var e;if(a==="coma")return!1;if(a==="limited"||a==="full")return!0;if(typeof window<"u")try{const t=window.store||((e=require("../state/store.js"))==null?void 0:e.store);if(t){const i=t.getState().formData;return i.limited||i.full}}catch{}return!1}function be(){return""}function ve(a,e,t){if(!(e!=null&&e.isValid))return console.log("🔬 Legacy model results invalid:",e),`
    ...
    `;const i=x.compareModels(a,e);return`
    <div class="research-panel" id="researchPanel" style="display: none;">
      <div class="research-header">
        <h4>🔬 Model Comparison (Research)</h4>
        <button class="close-research" id="closeResearch">×</button>
  ...
  `}function Ze(a,e){let t=a.probability||0;t<=1&&(t=t*100);const i=e.probability||0;return`
  ...
  `}function Xe(a){if(!a.isValid)return'<div class="comparison-error">Unable to compare models</div>';const{differences:e,agreement:t}=a;return`
  ...
  `}function et(){const a=x.getModelMetadata();return`
  ...
  `}function tt(){if(!document.getElementById("researchPanel"))return;const e=document.getElementById("closeResearch");e&&e.addEventListener("click",()=>{const s=document.getElementById("researchPanel");s&&(s.style.display="none")});const t=document.getElementById("exportResearchData");t&&t.addEventListener("click",()=>{P.downloadData("csv")});const i=document.getElementById("toggleCalculationDetails");i&&i.addEventListener("click",()=>{const s=document.getElementById("calculationDetails");s&&(s.style.display=s.style.display==="none"?"block":"none",i.textContent=s.style.display==="none"?"🧮 Details":"🧮 Hide")});const n=document.getElementById("clearResearchData");n&&n.addEventListener("click",()=>{if(confirm("Clear all research data? This cannot be undone.")){P.clearData();const s=P.getDataSummary();console.log(`Data cleared. Total entries: ${s.totalEntries}`)}}),console.log("🔬 Research mode initialized")}function at(a,e){const t=document.getElementById("tachometerCanvas");if(!t)return;const i=t.getContext("2d"),n=e/Math.max(a,1),s=Math.min(1,Math.max(0,(n-.5)/1.5));let o=0;const d=s,l=()=>{const c=t.width/2,u=t.height*.8,m=Math.min(t.width,t.height)*.35;i.clearRect(0,0,t.width,t.height),i.beginPath(),i.arc(c,u,m,Math.PI,2*Math.PI),i.strokeStyle=getComputedStyle(document.documentElement).getPropertyValue("--border-color"),i.lineWidth=8,i.stroke(),[{start:0,end:.33,color:"#ff0040"},{start:.33,end:.67,color:"#ffd700"},{start:.67,end:1,color:"#00d4ff"}].forEach(f=>{i.beginPath();const k=Math.PI+f.start*Math.PI,v=Math.PI+f.end*Math.PI;i.arc(c,u,m,k,v),i.strokeStyle=f.color,i.lineWidth=6,i.stroke()}),[.5,.75,1,1.5,2].forEach(f=>{const k=(f-.5)/1.5,v=Math.PI+k*Math.PI,w=c+Math.cos(v)*(m-15),S=u+Math.sin(v)*(m-15),L=c+Math.cos(v)*(m-5),R=u+Math.sin(v)*(m-5);i.beginPath(),i.moveTo(w,S),i.lineTo(L,R),i.strokeStyle=getComputedStyle(document.documentElement).getPropertyValue("--text-secondary"),i.lineWidth=2,i.stroke();const I=c+Math.cos(v)*(m+15),H=u+Math.sin(v)*(m+15);i.fillStyle=getComputedStyle(document.documentElement).getPropertyValue("--text-secondary"),i.font="12px sans-serif",i.textAlign="center",i.fillText(f.toString(),I,H+4)});const g=Math.PI+o*Math.PI,h=m*.8;i.beginPath(),i.moveTo(c,u),i.lineTo(c+Math.cos(g)*h,u+Math.sin(g)*h),i.strokeStyle="#ff6b35",i.lineWidth=4,i.lineCap="round",i.stroke(),i.beginPath(),i.arc(c,u,6,0,2*Math.PI),i.fillStyle="#ff6b35",i.fill(),i.fillStyle=getComputedStyle(document.documentElement).getPropertyValue("--text-primary"),i.font="bold 16px sans-serif",i.textAlign="center",i.fillText(n.toFixed(2),c,u-20),Math.abs(o-d)>.01&&(o+=(d-o)*.05,requestAnimationFrame(l))};l()}function fe(){const e=p.getState().formData;if(!e||Object.keys(e).length===0)return"";let t="";return Object.entries(e).forEach(([i,n])=>{if(n&&Object.keys(n).length>0){const s=r(`${i}ModuleTitle`)||i.charAt(0).toUpperCase()+i.slice(1);let o="";Object.entries(n).forEach(([d,l])=>{if(l===""||l===null||l===void 0)return;let c=Ne(d),u=_e(l,d);o+=`
  ...
  `:""}function Y(a,e,t){if(!e)return"";const i=Math.round((e.probability||0)*100),n=ze(i,a),s=i>70,o=i>me[a].high,d={ich:"🩸",lvo:"🧠"},l={ich:r("ichProbability"),lvo:r("lvoProbability")},c={ich:"ICH",lvo:M.getCurrentLanguage()==="de"?"Großgefäßverschluss":"Large Vessel Occlusion"};return`
    <div class="enhanced-risk-card ${a} ${s?"critical":o?"high":"normal"}">
      <div class="risk-header">
        <div class="risk-icon">${d[a]}</div>
        <div class="risk-title">
          <h3>${l[a]}</h3>
          <span class="risk-subtitle">${c[a]}</span>
        ...
        <div class="risk-assessment">
          ${a==="ich"&&i>=50&&_()>0?`
            <div class="mortality-assessment">
              ${r("predictedMortality")}: ${j(_()).mortalityRate}
            </div>
          `:""}
        </div>
      </div>
    </div>
  `}function it(a){const e=a.gfap_value||_();if(!e||e<=0)return"";const t=j(e);return`
    <div class="volume-display-container">
      ${Ue(t.volume)}
    </div>
  `}function _(){var t;const e=p.getState().formData;for(const i of["coma","limited","full"])if((t=e[i])!=null&&t.gfap_value)return parseFloat(e[i].gfap_value);return 0}function st(a,e){const{ich:t,lvo:i}=a,n=ct(t),s=n!=="coma"?ot():null;console.log("🔬 Research Debug - Always Active:",{module:n,researchEnabled:C(n),mainResults:t,legacyResults:s,patientInputs:B(),legacyCalculationAttempted:n!=="coma"}),s&&C(n)&&Je(t,s,B());const o=(t==null?void 0:t.module)==="Limited"||(t==null?void 0:t.module)==="Coma"||(i==null?void 0:i.notPossible)===!0;t==null||t.module;let d;return o?d=nt(t,a,e,s,n):d=rt(t,i,a,e,s,n),setTimeout(()=>{if(Ge(),document.getElementById("tachometerCanvas")&&i&&t){const c=Math.round(((t==null?void 0:t.probability)||0)*100),u=Math.round(((i==null?void 0:i.probability)||0)*100);at(c,u)}},100),d}function nt(a,e,t,i,n){const s=a&&a.probability>.6?ge():"",o=he(),d=fe(),l=C(n)?be():"",c=i&&C(n)?ve(a,i,B()):"",u=(a==null?void 0:a.module)==="Coma"?lt(a.probability):"",m=(a==null?void 0:a.module)!=="Coma"?Se(a.probability):"";return`
    <div class="container">
      ${A(3)}
  ...
  `}function rt(a,e,t,i,n,s){var H,X,Q,ee;const o=Math.round(((a==null?void 0:a.probability)||0)*100),d=Math.round(((e==null?void 0:e.probability)||0)*100),l=a&&a.probability>.6?ge():"",c=he(),u=fe(),m=C(s)?be():"",b=n&&C(s)?ve(a,n,B()):"",y=p.getState(),g=parseInt((X=(H=y.formData)==null?void 0:H.full)==null?void 0:X.fast_ed_score)||0;console.log("🔍 Debug LVO Display:"),console.log("  Current Module:",s),console.log("  FAST-ED Score:",g),console.log("  FAST-ED Raw:",(ee=(Q=y.formData)==null?void 0:Q.full)==null?void 0:ee.fast_ed_score),console.log("  LVO Data:",e),console.log("  LVO notPossible:",e==null?void 0:e.notPossible),console.log("  LVO Probability:",e==null?void 0:e.probability),console.log("  ICH Module:",a==null?void 0:a.module);const h=s==="full"||(a==null?void 0:a.module)==="Full",f=e&&typeof e.probability=="number"&&!e.notPossible,k=h&&g>3&&f;console.log("  Conditions: isFullModule:",h),console.log("  Conditions: fastEdScore > 3:",g>3),console.log("  Conditions: hasValidLVO:",f),console.log("  Show LVO Card:",k);const v=o>=50,S=Math.max(o,d)>=50&&k;let L=1;k&&L++,v&&L++;const R=L===1?"risk-results-single":L===2?"risk-results-dual":"risk-results-triple",I=Se(a.probability);return`
    <div class="container">
      ${A(3)}
  ...
  `}function ye(a){if(!a||!a.drivers)return'<p class="no-drivers">No driver data available</p>';const e=a.drivers;if(!e.positive&&!e.negative)return'<p class="no-drivers">Driver format error</p>';const t=e.positive||[],i=e.negative||[];return`
    <div class="drivers-split-view">
      <div class="drivers-column positive-column">
        <div class="column-header">
          <span class="column-icon">⬆</span>
        ...
        <div class="compact-drivers">
          ${t.length>0?t.slice(0,5).map(n=>le(n,"positive")).join(""):`<p class="no-factors">${r("noFactors")||"Keine Faktoren / No factors"}</p>`}
        </div>
      </div>
      ...
      <div class="drivers-column negative-column">
        ...
        <div class="compact-drivers">
          ${i.length>0?i.slice(0,5).map(n=>le(n,"negative")).join(""):`<p class="no-factors">${r("noFactors")||"Keine Faktoren / No factors"}</p>`}
        </div>
      </div>
    </div>
  `}function le(a,e){const t=Math.abs(a.weight*100),i=Math.min(t*2,100);return`
    <div class="compact-driver-item">
      <div class="compact-driver-label">${z(a.label)}</div>
      <div class="compact-driver-bar ${e}" style="width: ${i}%;">
        <span class="compact-driver-value">${t.toFixed(1)}%</span>
      </div>
    </div>
  `}function ke(a){if(!a||!a.probability||Math.round((a.probability||0)*100)<50)return"";const t=_();return!t||t<=0?"":`
  ...
  `}function ot(a){try{const e=B();if(console.log("🔍 Legacy calculation inputs:",e),!e.age||!e.gfap)return console.warn("🔍 Missing required inputs for legacy model:",{age:e.age,gfap:e.gfap}),null;const t=je(e);return console.log("🔍 Legacy calculation result:",t),t}catch(e){return console.warn("Legacy model calculation failed (non-critical):",e),null}}function B(){const e=p.getState().formData;console.log("🔍 Debug formData structure:",e);let t=null,i=null;for(const s of["coma","limited","full"])e[s]&&(console.log(`🔍 ${s} module data:`,e[s]),t=t||e[s].age_years,i=i||e[s].gfap_value);const n={age:parseInt(t)||null,gfap:parseFloat(i)||null};return console.log("🔍 Extracted patient inputs:",n),n}function Se(a){return Math.round(a*100)>25?`
    ...
    `:""}function lt(a){const e=Math.round(a*100),t=M.getCurrentLanguage()==="de";return e>25?`
      <div class="alternative-diagnosis-card">
        <div class="diagnosis-header">
          <span class="lightning-icon">⚡</span>
    ...
    `}function ct(a){if(!(a!=null&&a.module))return"unknown";const e=a.module.toLowerCase();return e.includes("coma")?"coma":e.includes("limited")?"limited":e.includes("full")?"full":"unknown"}function dt(a){const e=_();if(!e||e<=0)return"";const t=j(e);return Math.round(((a==null?void 0:a.probability)||0)*100),`
    <div class="enhanced-risk-card volume-card normal">
      <div class="risk-header">
        <div class="risk-icon">🧮</div>
        <div class="risk-title">
          <h3>${r("ichVolumeLabel")}</h3>
          <span class="risk-subtitle">${t.displayVolume}</span>
      ...
      <div class="risk-probability">
        ...
        <div class="risk-assessment">
          <div class="mortality-assessment">
            ${r("predictedMortality")}: ${t.mortalityRate}
          </div>
        </div>
      </div>
    </div>
  `}function ut(a,e){const t=e/Math.max(a,1);let i;return e>40&&a>40?i={center:"COMPREHENSIVE CENTER",detail:"Both LVO and ICH risks elevated",className:"critical",icon:"🏥"}:t>1.3&&e>=50?i={center:"THROMBECTOMY CENTER",detail:"LVO dominant - endovascular required",className:"lvo-dominant",icon:"🧠"}:t<.77&&a>=50?i={center:"NEUROSURGERY CENTER",detail:"ICH dominant - surgical capability required",className:"ich-dominant",icon:"🩸"}:i={center:"SPECIALIZED CENTER",detail:"Elevated risk requires specialized care",className:"moderate",icon:"⚡"},`
    <div class="tachometer-section">
      <div class="tachometer-card">
        <div class="tachometer-header">
          <h3>🎯 ${r("treatmentDecision")||"Treatment Decision"}</h3>
          <div class="ratio-display">
            LVO/ICH Ratio: ${t.toFixed(2)}
          </div>
        </div>
        ...
        <div class="treatment-recommendation ${i.className}">
          <div class="recommendation-icon">${i.icon}</div>
  ...
  `}function mt(a,e,t){const i=[];return t.required&&!e&&e!==0&&i.push("This field is required"),t.min!==void 0&&e!==""&&!isNaN(e)&&parseFloat(e)<t.min&&i.push(`Value must be at least ${t.min}`),t.max!==void 0&&e!==""&&!isNaN(e)&&parseFloat(e)>t.max&&i.push(`Value must be at most ${t.max}`),t.pattern&&!t.pattern.test(e)&&i.push("Invalid format"),i}function gt(a){let e=!0;const t={};return Object.entries(Ae).forEach(([i,n])=>{const s=a.elements[i];if(s){const o=mt(i,s.value,n);o.length>0&&(t[i]=o,e=!1)}}),{isValid:e,validationErrors:t}}function pt(a,e){Object.entries(e).forEach(([t,i])=>{const n=a.querySelector(`[name="${t}"]`);if(n){const s=n.closest(".input-group");if(s){s.classList.add("error"),s.querySelectorAll(".error-message").forEach(d=>d.remove());const o=document.createElement("div");o.className="error-message",o.innerHTML=`<span class="error-icon">⚠️</span> ${i[0]}`,s.appendChild(o)}}})}function ht(a){a.querySelectorAll(".input-group.error").forEach(e=>{e.classList.remove("error"),e.querySelectorAll(".error-message").forEach(t=>t.remove())})}function ce(a,e){var o,d;console.log(`=== EXTRACTING ${e.toUpperCase()} DRIVERS ===`),console.log("Full response:",a);let t=null;if(e==="ICH"?(t=((o=a.ich_prediction)==null?void 0:o.drivers)||null,console.log("🧠 ICH raw drivers extracted:",t)):e==="LVO"&&(t=((d=a.lvo_prediction)==null?void 0:d.drivers)||null,console.log("🩸 LVO raw drivers extracted:",t)),!t)return console.log(`❌ No ${e} drivers found`),null;const i=bt(t,e);console.log(`✅ ${e} drivers formatted:`,i);const s=[...i.positive,...i.negative].find(l=>l.label&&(l.label.toLowerCase().includes("fast")||l.label.includes("fast_ed")));return s?console.log(`🎯 FAST-ED found in ${e}:`,`${s.label}: ${s.weight>0?"+":""}${s.weight.toFixed(4)}`):console.log(`⚠️  FAST-ED NOT found in ${e} drivers`),i}function bt(a,e){console.log(`🔄 Formatting ${e} drivers from dictionary:`,a);const t=[],i=[];return Object.entries(a).forEach(([n,s])=>{typeof s=="number"&&(s>0?t.push({label:n,weight:s}):s<0&&i.push({label:n,weight:Math.abs(s)}))}),t.sort((n,s)=>s.weight-n.weight),i.sort((n,s)=>s.weight-n.weight),console.log(`📈 ${e} positive drivers:`,t.slice(0,5)),console.log(`📉 ${e} negative drivers:`,i.slice(0,5)),{kind:"flat_dictionary",units:"logit",positive:t,negative:i,meta:{}}}function de(a,e){var i,n;console.log(`=== EXTRACTING ${e.toUpperCase()} PROBABILITY ===`);let t=0;return e==="ICH"?(t=((i=a.ich_prediction)==null?void 0:i.probability)||0,console.log("🧠 ICH probability extracted:",t)):e==="LVO"&&(t=((n=a.lvo_prediction)==null?void 0:n.probability)||0,console.log("🩸 LVO probability extracted:",t)),t}function ue(a,e){var i,n;let t=.85;return e==="ICH"?t=((i=a.ich_prediction)==null?void 0:i.confidence)||.85:e==="LVO"&&(t=((n=a.lvo_prediction)==null?void 0:n.confidence)||.85),t}async function vt(){console.log("Warming up Cloud Functions...");const a=Object.values($).map(async e=>{try{const t=new AbortController,i=setTimeout(()=>t.abort(),3e3);await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({}),signal:t.signal,mode:"cors"}),clearTimeout(i),console.log(`Warmed up: ${e}`)}catch{console.log(`Warm-up attempt for ${e.split("/").pop()} completed`)}});Promise.all(a).then(()=>{console.log("Cloud Functions warm-up complete")})}class T extends Error{constructor(e,t,i){super(e),this.name="APIError",this.status=t,this.url=i}}function J(a){const e={...a};return Object.keys(e).forEach(t=>{const i=e[t];(typeof i=="boolean"||i==="on"||i==="true"||i==="false")&&(e[t]=i===!0||i==="on"||i==="true"?1:0)}),e}function W(a,e=0){const t=parseFloat(a);return isNaN(t)?e:t}async function Z(a,e){const t=new AbortController,i=setTimeout(()=>t.abort(),U.requestTimeout);try{const n=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(e),signal:t.signal,mode:"cors"});if(clearTimeout(i),!n.ok){let o=`HTTP ${n.status}`;try{const d=await n.json();o=d.error||d.message||o}catch{o=`${o}: ${n.statusText}`}throw new T(o,n.status,a)}return await n.json()}catch(n){throw clearTimeout(i),n.name==="AbortError"?new T("Request timeout - please try again",408,a):n instanceof T?n:new T("Network error - please check your connection and try again",0,a)}}async function ft(a){const e=J(a);console.log("Coma ICH API Payload:",e);try{const t=await Z($.COMA_ICH,e);return console.log("Coma ICH API Response:",t),{probability:W(t.probability||t.ich_probability,0),drivers:t.drivers||null,confidence:W(t.confidence,.75),module:"Coma"}}catch(t){throw console.error("Coma ICH prediction failed:",t),new T(`Failed to get ICH prediction: ${t.message}`,t.status,$.COMA_ICH)}}async function yt(a){const e={age_years:a.age_years,systolic_bp:a.systolic_bp,diastolic_bp:a.diastolic_bp,gfap_value:a.gfap_value,vigilanzminderung:a.vigilanzminderung||0},t=J(e);console.log("Limited Data ICH API Payload:",t);try{const i=await Z($.LDM_ICH,t);return console.log("Limited Data ICH API Response:",i),{probability:W(i.probability||i.ich_probability,0),drivers:i.drivers||null,confidence:W(i.confidence,.65),module:"Limited Data"}}catch(i){throw console.error("Limited Data ICH prediction failed:",i),new T(`Failed to get ICH prediction: ${i.message}`,i.status,$.LDM_ICH)}}async function kt(a){var i,n,s,o,d,l;const e={age_years:a.age_years,systolic_bp:a.systolic_bp,diastolic_bp:a.diastolic_bp,gfap_value:a.gfap_value,fast_ed_score:a.fast_ed_score,headache:a.headache||0,vigilanzminderung:a.vigilanzminderung||0,armparese:a.armparese||0,beinparese:a.beinparese||0,eye_deviation:a.eye_deviation||0,atrial_fibrillation:a.atrial_fibrillation||0,anticoagulated_noak:a.anticoagulated_noak||0,antiplatelets:a.antiplatelets||0},t=J(e);console.log("=== BACKEND DATA MAPPING TEST ==="),console.log("📤 Full Stroke API Payload:",t),console.log("🧪 Clinical Variables Being Sent:"),console.log("  📊 FAST-ED Score:",t.fast_ed_score),console.log("  🩸 Systolic BP:",t.systolic_bp),console.log("  🩸 Diastolic BP:",t.diastolic_bp),console.log("  🧬 GFAP Value:",t.gfap_value),console.log("  👤 Age:",t.age_years),console.log("  🤕 Headache:",t.headache),console.log("  😵 Vigilanz:",t.vigilanzminderung),console.log("  💪 Arm Parese:",t.armparese),console.log("  🦵 Leg Parese:",t.beinparese),console.log("  👁️ Eye Deviation:",t.eye_deviation),console.log("  💓 Atrial Fib:",t.atrial_fibrillation),console.log("  💊 Anticoag NOAK:",t.anticoagulated_noak),console.log("  💊 Antiplatelets:",t.antiplatelets);try{const c=await Z($.FULL_STROKE,t);console.log("📥 Full Stroke API Response:",c),console.log("🔑 Available keys in response:",Object.keys(c)),console.log("=== BACKEND MAPPING VERIFICATION ===");const u=JSON.stringify(c).toLowerCase();console.log("🔍 Backend Feature Name Analysis:"),console.log('  Contains "fast":',u.includes("fast")),console.log('  Contains "ed":',u.includes("ed")),console.log('  Contains "fast_ed":',u.includes("fast_ed")),console.log('  Contains "systolic":',u.includes("systolic")),console.log('  Contains "diastolic":',u.includes("diastolic")),console.log('  Contains "gfap":',u.includes("gfap")),console.log('  Contains "age":',u.includes("age")),console.log('  Contains "headache":',u.includes("headache")),console.log("🧠 ICH driver sources:"),console.log("  response.ich_prediction?.drivers:",(i=c.ich_prediction)==null?void 0:i.drivers),console.log("  response.ich_drivers:",c.ich_drivers),console.log("  response.ich?.drivers:",(n=c.ich)==null?void 0:n.drivers),console.log("  response.drivers?.ich:",(s=c.drivers)==null?void 0:s.ich),console.log("🩸 LVO driver sources:"),console.log("  response.lvo_prediction?.drivers:",(o=c.lvo_prediction)==null?void 0:o.drivers),console.log("  response.lvo_drivers:",c.lvo_drivers),console.log("  response.lvo?.drivers:",(d=c.lvo)==null?void 0:d.drivers),console.log("  response.drivers?.lvo:",(l=c.drivers)==null?void 0:l.lvo),Object.keys(c).forEach(w=>{const S=c[w];typeof S=="number"&&S>=0&&S<=1&&console.log(`Potential probability field: ${w} = ${S}`)});const m=de(c,"ICH"),b=de(c,"LVO"),y=ce(c,"ICH"),g=ce(c,"LVO"),h=ue(c,"ICH"),f=ue(c,"LVO");return console.log("✅ Clean extraction results:"),console.log("  ICH:",{probability:m,hasDrivers:!!y}),console.log("  LVO:",{probability:b,hasDrivers:!!g}),{ich:{probability:m,drivers:y,confidence:h,module:"Full Stroke"},lvo:{probability:b,drivers:g,confidence:f,module:"Full Stroke"}}}catch(c){throw console.error("Full Stroke prediction failed:",c),new T(`Failed to get stroke predictions: ${c.message}`,c.status,$.FULL_STROKE)}}const St=()=>[{id:"acute_deficit",checked:!1},{id:"symptom_onset",checked:!1},{id:"no_preexisting",checked:!1},{id:"no_trauma",checked:!1}];function wt(){const a=St();return`
  ...
  `}function Et(){const a=document.getElementById("prerequisitesModal");if(!a){console.error("Prerequisites modal not found");return}console.log("Initializing prerequisites modal");const e=document.getElementById("closePrerequisites"),t=document.getElementById("cancelPrerequisites"),i=document.getElementById("confirmPrerequisites");console.log("Modal buttons found:",{closeBtn:!!e,cancelBtn:!!t,confirmBtn:!!i});const n=()=>{a.remove(),F("welcome")};e==null||e.addEventListener("click",n),t==null||t.addEventListener("click",n),i==null||i.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),console.log("Prerequisites confirm button clicked");const d=a.querySelectorAll(".toggle-input"),l=Array.from(d).every(c=>c.checked);if(console.log("All prerequisites checked:",l),l)console.log("Navigating to triage2"),a.remove(),F("triage2");else{console.log("Showing prerequisites warning");const c=document.getElementById("prerequisitesWarning");c&&(c.style.display="flex",c.classList.add("shake"),setTimeout(()=>c.classList.remove("shake"),500))}});const s=a.querySelectorAll(".toggle-input");s.forEach(o=>{o.addEventListener("change",()=>{const d=Array.from(s).every(c=>c.checked),l=document.getElementById("prerequisitesWarning");d&&l&&(l.style.display="none")})})}function Lt(){const a=document.getElementById("prerequisitesModal");a&&a.remove();const e=document.createElement("div");e.innerHTML=wt();const t=e.firstElementChild;document.body.appendChild(t),Et()}function Tt(a){p.logEvent("triage1_answer",{comatose:a}),a?F("coma"):Lt()}function $t(a){p.logEvent("triage2_answer",{examinable:a}),F(a?"full":"limited")}function F(a){p.logEvent("navigate",{from:p.getState().currentScreen,to:a}),p.navigate(a),window.scrollTo(0,0)}function Ct(){p.hasUnsavedData()&&!confirm("Are you sure you want to start over? All entered data will be lost.")||(p.logEvent("reset"),p.reset())}function At(){console.log("goBack() called");const a=p.goBack();console.log("goBack() success:",a),a?(p.logEvent("navigate_back"),window.scrollTo(0,0)):(console.log("No history available, going home instead"),we())}function we(){console.log("goHome() called"),p.logEvent("navigate_home"),p.goHome(),window.scrollTo(0,0)}async function Mt(a,e){a.preventDefault();const t=a.target,i=t.dataset.module,n=gt(t);if(!n.isValid){pt(e,n.validationErrors);try{const l=Object.keys(n.validationErrors)[0];if(l&&t.elements[l]){const m=t.elements[l];m.focus({preventScroll:!0}),m.scrollIntoView({behavior:"smooth",block:"center"})}const c=document.createElement("div");c.className="sr-only",c.setAttribute("role","status"),c.setAttribute("aria-live","polite");const u=Object.keys(n.validationErrors).length;c.textContent=`${u} field${u===1?"":"s"} need attention.`,document.body.appendChild(c),setTimeout(()=>c.remove(),1200)}catch{}return}const s={};Array.from(t.elements).forEach(l=>{if(l.name)if(l.type==="checkbox")s[l.name]=l.checked;else if(l.type==="number"){const c=parseFloat(l.value);s[l.name]=isNaN(c)?0:c}else l.type==="hidden"&&l.name==="armparese"?s[l.name]=l.value==="true":s[l.name]=l.value}),console.log("Collected form inputs:",s),p.setFormData(i,s);const o=t.querySelector("button[type=submit]"),d=o?o.innerHTML:"";o&&(o.disabled=!0,o.innerHTML=`<span class="loading-spinner"></span> ${r("analyzing")}`);try{let l;switch(i){case"coma":l={ich:await ft(s),lvo:null};break;case"limited":l={ich:await yt(s),lvo:{notPossible:!0}};break;case"full":l=await kt(s);break;default:throw new Error("Unknown module: "+i)}p.setResults(l),p.logEvent("models_complete",{module:i,results:l}),F("results")}catch(l){console.error("Error running models:",l);let c="An error occurred during analysis. Please try again.";l instanceof T&&(c=l.message),Pt(e,c),o&&(o.disabled=!1,o.innerHTML=d)}}function Pt(a,e){a.querySelectorAll(".critical-alert").forEach(n=>{var s,o;(o=(s=n.querySelector("h4"))==null?void 0:s.textContent)!=null&&o.includes("Error")&&n.remove()});const t=document.createElement("div");t.className="critical-alert",t.innerHTML=`<h4><span class="alert-icon">⚠️</span> Error</h4><p>${e}</p>`;const i=a.querySelector(".container");i?i.prepend(t):a.prepend(t),setTimeout(()=>t.remove(),1e4)}function Rt(a){const e=document.createElement("div");e.className="sr-only",e.setAttribute("role","status"),e.setAttribute("aria-live","polite");const t={triage1:"Coma assessment",triage2:"Examination capability assessment",coma:"Coma module",limited:"Limited data module",full:"Full stroke assessment",results:"Assessment results"};e.textContent=`Navigated to ${t[a]||a}`,document.body.appendChild(e),setTimeout(()=>e.remove(),1e3)}function It(a){const e="iGFAP",i={triage1:"Initial Assessment",triage2:"Examination Capability",coma:"Coma Module",limited:"Limited Data Module",full:"Full Stroke Module",results:"Assessment Results"}[a];document.title=i?`${e} — ${i}`:e}function Dt(){setTimeout(()=>{const a=document.querySelector("h2");a&&(a.setAttribute("tabindex","-1"),a.focus(),setTimeout(()=>a.removeAttribute("tabindex"),100))},100)}class Nt{constructor(){this.scores={facial_palsy:0,arm_weakness:0,speech_changes:0,eye_deviation:0,denial_neglect:0},this.onApply=null,this.modal=null}getTotal(){return Object.values(this.scores).reduce((e,t)=>e+t,0)}getRiskLevel(){return this.getTotal()>=4?"high":"low"}render(){const e=this.getTotal(),t=this.getRiskLevel();return`
