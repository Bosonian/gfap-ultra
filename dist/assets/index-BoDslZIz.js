(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();class q{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{},screenHistory:[]},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}notify(){this.listeners.forEach(e=>e(this.state))}getState(){return{...this.state}}setState(e){this.state={...this.state,...e},this.notify()}navigate(e){console.log(`Navigating from ${this.state.currentScreen} to ${e}`);const t=[...this.state.screenHistory];this.state.currentScreen!==e&&!t.includes(this.state.currentScreen)&&t.push(this.state.currentScreen),this.setState({currentScreen:e,screenHistory:t})}goBack(){const e=[...this.state.screenHistory];if(console.log("goBack() - current history:",e),console.log("goBack() - current screen:",this.state.currentScreen),e.length>0){const t=e.pop();return console.log("goBack() - navigating to:",t),this.setState({currentScreen:t,screenHistory:e}),!0}return console.log("goBack() - no history available"),!1}goHome(){this.setState({currentScreen:"triage1",screenHistory:[]})}setFormData(e,t){const a={...this.state.formData};a[e]={...t},this.setState({formData:a})}getFormData(e){return this.state.formData[e]||{}}setValidationErrors(e){this.setState({validationErrors:e})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(e){this.setState({results:e})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const e={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{},screenHistory:[]};this.setState(e),console.log("Store reset with new session:",e.sessionId)}logEvent(e,t={}){const a={timestamp:Date.now(),session:this.state.sessionId,event:e,data:t};console.log("Event:",a)}getSessionDuration(){return Date.now()-this.state.startTime}}const m=new q;function y(i){const e=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let t='<div class="progress-indicator">';return e.forEach((a,s)=>{const r=a.id===i,n=a.id<i;t+=`
  ...
  `}function ee(i){return!i||typeof i!="object"?{kind:"unavailable",units:null,positive:[],negative:[],meta:{}}:i.kind?i:i.shap_values||i.kind&&i.kind==="shap_values"?te(i):i.logistic_contributions||i.kind&&i.kind==="logistic_contributions"?ie(i):ne(i)?ae(i):{kind:"unavailable",units:null,positive:[],negative:[],meta:{}}}function te(i){const e=i.shap_values||i,t=[];Array.isArray(e)?e.forEach((n,l)=>{typeof n=="object"&&n.feature&&n.value!==void 0?t.push({label:n.feature,weight:n.value}):typeof n=="number"&&t.push({label:`Feature ${l}`,weight:n})}):typeof e=="object"&&Object.entries(e).forEach(([n,l])=>{typeof l=="number"&&t.push({label:n,weight:l})}),t.sort((n,l)=>Math.abs(l.weight)-Math.abs(n.weight));const a=t.filter(n=>n.weight>0),s=t.filter(n=>n.weight<0),r={};return i.base_value!==void 0&&(r.base_value=i.base_value),i.contrib_sum!==void 0&&(r.contrib_sum=i.contrib_sum),i.logit_total!==void 0&&(r.logit_total=i.logit_total),{kind:"shap_values",units:"logit",positive:a,negative:s,meta:r}}function ie(i){const e=i.logistic_contributions||i,t=[];typeof e=="object"&&Object.entries(e).forEach(([n,l])=>{typeof l=="number"&&!["intercept","contrib_sum","logit_total"].includes(n)&&t.push({label:n,weight:l})}),t.sort((n,l)=>Math.abs(l.weight)-Math.abs(n.weight));const a=t.filter(n=>n.weight>0),s=t.filter(n=>n.weight<0),r={};return e.intercept!==void 0&&(r.base_value=e.intercept),e.contrib_sum!==void 0&&(r.contrib_sum=e.contrib_sum),e.logit_total!==void 0&&(r.logit_total=e.logit_total),i.contrib_sum!==void 0&&(r.contrib_sum=i.contrib_sum),{kind:"logistic_contributions",units:"logit",positive:a,negative:s,meta:r}}function ae(i){const e=[];Object.entries(i).forEach(([s,r])=>{typeof r=="number"&&e.push({label:s,weight:r})}),e.sort((s,r)=>Math.abs(r.weight)-Math.abs(s.weight));const t=e.filter(s=>s.weight>0),a=e.filter(s=>s.weight<0);return{kind:"raw_weights",units:null,positive:t,negative:a,meta:{}}}function ne(i){return Object.values(i).every(e=>typeof e=="number")}function re(i,e){if(!(i!=null&&i.drivers)&&!(e!=null&&e.drivers))return"";let t=`
    <div class="drivers-section">
      <h3>Prediction Drivers</h3>
      <div class="drivers-grid">
  `;return i!=null&&i.drivers&&(t+=N(i.drivers,"ICH","ich")),e!=null&&e.drivers&&!e.notPossible&&(t+=N(e.drivers,"LVO","lvo")),t+=`
      </div>
    </div>
  `,t}function N(i,e,t){if(!i||Object.keys(i).length===0)return`
      <div class="drivers-panel">
        <h4>
          <span class="driver-icon ${t}">${t==="ich"?"I":"L"}</span>
          ${e} Risk Factors
        </h4>
  ...
  `}function me(i){const e=document.getElementById("useGpsButton"),t=document.getElementById("manualLocationButton"),a=document.querySelector(".location-manual"),s=document.getElementById("locationInput"),r=document.getElementById("searchLocationButton"),n=document.getElementById("strokeCenterResults");e&&e.addEventListener("click",()=>{ge(i,n)}),t&&t.addEventListener("click",()=>{a.style.display=a.style.display==="none"?"block":"none"}),r&&r.addEventListener("click",()=>{const l=s.value.trim();l&&F(l,i,n)}),s&&s.addEventListener("keypress",l=>{if(l.key==="Enter"){const c=s.value.trim();c&&F(c,i,n)}})}function ge(i,e){if(!navigator.geolocation){C(o("geolocationNotSupported"),e);return}e.innerHTML=`<div class="loading">${o("gettingLocation")}...</div>`,navigator.geolocation.getCurrentPosition(t=>{const{latitude:a,longitude:s}=t.coords;pe(a,s,i,e)},t=>{let a=o("locationError");switch(t.code){case t.PERMISSION_DENIED:a=o("locationPermissionDenied");break;case t.POSITION_UNAVAILABLE:a=o("locationUnavailable");break;case t.TIMEOUT:a=o("locationTimeout");break}C(a,e)},{enableHighAccuracy:!0,timeout:1e4,maximumAge:3e5})}async function F(i,e,t){t.innerHTML=`<div class="loading">${o("searchingLocation")}...</div>`,C(o("geocodingNotImplemented"),t)}async function pe(i,e,t,a){const s=he(t);a.innerHTML=`
    <div class="location-info">
      <p><strong>${o("yourLocation")}:</strong> ${i.toFixed(4)}, ${e.toFixed(4)}</p>
    </div>
    <div class="loading">${o("calculatingTravelTimes")}...</div>
  `;try{const r=await ce(i,e,s),n=`
      <div class="location-info">
        <p><strong>${o("yourLocation")}:</strong> ${i.toFixed(4)}, ${e.toFixed(4)}</p>
      </div>
    ...
    `;a.innerHTML=n}catch(r){console.warn("Travel time calculation failed, falling back to distance:",r);const n=de(i,e,s),l=`
      <div class="location-info">
        <p><strong>${o("yourLocation")}:</strong> ${i.toFixed(4)}, ${e.toFixed(4)}</p>
      </div>
    ...
    `;a.innerHTML=l}}function L(i,e=!1){return!i||i.length===0?`<p>${o("noCentersFound")}</p>`:i.map(t=>`
    <div class="stroke-center-card ${e?"recommended":"alternative"}">
      <div class="center-header">
        <h5>${t.name}</h5>
        <span class="center-type ${t.type}">${o(t.type+"Center")}</span>
        ${t.travelTime?`
          <span class="travel-time">
            <span class="time">${t.travelTime} ${o("minutes")}</span>
            <span class="distance">(${t.distance} km)</span>
          </span>
        `:`
      ...
      <div class="center-details">
        ...
        <p class="phone">📞 ${o("emergency")}: ${t.emergency}</p>
        ...
        ${t.certified?`
          <div class="certification">
            ✅ ${o("certified")}: ${t.certification}
          </div>
        `:""}
      </div>
      
      <div class="center-actions">
        <button class="call-button" onclick="window.open('tel:${t.emergency}')">
          📞 ${o("call")}
        </button>
  ...
  `).join("")}function he(i){return i?i.lvo&&i.lvo.probability>.5?"lvo":i.ich&&i.ich.probability>.6?"ich":"stroke":"stroke"}function C(i,e){e.innerHTML=`
    <div class="location-error">
      <p>⚠️ ${i}</p>
      <p><small>${o("tryManualEntry")}</small></p>
    </div>
  `}function z(i,e){const t=Number(i),a=$[e];return t>=a.critical?"🔴 CRITICAL RISK":t>=a.high?"🟠 HIGH RISK":t>=30?"🟡 MODERATE RISK":"🟢 LOW RISK"}function be(){const e=m.getState().formData;if(!e||Object.keys(e).length===0)return"";let t="";return Object.entries(e).forEach(([a,s])=>{if(s&&Object.keys(s).length>0){const r=o(`${a}ModuleTitle`)||a.charAt(0).toUpperCase()+a.slice(1);let n="";Object.entries(s).forEach(([l,c])=>{if(c===""||c===null||c===void 0)return;let g=l;o(`${l}Label`)?g=o(`${l}Label`):g=l.replace(/_/g," ").replace(/\b\w/g,f=>f.toUpperCase());let u=c;typeof c=="boolean"&&(u=c?"✓":"✗"),n+=`
  ...
  `:""}function fe(i,e){const{ich:t,lvo:a}=i;let s="",r="";if(t){const u=Math.round((t.probability||0)*100);s=`
      <div class="result-card ${u>$.ich.critical?"critical":"ich"}">
        <h3> 🧠 ${o("ichProbability")} <small>(${t.module} Module)</small> </h3>
    ...
    `}if(a)if(a.notPossible)r=`
      ...
      `;else{const u=Math.round((a.probability||0)*100);r=`
      ...
      `}const n=t&&t.probability>.6?X():"",l=re(t,a),c=ue(),g=be();return`
    <div class="container">
      ${y(3)}
  ...
  `}function ve(i,e,t){const a=[];return t.required&&!e&&e!==0&&a.push("This field is required"),t.min!==void 0&&e!==""&&!isNaN(e)&&parseFloat(e)<t.min&&a.push(`Value must be at least ${t.min}`),t.max!==void 0&&e!==""&&!isNaN(e)&&parseFloat(e)>t.max&&a.push(`Value must be at most ${t.max}`),t.pattern&&!t.pattern.test(e)&&a.push("Invalid format"),a}function ye(i){let e=!0;const t={};return Object.entries(Y).forEach(([a,s])=>{const r=i.elements[a];if(r){const n=ve(a,r.value,s);n.length>0&&(t[a]=n,e=!1)}}),{isValid:e,validationErrors:t}}function ke(i,e){Object.entries(e).forEach(([t,a])=>{const s=i.querySelector(`[name="${t}"]`);if(s){const r=s.closest(".input-group");if(r){r.classList.add("error"),r.querySelectorAll(".error-message").forEach(l=>l.remove());const n=document.createElement("div");n.className="error-message",n.innerHTML=`<span class="error-icon">⚠️</span> ${a[0]}`,r.appendChild(n)}}})}function Se(i){i.querySelectorAll(".input-group.error").forEach(e=>{e.classList.remove("error"),e.querySelectorAll(".error-message").forEach(t=>t.remove())})}class h extends Error{constructor(e,t,a){super(e),this.name="APIError",this.status=t,this.url=a}}function A(i){const e={...i};return Object.keys(e).forEach(t=>{const a=e[t];(typeof a=="boolean"||a==="on"||a==="true"||a==="false")&&(e[t]=a===!0||a==="on"||a==="true"?1:0)}),e}function b(i,e=0){const t=parseFloat(i);return isNaN(t)?e:t}async function _(i,e){const t=new AbortController,a=setTimeout(()=>t.abort(),D.requestTimeout);try{const s=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(e),signal:t.signal,mode:"cors"});if(clearTimeout(a),!s.ok){let n=`HTTP ${s.status}`;try{const l=await s.json();n=l.error||l.message||n}catch{n=`${n}: ${s.statusText}`}throw new h(n,s.status,i)}return await s.json()}catch(s){throw clearTimeout(a),s.name==="AbortError"?new h("Request timeout - please try again",408,i):s instanceof h?s:new h("Network error - please check your connection and try again",0,i)}}async function Le(i){const e=A(i);console.log("Coma ICH API Payload:",e);try{const t=await _(v.COMA_ICH,e);return console.log("Coma ICH API Response:",t),{probability:b(t.probability||t.ich_probability,0),drivers:t.drivers||null,confidence:b(t.confidence,.75),module:"Coma"}}catch(t){throw console.error("Coma ICH prediction failed:",t),new h(`Failed to get ICH prediction: ${t.message}`,t.status,v.COMA_ICH)}}async function Te(i){const e={age_years:i.age_years,systolic_bp:i.systolic_bp,diastolic_bp:i.diastolic_bp,gfap_value:i.gfap_value,vigilanzminderung:i.vigilanzminderung||0},t=A(e);console.log("Limited Data ICH API Payload:",t);try{const a=await _(v.LDM_ICH,t);return console.log("Limited Data ICH API Response:",a),{probability:b(a.probability||a.ich_probability,0),drivers:a.drivers||null,confidence:b(a.confidence,.65),module:"Limited Data"}}catch(a){throw console.error("Limited Data ICH prediction failed:",a),new h(`Failed to get ICH prediction: ${a.message}`,a.status,v.LDM_ICH)}}async function we(i){var a,s,r,n,l,c,g,u,f,M,P,x;const e={age_years:i.age_years,systolic_bp:i.systolic_bp,diastolic_bp:i.diastolic_bp,gfap_value:i.gfap_value,fast_ed_score:i.fast_ed_score,headache:i.headache||0,vigilanzminderung:i.vigilanzminderung||0,armparese:i.armparese||0,beinparese:i.beinparese||0,eye_deviation:i.eye_deviation||0,atrial_fibrillation:i.atrial_fibrillation||0,anticoagulated_noak:i.anticoagulated_noak||0,antiplatelets:i.antiplatelets||0},t=A(e);console.log("Full Stroke API Payload:",t);try{const d=await _(v.FULL_STROKE,t);console.log("Full Stroke API Response:",d),console.log("Available keys in response:",Object.keys(d)),console.log("Response type:",typeof d),Object.keys(d).forEach(B=>{const k=d[B];typeof k=="number"&&k>=0&&k<=1&&console.log(`Potential probability field: ${B} = ${k}`)});const V={probability:b(d.ich_probability||((a=d.ich)==null?void 0:a.probability)||d.ICH_probability||d.ich_prob||((s=d.probability)==null?void 0:s.ich)||((r=d.results)==null?void 0:r.ich_probability),0),drivers:d.ich_drivers||((n=d.ich)==null?void 0:n.drivers)||((l=d.drivers)==null?void 0:l.ich)||null,confidence:b(d.ich_confidence||((c=d.ich)==null?void 0:c.confidence),.85),module:"Full Stroke"},K={probability:b(d.lvo_probability||((g=d.lvo)==null?void 0:g.probability)||d.LVO_probability||d.lvo_prob||((u=d.probability)==null?void 0:u.lvo)||((f=d.results)==null?void 0:f.lvo_probability),0),drivers:d.lvo_drivers||((M=d.lvo)==null?void 0:M.drivers)||((P=d.drivers)==null?void 0:P.lvo)||null,confidence:b(d.lvo_confidence||((x=d.lvo)==null?void 0:x.confidence),.85),module:"Full Stroke"};return{ich:V,lvo:K}}catch(d){throw console.error("Full Stroke prediction failed:",d),new h(`Failed to get stroke predictions: ${d.message}`,d.status,v.FULL_STROKE)}}function Ee(i){m.logEvent("triage1_answer",{comatose:i}),I(i?"coma":"triage2")}function $e(i){m.logEvent("triage2_answer",{examinable:i}),I(i?"full":"limited")}function I(i){m.logEvent("navigate",{from:m.getState().currentScreen,to:i}),m.navigate(i),window.scrollTo(0,0)}function De(){m.hasUnsavedData()&&!confirm("Are you sure you want to start over? All entered data will be lost.")||(m.logEvent("reset"),m.reset())}function Ce(){console.log("goBack() called");const i=m.goBack();console.log("goBack() success:",i),i?(m.logEvent("navigate_back"),window.scrollTo(0,0)):(console.log("No history available, going home instead"),U())}function U(){console.log("goHome() called"),m.logEvent("navigate_home"),m.goHome(),window.scrollTo(0,0)}async function Ae(i,e){i.preventDefault();const t=i.target,a=t.dataset.module,s=ye(t);if(!s.isValid){ke(e,s.validationErrors);return}const r={};Array.from(t.elements).forEach(c=>{if(c.name)if(c.type==="checkbox")r[c.name]=c.checked;else if(c.type==="number"){const g=parseFloat(c.value);r[c.name]=isNaN(g)?0:g}else r[c.name]=c.value}),console.log("Collected form inputs:",r),m.setFormData(a,r);const n=t.querySelector("button[type=submit]"),l=n?n.innerHTML:"";n&&(n.disabled=!0,n.innerHTML=`<span class="loading-spinner"></span> ${o("analyzing")}`);try{let c;switch(a){case"coma":c={ich:await Le(r),lvo:null};break;case"limited":c={ich:await Te(r),lvo:{notPossible:!0}};break;case"full":c=await we(r);break;default:throw new Error("Unknown module: "+a)}m.setResults(c),m.logEvent("models_complete",{module:a,results:c}),I("results")}catch(c){console.error("Error running models:",c);let g="An error occurred during analysis. Please try again.";c instanceof h&&(g=c.message),_e(e,g),n&&(n.disabled=!1,n.innerHTML=l)}}function _e(i,e){i.querySelectorAll(".critical-alert").forEach(s=>{var r,n;(n=(r=s.querySelector("h4"))==null?void 0:r.textContent)!=null&&n.includes("Error")&&s.remove()});const t=document.createElement("div");t.className="critical-alert",t.innerHTML=`<h4><span class="alert-icon">⚠️</span> Error</h4><p>${e}</p>`;const a=i.querySelector(".container");a?a.prepend(t):i.prepend(t),setTimeout(()=>t.remove(),1e4)}function Ie(i){const e=document.createElement("div");e.className="sr-only",e.setAttribute("role","status"),e.setAttribute("aria-live","polite");const t={triage1:"Coma assessment",triage2:"Examination capability assessment",coma:"Coma module",limited:"Limited data module",full:"Full stroke assessment",results:"Assessment results"};e.textContent=`Navigated to ${t[i]||i}`,document.body.appendChild(e),setTimeout(()=>e.remove(),1e3)}function Me(i){const e={triage1:"Initial Assessment - Stroke Triage Assistant",triage2:"Examination Capability - Stroke Triage Assistant",coma:"Coma Module - Stroke Triage Assistant",limited:"Limited Data Module - Stroke Triage Assistant",full:"Full Stroke Module - Stroke Triage Assistant",results:"Assessment Results - Stroke Triage Assistant"};document.title=e[i]||"Stroke Triage Assistant"}function Pe(){setTimeout(()=>{const i=document.querySelector("h2");i&&(i.setAttribute("tabindex","-1"),i.focus(),setTimeout(()=>i.removeAttribute("tabindex"),100))},100)}function w(i){const e=m.getState(),{currentScreen:t,results:a,startTime:s}=e;i.innerHTML="";let r="";switch(t){case"triage1":r=R();break;case"triage2":r=W();break;case"coma":r=Z();break;case"limited":r=J();break;case"full":r=Q();break;case"results":r=fe(a);break;default:r=R()}i.innerHTML=r;const n=i.querySelector("form[data-module]");if(n){const l=n.dataset.module;xe(n,l)}Be(i),t==="results"&&a&&setTimeout(()=>{me(a)},100),Ie(t),Me(t),Pe()}function xe(i,e){const t=m.getFormData(e);!t||Object.keys(t).length===0||Object.entries(t).forEach(([a,s])=>{const r=i.elements[a];r&&(r.type==="checkbox"?r.checked=s===!0||s==="on"||s==="true":r.value=s)})}function Be(i){i.querySelectorAll('input[type="number"]').forEach(t=>{t.addEventListener("blur",()=>{Se(i)})}),i.querySelectorAll("[data-action]").forEach(t=>{t.addEventListener("click",a=>{const{action:s,value:r}=a.currentTarget.dataset,n=r==="true";switch(s){case"triage1":Ee(n);break;case"triage2":$e(n);break;case"reset":De();break;case"goBack":Ce();break;case"goHome":U();break}})}),i.querySelectorAll("form[data-module]").forEach(t=>{t.addEventListener("submit",a=>{Ae(a,i)})});const e=i.querySelector("#printResults");e&&e.addEventListener("click",()=>window.print())}class He{constructor(){this.container=null,this.unsubscribe=null}async init(){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.init());return}if(this.container=document.getElementById("appContainer"),!this.container){console.error("App container not found");return}this.unsubscribe=m.subscribe(()=>{w(this.container)}),window.addEventListener("languageChanged",()=>{this.updateUILanguage(),w(this.container)}),this.setupGlobalEventListeners(),this.initializeTheme(),this.updateUILanguage(),this.startAutoSave(),this.setupSessionTimeout(),this.setCurrentYear(),this.registerServiceWorker(),w(this.container),console.log("Stroke Triage Assistant initialized")}setupGlobalEventListeners(){const e=document.getElementById("languageToggle");e&&e.addEventListener("click",()=>this.toggleLanguage());const t=document.getElementById("darkModeToggle");t&&t.addEventListener("click",()=>this.toggleDarkMode()),this.setupHelpModal(),this.setupFooterLinks(),document.addEventListener("keydown",a=>{if(a.key==="Escape"){const s=document.getElementById("helpModal");s&&s.classList.contains("show")&&(s.classList.remove("show"),s.setAttribute("aria-hidden","true"))}}),window.addEventListener("beforeunload",a=>{m.hasUnsavedData()&&(a.preventDefault(),a.returnValue="You have unsaved data. Are you sure you want to leave?")})}setupHelpModal(){const e=document.getElementById("helpButton"),t=document.getElementById("helpModal"),a=t==null?void 0:t.querySelector(".modal-close");e&&t&&(e.addEventListener("click",()=>{t.classList.add("show"),t.setAttribute("aria-hidden","false")}),a==null||a.addEventListener("click",()=>{t.classList.remove("show"),t.setAttribute("aria-hidden","true")}),t.addEventListener("click",s=>{s.target===t&&(t.classList.remove("show"),t.setAttribute("aria-hidden","true"))}))}setupFooterLinks(){var e,t;(e=document.getElementById("privacyLink"))==null||e.addEventListener("click",a=>{a.preventDefault(),this.showPrivacyPolicy()}),(t=document.getElementById("disclaimerLink"))==null||t.addEventListener("click",a=>{a.preventDefault(),this.showDisclaimer()})}initializeTheme(){const e=localStorage.getItem("theme"),t=document.getElementById("darkModeToggle");(e==="dark"||!e&&window.matchMedia("(prefers-color-scheme: dark)").matches)&&(document.body.classList.add("dark-mode"),t&&(t.textContent="☀️"))}toggleLanguage(){E.toggleLanguage(),this.updateUILanguage()}updateUILanguage(){document.documentElement.lang=E.getCurrentLanguage();const e=document.querySelector(".app-header h1");e&&(e.textContent=o("appTitle"));const t=document.querySelector(".emergency-badge");t&&(t.textContent=o("emergencyBadge"));const a=document.getElementById("languageToggle");a&&(a.title=o("languageToggle"),a.setAttribute("aria-label",o("languageToggle")));const s=document.getElementById("helpButton");s&&(s.title=o("helpButton"),s.setAttribute("aria-label",o("helpButton")));const r=document.getElementById("darkModeToggle");r&&(r.title=o("darkModeButton"),r.setAttribute("aria-label",o("darkModeButton")));const n=document.getElementById("modalTitle");n&&(n.textContent=o("helpTitle"))}toggleDarkMode(){const e=document.getElementById("darkModeToggle");document.body.classList.toggle("dark-mode");const t=document.body.classList.contains("dark-mode");e&&(e.textContent=t?"☀️":"🌙"),localStorage.setItem("theme",t?"dark":"light")}startAutoSave(){setInterval(()=>{this.saveCurrentFormData()},D.autoSaveInterval)}saveCurrentFormData(){this.container.querySelectorAll("form[data-module]").forEach(t=>{const a=new FormData(t),s=t.dataset.module;if(s){const r={};a.forEach((c,g)=>{const u=t.elements[g];u&&u.type==="checkbox"?r[g]=u.checked:r[g]=c});const n=m.getFormData(s);JSON.stringify(n)!==JSON.stringify(r)&&m.setFormData(s,r)}})}setupSessionTimeout(){setTimeout(()=>{confirm("Your session has been idle for 30 minutes. Would you like to continue?")?this.setupSessionTimeout():m.reset()},D.sessionTimeout)}setCurrentYear(){const e=document.getElementById("currentYear");e&&(e.textContent=new Date().getFullYear())}showPrivacyPolicy(){alert("Privacy Policy: This tool processes data locally. No patient data is stored or transmitted.")}showDisclaimer(){alert("Medical Disclaimer: This tool is for clinical decision support only. Always use clinical judgment and follow local protocols.")}async registerServiceWorker(){if(!("serviceWorker"in navigator)){console.log("Service Workers not supported");return}try{const e=await navigator.serviceWorker.register("/0825/sw.js",{scope:"/0825/"});console.log("Service Worker registered successfully:",e),e.addEventListener("updatefound",()=>{const t=e.installing;console.log("New service worker found"),t.addEventListener("statechange",()=>{t.state==="installed"&&navigator.serviceWorker.controller&&(console.log("New service worker installed, update available"),this.showUpdateNotification())})}),navigator.serviceWorker.addEventListener("message",t=>{console.log("Message from service worker:",t.data)})}catch(e){console.error("Service Worker registration failed:",e)}}showUpdateNotification(){const e=document.createElement("div");e.style.cssText=`
      position: fixed;
      top: 70px;
      right: 20px;
    ...
    `,e.textContent="App update available - Tap to refresh",e.addEventListener("click",()=>{window.location.reload()}),document.body.appendChild(e),setTimeout(()=>{e.parentNode&&e.remove()},1e4)}destroy(){this.unsubscribe&&this.unsubscribe()}}const Re=new He;Re.init();
//# sourceMappingURL=index-BoDslZIz.js.map
