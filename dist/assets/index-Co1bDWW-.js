var fe=Object.defineProperty;var ve=(a,t,e)=>t in a?fe(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var _=(a,t,e)=>ve(a,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=e(n);fetch(n.href,s)}})();class ye{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{},screenHistory:[]},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}notify(){this.listeners.forEach(t=>t(this.state))}getState(){return{...this.state}}setState(t){this.state={...this.state,...t},this.notify()}navigate(t){console.log(`Navigating from ${this.state.currentScreen} to ${t}`);const e=[...this.state.screenHistory];this.state.currentScreen!==t&&!e.includes(this.state.currentScreen)&&e.push(this.state.currentScreen),this.setState({currentScreen:t,screenHistory:e})}goBack(){const t=[...this.state.screenHistory];if(console.log("goBack() - current history:",t),console.log("goBack() - current screen:",this.state.currentScreen),t.length>0){const e=t.pop();return console.log("goBack() - navigating to:",e),this.setState({currentScreen:e,screenHistory:t}),!0}return console.log("goBack() - no history available"),!1}goHome(){this.setState({currentScreen:"triage1",screenHistory:[]})}setFormData(t,e){const i={...this.state.formData};i[t]={...e},this.setState({formData:i})}getFormData(t){return this.state.formData[t]||{}}setValidationErrors(t){this.setState({validationErrors:t})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(t){this.setState({results:t})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const t={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{},screenHistory:[]};this.setState(t),console.log("Store reset with new session:",t.sessionId)}logEvent(t,e={}){const i={timestamp:Date.now(),session:this.state.sessionId,event:t,data:e};console.log("Event:",i)}getSessionDuration(){return Date.now()-this.state.startTime}}const g=new ye;function E(a){const t=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let e='<div class="progress-indicator">';return t.forEach((i,n)=>{const s=i.id===a,o=i.id<a;e+=`
  ...
  `}function Ne(a){const t=document.getElementById("useGpsButton"),e=document.getElementById("manualLocationButton"),i=document.querySelector(".location-manual"),n=document.getElementById("locationInput"),s=document.getElementById("searchLocationButton"),o=document.getElementById("strokeCenterResults");t&&t.addEventListener("click",()=>{Ie(a,o)}),e&&e.addEventListener("click",()=>{i.style.display=i.style.display==="none"?"block":"none"}),s&&s.addEventListener("click",()=>{const l=n.value.trim();l&&j(l,a,o)}),n&&n.addEventListener("keypress",l=>{if(l.key==="Enter"){const c=n.value.trim();c&&j(c,a,o)}})}function Ie(a,t){if(!navigator.geolocation){R(r("geolocationNotSupported"),t);return}t.innerHTML=`<div class="loading">${r("gettingLocation")}...</div>`,navigator.geolocation.getCurrentPosition(e=>{const{latitude:i,longitude:n}=e.coords;z(i,n,a,t)},e=>{let i=r("locationError");switch(e.code){case e.PERMISSION_DENIED:i=r("locationPermissionDenied");break;case e.POSITION_UNAVAILABLE:i=r("locationUnavailable");break;case e.TIMEOUT:i=r("locationTimeout");break}R(i,t)},{enableHighAccuracy:!0,timeout:1e4,maximumAge:3e5})}async function j(a,t,e){e.innerHTML=`<div class="loading">${r("searchingLocation")}...</div>`;const i=/^(-?\d+\.?\d*)\s*,\s*(-?\d+\.?\d*)$/,n=a.trim().match(i);if(n){const s=parseFloat(n[1]),o=parseFloat(n[2]);if(s>=47.2&&s<=52.5&&o>=5.9&&o<=15){e.innerHTML=`
        <div class="location-success">
          <p>📍 Coordinates: ${s.toFixed(4)}, ${o.toFixed(4)}</p>
        </div>
      `,setTimeout(()=>{z(s,o,t,e)},500);return}else{R("Coordinates appear to be outside Germany. Please check the values.",e);return}}try{let s=a.trim();!s.toLowerCase().includes("deutschland")&&!s.toLowerCase().includes("germany")&&!s.toLowerCase().includes("bayern")&&!s.toLowerCase().includes("bavaria")&&!s.toLowerCase().includes("nordrhein")&&!s.toLowerCase().includes("baden")&&(s=s+", Deutschland");const l=`https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(s)}&countrycodes=de&format=json&limit=3&addressdetails=1`,c=await fetch(l,{method:"GET",headers:{Accept:"application/json","User-Agent":"iGFAP-StrokeTriage/2.1.0"}});if(!c.ok)throw new Error(`Geocoding API error: ${c.status}`);const d=await c.json();if(d&&d.length>0){let m=d[0];const p=["Bayern","Baden-Württemberg","Nordrhein-Westfalen"];for(const h of d)if(h.address&&p.includes(h.address.state)){m=h;break}const b=parseFloat(m.lat),f=parseFloat(m.lon),u=m.display_name||a;e.innerHTML=`
        <div class="location-success">
          <p>📍 Found: ${u}</p>
    ...
    `,e)}}async function z(a,t,e,i){var l,c;const n={lat:a,lng:t},s=Pe.routePatient({location:n,ichProbability:((l=e==null?void 0:e.ich)==null?void 0:l.probability)||0,timeFromOnset:(e==null?void 0:e.timeFromOnset)||null,clinicalFactors:(e==null?void 0:e.clinicalFactors)||{}});if(!s||!s.destination){i.innerHTML=`
  ...
  `;try{const d=se[s.state],m=[...d.neurosurgicalCenters,...d.comprehensiveStrokeCenters,...d.regionalStrokeUnits,...d.thrombolysisHospitals||[]],p=s.destination;p.distance=B(a,t,p.coordinates.lat,p.coordinates.lng);try{const u=await Y(a,t,p.coordinates.lat,p.coordinates.lng);p.travelTime=u.duration,p.travelSource=u.source}catch{p.travelTime=Math.round(p.distance/.8),p.travelSource="estimated"}const b=m.filter(u=>u.id!==p.id).map(u=>({...u,distance:B(a,t,u.coordinates.lat,u.coordinates.lng)})).sort((u,h)=>u.distance-h.distance).slice(0,3);for(const u of b)try{const h=await Y(a,t,u.coordinates.lat,u.coordinates.lng);u.travelTime=h.duration,u.travelSource=h.source}catch{u.travelTime=Math.round(u.distance/.8),u.travelSource="estimated"}const f=`
      <div class="location-info">
        <p><strong>${r("yourLocation")}:</strong> ${a.toFixed(4)}, ${t.toFixed(4)}</p>
  ...
  `}function De(a,t){const e=Number(a),i=O[t];return e>=i.high?"🔴 HIGH RISK":e>=i.medium?"🟡 MEDIUM RISK":"🟢 LOW RISK"}const x={moderate:{min:10},high:{min:20},critical:{min:30}};function re(a){if(!a||a<=0)return{volume:0,volumeRange:{min:0,max:0},riskLevel:"low",mortalityRate:"~0%",isValid:!0,calculation:"No hemorrhage detected"};const t=Math.min(a,1e4);a>1e4&&console.warn(`GFAP value ${a} exceeds expected range, capped at 10,000 pg/ml`);try{const e=.0192+.4533*Math.log10(t),i=Math.pow(10,e),n={min:i*.7,max:i*1.3},s=Be(i),o=Fe(i),l=i<1?"<1":i.toFixed(1);return{volume:i,displayVolume:l,volumeRange:{min:n.min.toFixed(1),max:n.max.toFixed(1)},riskLevel:s,mortalityRate:o,isValid:!0,calculation:`Based on GFAP ${a} pg/ml`,threshold:i>=30?"SURGICAL":i>=20?"HIGH_RISK":"MANAGEABLE"}}catch(e){return console.error("Volume calculation error:",e),{volume:0,volumeRange:{min:0,max:0},riskLevel:"low",mortalityRate:"Unknown",isValid:!1,calculation:"Calculation error",error:e.message}}}function Be(a){return a>=x.critical.min?"critical":a>=x.high.min?"high":a>=x.moderate.min?"moderate":"low"}function Fe(a){return a<10?"5-10%⁴":a<30?`${Math.round(10+(a-10)*9/20)}%⁴`:a<50?`${Math.round(19+(a-30)*25/20)}%³`:a<60?`${Math.round(44+(a-50)*47/10)}%²`:a<80?`${Math.round(91+(a-60)*5/20)}%¹`:"96-100%¹"}function He(a){return a<1?"<1 ml":a<10?`${a.toFixed(1)} ml`:`${Math.round(a)} ml`}function xe(a){if(!a||a<=0)return`
...
`)}static exportAsJSON(){const t=this.getStoredData();return JSON.stringify(t,null,2)}static downloadData(t="csv"){try{const e=t==="csv"?this.exportAsCSV():this.exportAsJSON(),i=`igfap-research-${Date.now()}.${t}`,n=new Blob([e],{type:t==="csv"?"text/csv":"application/json"}),s=URL.createObjectURL(n),o=document.createElement("a");return o.href=s,o.download=i,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(s),console.log(`📥 Downloaded research data: ${i}`),!0}catch(e){return console.error("Failed to download research data:",e),!1}}static clearData(){try{return localStorage.removeItem(this.STORAGE_KEY),console.log("🗑️ Research data cleared"),!0}catch(t){return console.warn("Failed to clear research data:",t),!1}}static getDataSummary(){var s,o;const t=this.getStoredData();if(!t.entries||t.entries.length===0)return{totalEntries:0,dateRange:null,avgDifference:null};const e=t.entries,i=e.map(l=>{var c,d;return(d=(c=l.comparison)==null?void 0:c.differences)==null?void 0:d.absolute}).filter(l=>l!=null),n=i.length>0?i.reduce((l,c)=>l+Math.abs(c),0)/i.length:0;return{totalEntries:e.length,dateRange:{first:(s=e[0])==null?void 0:s.timestamp,last:(o=e[e.length-1])==null?void 0:o.timestamp},avgAbsoluteDifference:Math.round(n*10)/10,storageSize:JSON.stringify(t).length}}static generateEntryId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}static getSessionId(){let t=sessionStorage.getItem("research_session_id");return t||(t="session_"+Date.now().toString(36),sessionStorage.setItem("research_session_id",t)),t}}_(A,"STORAGE_KEY","igfap_research_data"),_(A,"MAX_ENTRIES",1e3);function Ke(a,t,e){try{if(!w())return;const i={inputs:{age:e.age_years||e.age,gfap:e.gfap_value||e.gfap,module:a.module||"unknown"},main:{probability:a.probability,module:a.module,confidence:a.confidence},legacy:t,comparison:t?I.compareModels(a,t):null};A.logComparison(i)}catch(i){console.warn("Research logging failed (non-critical):",i)}}function w(a=null){var t;if(a==="coma")return!1;if(a==="limited"||a==="full")return!0;if(typeof window<"u")try{const e=window.store||((t=require("../state/store.js"))==null?void 0:t.store);if(e){const i=e.getState().formData;return i.limited||i.full}}catch{}return!1}function oe(){return""}function le(a,t,e){if(!(t!=null&&t.isValid))return console.log("🔬 Legacy model results invalid:",t),`
    ...
    `;const i=I.compareModels(a,t);return`
    <div class="research-panel" id="researchPanel" style="display: none;">
      <div class="research-header">
        <h4>🔬 Model Comparison (Research)</h4>
        <button class="close-research" id="closeResearch">×</button>
  ...
  `}function Ge(a){if(!a.isValid)return'<div class="comparison-error">Unable to compare models</div>';const{differences:t,agreement:e}=a;return`
  ...
  `}function qe(){const a=I.getModelMetadata();return`
  ...
  `:""}function de(a,t,e){if(!t)return"";const i=Math.round((t.probability||0)*100),n=De(i,a),s=i>O[a].critical,o=i>O[a].high,l={ich:"🩸",lvo:"🧠"},c={ich:r("ichProbability"),lvo:r("lvoProbability")},d={ich:"ICH",lvo:P.getCurrentLanguage()==="de"?"Großgefäßverschluss":"Large Vessel Occlusion"};return`
  ...
  `}function F(){var e;const t=g.getState().formData;for(const i of["coma","limited","full"])if((e=t[i])!=null&&e.gfap_value)return parseFloat(t[i].gfap_value);return 0}function Je(a,t){const{ich:e,lvo:i}=a,n=tt(e),s=n!=="coma"?et():null;w(n)&&console.log("🔬 Research Debug:",{module:n,mainResults:e,legacyResults:s,patientInputs:N()}),s&&w(n)&&Ke(e,s,N());const o=(e==null?void 0:e.module)==="Limited"||(e==null?void 0:e.module)==="Coma"||(i==null?void 0:i.notPossible)===!0;e==null||e.module;let l;return o?l=Ze(e,a,t,s,n):l=Qe(e,i,a,t,s,n),setTimeout(()=>{Oe()},100),l}function Ze(a,t,e,i,n){const s=a&&a.probability>.6?ae():"",o=ne(),l=ce(),c=w(n)?oe():"",d=i&&w(n)?le(a,i,N()):"";return`
    <div class="container">
      ${E(3)}
  ...
  `}function Qe(a,t,e,i,n,s){const o=Math.round(((a==null?void 0:a.probability)||0)*100),l=Math.round(((t==null?void 0:t.probability)||0)*100),c=a&&a.probability>.6?ae():"",d=ne(),m=ce(),p=w(s)?oe():"",b=n&&w(s)?le(a,n,N()):"",f=o<30&&l>50;return`
    <div class="container">
      ${E(3)}
...
//# sourceMappingURL=index-Co1bDWW-.js.map
