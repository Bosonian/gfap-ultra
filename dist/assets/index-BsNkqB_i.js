var Ie=Object.defineProperty;var De=(t,e,i)=>e in t?Ie(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var V=(t,e,i)=>De(t,typeof e!="symbol"?e+"":e,i);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function i(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(s){if(s.ep)return;s.ep=!0;const n=i(s);fetch(s.href,n)}})();class _e{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{},screenHistory:[]},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}notify(){this.listeners.forEach(e=>e(this.state))}getState(){return{...this.state}}setState(e){this.state={...this.state,...e},this.notify()}navigate(e){console.log(`Navigating from ${this.state.currentScreen} to ${e}`);const i=[...this.state.screenHistory];this.state.currentScreen!==e&&!i.includes(this.state.currentScreen)&&i.push(this.state.currentScreen),this.setState({currentScreen:e,screenHistory:i})}goBack(){const e=[...this.state.screenHistory];if(console.log("goBack() - current history:",e),console.log("goBack() - current screen:",this.state.currentScreen),e.length>0){const i=e.pop();return console.log("goBack() - navigating to:",i),this.setState({currentScreen:i,screenHistory:e}),!0}return console.log("goBack() - no history available"),!1}goHome(){this.setState({currentScreen:"triage1",screenHistory:[]})}setFormData(e,i){const a={...this.state.formData};a[e]={...i},this.setState({formData:a})}getFormData(e){return this.state.formData[e]||{}}setValidationErrors(e){this.setState({validationErrors:e})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(e){this.setState({results:e})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const e={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{},screenHistory:[]};this.setState(e),console.log("Store reset with new session:",e.sessionId)}logEvent(e,i={}){const a={timestamp:Date.now(),session:this.state.sessionId,event:e,data:i};console.log("Event:",a)}getSessionDuration(){return Date.now()-this.state.startTime}}const p=new _e;function P(t){const e=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let i='<div class="progress-indicator">';return e.forEach((a,s)=>{const n=a.id===t,r=a.id<t;i+=`
  ...
  `}const A={COMA_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_coma_ich",LDM_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_limited_data_ich",FULL_STROKE:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_full_stroke"},ve={ich:{medium:25,high:50},lvo:{medium:25,high:50}},L={min:29,max:10001},Y={autoSaveInterval:18e4,sessionTimeout:30*60*1e3,requestTimeout:1e4},Be={age_years:{required:!0,min:0,max:120},systolic_bp:{required:!0,min:60,max:300},diastolic_bp:{required:!0,min:30,max:200},gfap_value:{required:!0,min:L.min,max:L.max},fast_ed_score:{required:!0,min:0,max:9}};function xe(){return`
    <div class="container">
      ${P(2)}
        ...
        <div class="input-grid">
          <div class="input-group">
            ...
            <div id="gfap-help" class="input-help">
              ${o("gfapRange").replace("{min}",L.min).replace("{max}",L.max)}
            </div>
          </div>
        </div>
  ...
  `}const Ve="modulepreload",ze=function(t){return"/0825/"+t},oe={},qe=function(e,i,a){let s=Promise.resolve();if(i&&i.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),c=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));s=Promise.allSettled(i.map(l=>{if(l=ze(l),l in oe)return;oe[l]=!0;const d=l.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const m=document.createElement("link");if(m.rel=d?"stylesheet":Ve,d||(m.as="script"),m.crossOrigin="",m.href=l,c&&m.setAttribute("nonce",c),document.head.appendChild(m),d)return new Promise((b,v)=>{m.addEventListener("load",b),m.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(r){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=r,window.dispatchEvent(c),!c.defaultPrevented)throw r}return s.then(r=>{for(const c of r||[])c.status==="rejected"&&n(c.reason);return e().catch(n)})};function fe(){return`
    <div class="critical-alert">
      <h4><span class="alert-icon">🚨</span> ${o("criticalAlertTitle")}</h4>
      <p>${o("criticalAlertMessage")}</p>
    </div>
  `}const Ue={age_years:"ageLabel",age:"ageLabel",systolic_bp:"systolicLabel",diastolic_bp:"diastolicLabel",systolic_blood_pressure:"systolicLabel",diastolic_blood_pressure:"diastolicLabel",blood_pressure_systolic:"systolicLabel",blood_pressure_diastolic:"diastolicLabel",gfap_value:"gfapLabel",gfap:"gfapLabel",gfap_level:"gfapLabel",fast_ed_score:"fastEdLabel",fast_ed:"fastEdLabel",fast_ed_total:"fastEdLabel",vigilanzminderung:"vigilanzLabel",vigilance_reduction:"vigilanzLabel",reduced_consciousness:"vigilanzLabel",armparese:"armPareseLabel",arm_paresis:"armPareseLabel",arm_weakness:"armPareseLabel",beinparese:"beinPareseLabel",leg_paresis:"beinPareseLabel",leg_weakness:"beinPareseLabel",eye_deviation:"eyeDeviationLabel",blickdeviation:"eyeDeviationLabel",headache:"headacheLabel",kopfschmerzen:"headacheLabel",atrial_fibrillation:"atrialFibLabel",vorhofflimmern:"atrialFibLabel",anticoagulated_noak:"anticoagLabel",anticoagulation:"anticoagLabel",antiplatelets:"antiplateletsLabel",thrombozytenaggregationshemmer:"antiplateletsLabel"},Ke=[{pattern:/_score$/,replacement:" Score"},{pattern:/_value$/,replacement:" Level"},{pattern:/_bp$/,replacement:" Blood Pressure"},{pattern:/_years?$/,replacement:" (years)"},{pattern:/^ich_/,replacement:"Brain Bleeding "},{pattern:/^lvo_/,replacement:"Large Vessel "},{pattern:/parese$/,replacement:"Weakness"},{pattern:/deviation$/,replacement:"Movement"}];function q(t){if(!t)return"";const e=Ue[t.toLowerCase()];if(e){const a=o(e);if(a&&a!==e)return a}let i=t.toLowerCase();return Ke.forEach(({pattern:a,replacement:s})=>{i=i.replace(a,s)}),i=i.replace(/_/g," ").replace(/\b\w/g,a=>a.toUpperCase()).trim(),i}function We(t){return q(t).replace(/\s*\([^)]*\)\s*/g,"").trim()}function Ge(t,e=""){return t==null||t===""?"":typeof t=="boolean"?t?"✓":"✗":typeof t=="number"?e.includes("bp")||e.includes("blood_pressure")?`${t} mmHg`:e.includes("gfap")?`${t} pg/mL`:e.includes("age")?`${t} years`:e.includes("score")||Number.isInteger(t)?t.toString():t.toFixed(1):t.toString()}function Ye(t,e){if(console.log("=== DRIVER RENDERING SECTION ==="),console.log("🧠 ICH result received:",{probability:t==null?void 0:t.probability,hasDrivers:!!(t!=null&&t.drivers),module:t==null?void 0:t.module}),console.log("🩸 LVO result received:",{probability:e==null?void 0:e.probability,hasDrivers:!!(e!=null&&e.drivers),module:e==null?void 0:e.module,notPossible:e==null?void 0:e.notPossible}),!(t!=null&&t.drivers)&&!(e!=null&&e.drivers))return console.log("❌ No drivers available for rendering"),"";let i=`
  ...
  `;return t!=null&&t.drivers&&(console.log("🧠 Rendering ICH drivers panel"),i+=le(t.drivers,"ICH","ich",t.probability)),e!=null&&e.drivers&&!e.notPossible&&(console.log("🩸 Rendering LVO drivers panel"),i+=le(e.drivers,"LVO","lvo",e.probability)),i+=`
      </div>
    </div>
  `,i}function le(t,e,i,a){if(console.log(`--- ${e} Driver Panel Debug ---`),console.log("Raw drivers input:",t),console.log("Title:",e,"Type:",i,"Probability:",a),!t||Object.keys(t).length===0)return console.log(`No drivers data for ${e}`),`
    ...
    `;const n=s.positive.sort((d,u)=>Math.abs(u.weight)-Math.abs(d.weight)).slice(0,3),r=s.negative.sort((d,u)=>Math.abs(u.weight)-Math.abs(d.weight)).slice(0,3);console.log(`🎯 ${e} Final displayed drivers:`),console.log("  Top positive:",n.map(d=>`${d.label}: +${(Math.abs(d.weight)*100).toFixed(1)}%`)),console.log("  Top negative:",r.map(d=>`${d.label}: -${(Math.abs(d.weight)*100).toFixed(1)}%`));const c=Math.max(...n.map(d=>Math.abs(d.weight)),...r.map(d=>Math.abs(d.weight)),.01);let l=`
    <div class="enhanced-drivers-panel ${i}">
      <div class="panel-header">
        <div class="panel-icon ${i}">${i==="ich"?"🩸":"🧠"}</div>
        <div class="panel-title">
  ...
  `;return n.length>0?n.forEach(d=>{const u=Math.abs(d.weight*100),m=Math.abs(d.weight)/c*100,b=q(d.label);l+=`
      ...
      `}):l+=`<div class="no-factors">${o("noPositiveFactors")}</div>`,l+=`
        ...
        <div class="drivers-column negative-column">
          ...
          <div class="compact-drivers">
  `,r.length>0?r.forEach(d=>{const u=Math.abs(d.weight*100),m=Math.abs(d.weight)/c*100,b=q(d.label);l+=`
        <div class="compact-driver-item">
          <div class="compact-driver-label">${b}</div>
  ...
  `}function Ze(t){const e=document.getElementById("useGpsButton"),i=document.getElementById("manualLocationButton"),a=document.querySelector(".location-manual"),s=document.getElementById("locationInput"),n=document.getElementById("searchLocationButton"),r=document.getElementById("strokeCenterResults");e&&e.addEventListener("click",()=>{Qe(t,r)}),i&&i.addEventListener("click",()=>{a.style.display=a.style.display==="none"?"block":"none"}),n&&n.addEventListener("click",()=>{const c=s.value.trim();c&&de(c,t,r)}),s&&s.addEventListener("keypress",c=>{if(c.key==="Enter"){const l=s.value.trim();l&&de(l,t,r)}})}function Qe(t,e){if(!navigator.geolocation){N(o("geolocationNotSupported"),e);return}e.innerHTML=`<div class="loading">${o("gettingLocation")}...</div>`,navigator.geolocation.getCurrentPosition(i=>{const{latitude:a,longitude:s}=i.coords;j(a,s,t,e)},i=>{let a=o("locationError");switch(i.code){case i.PERMISSION_DENIED:a=o("locationPermissionDenied");break;case i.POSITION_UNAVAILABLE:a=o("locationUnavailable");break;case i.TIMEOUT:a=o("locationTimeout");break}N(a,e)},{enableHighAccuracy:!0,timeout:1e4,maximumAge:3e5})}async function de(t,e,i){i.innerHTML=`<div class="loading">${o("searchingLocation")}...</div>`;const a=/^(-?\d+\.?\d*)\s*,\s*(-?\d+\.?\d*)$/,s=t.trim().match(a);if(s){const n=parseFloat(s[1]),r=parseFloat(s[2]);if(n>=47.2&&n<=52.5&&r>=5.9&&r<=15){i.innerHTML=`
        <div class="location-success">
          <p>📍 Coordinates: ${n.toFixed(4)}, ${r.toFixed(4)}</p>
        </div>
      `,setTimeout(()=>{j(n,r,e,i)},500);return}else{N("Coordinates appear to be outside Germany. Please check the values.",i);return}}try{let n=t.trim();!n.toLowerCase().includes("deutschland")&&!n.toLowerCase().includes("germany")&&!n.toLowerCase().includes("bayern")&&!n.toLowerCase().includes("bavaria")&&!n.toLowerCase().includes("nordrhein")&&!n.toLowerCase().includes("baden")&&(n=n+", Deutschland");const c=`https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(n)}&countrycodes=de&format=json&limit=3&addressdetails=1`,l=await fetch(c,{method:"GET",headers:{Accept:"application/json","User-Agent":"iGFAP-StrokeTriage/2.1.0"}});if(!l.ok)throw new Error(`Geocoding API error: ${l.status}`);const d=await l.json();if(d&&d.length>0){let u=d[0];const m=["Bayern","Baden-Württemberg","Nordrhein-Westfalen"];for(const h of d)if(h.address&&m.includes(h.address.state)){u=h;break}const b=parseFloat(u.lat),v=parseFloat(u.lon),g=u.display_name||t;i.innerHTML=`
        <div class="location-success">
          <p>📍 Found: ${g}</p>
          <small style="color: #666;">Lat: ${b.toFixed(4)}, Lng: ${v.toFixed(4)}</small>
        </div>
      `,setTimeout(()=>{j(b,v,e,i)},1e3)}else N(`
    ...
    `,i)}}async function j(t,e,i,a){var c,l;const s={lat:t,lng:e},n=je.routePatient({location:s,ichProbability:((c=i==null?void 0:i.ich)==null?void 0:c.probability)||0,timeFromOnset:(i==null?void 0:i.timeFromOnset)||null,clinicalFactors:(i==null?void 0:i.clinicalFactors)||{}});if(!n||!n.destination){a.innerHTML=`
    ...
    `;return}const r=Xe(n,i);a.innerHTML=`
    <div class="location-info">
      <p><strong>${o("yourLocation")}:</strong> ${t.toFixed(4)}, ${e.toFixed(4)}</p>
      <p><strong>Detected State:</strong> ${ue(n.state)}</p>
    </div>
    <div class="loading">${o("calculatingTravelTimes")}...</div>
  `;try{const d=ye[n.state],u=[...d.neurosurgicalCenters,...d.comprehensiveStrokeCenters,...d.regionalStrokeUnits,...d.thrombolysisHospitals||[]],m=n.destination;m.distance=U(t,e,m.coordinates.lat,m.coordinates.lng);try{const g=await ce(t,e,m.coordinates.lat,m.coordinates.lng);m.travelTime=g.duration,m.travelSource=g.source}catch{m.travelTime=Math.round(m.distance/.8),m.travelSource="estimated"}const b=u.filter(g=>g.id!==m.id).map(g=>({...g,distance:U(t,e,g.coordinates.lat,g.coordinates.lng)})).sort((g,h)=>g.distance-h.distance).slice(0,3);for(const g of b)try{const h=await ce(t,e,g.coordinates.lat,g.coordinates.lng);g.travelTime=h.duration,g.travelSource=h.source}catch{g.travelTime=Math.round(g.distance/.8),g.travelSource="estimated"}const v=`
      <div class="location-info">
        <p><strong>${o("yourLocation")}:</strong> ${t.toFixed(4)}, ${e.toFixed(4)}</p>
        <p><strong>State:</strong> ${ue(n.state)}</p>
        ${r}
      </div>
    ...
    `}}function ue(t){return{bayern:"Bayern (Bavaria)",badenWuerttemberg:"Baden-Württemberg",nordrheinWestfalen:"Nordrhein-Westfalen (NRW)"}[t]||t}function Xe(t,e){var s;const i=Math.round((((s=e==null?void 0:e.ich)==null?void 0:s.probability)||0)*100);let a="🏥";return t.urgency==="IMMEDIATE"?a="🚨":t.urgency==="TIME_CRITICAL"?a="⏰":t.urgency==="URGENT"&&(a="⚠️"),`
  ...
  `}function me(t,e,i){const a=[];t.neurosurgery&&a.push("🧠 Neurosurgery"),t.thrombectomy&&a.push("🩸 Thrombectomy"),t.thrombolysis&&a.push("💉 Thrombolysis");const s=t.network?`<span class="network-badge">${t.network}</span>`:"";return`
  ...
  `}function et(t,e){const i=Number(t),a=ve[e];return i>=a.high?"🔴 HIGH RISK":i>=a.medium?"🟡 MEDIUM RISK":"🟢 LOW RISK"}const G={moderate:{min:10},high:{min:20},critical:{min:30}};function Se(t){if(!t||t<=0)return{volume:0,volumeRange:{min:0,max:0},riskLevel:"low",mortalityRate:"~0%",isValid:!0,calculation:"No hemorrhage detected"};const e=Math.min(t,1e4);t>1e4&&console.warn(`GFAP value ${t} exceeds expected range, capped at 10,000 pg/ml`);try{const i=.0192+.4533*Math.log10(e),a=Math.pow(10,i),s={min:a*.7,max:a*1.3},n=tt(a),r=it(a),c=a<1?"<1":a.toFixed(1);return{volume:a,displayVolume:c,volumeRange:{min:s.min.toFixed(1),max:s.max.toFixed(1)},riskLevel:n,mortalityRate:r,isValid:!0,calculation:`Based on GFAP ${t} pg/ml`,threshold:a>=30?"SURGICAL":a>=20?"HIGH_RISK":"MANAGEABLE"}}catch(i){return console.error("Volume calculation error:",i),{volume:0,volumeRange:{min:0,max:0},riskLevel:"low",mortalityRate:"Unknown",isValid:!1,calculation:"Calculation error",error:i.message}}}function tt(t){return t>=G.critical.min?"critical":t>=G.high.min?"high":t>=G.moderate.min?"moderate":"low"}function it(t){return t<10?"5-10%⁴":t<30?`${Math.round(10+(t-10)*9/20)}%⁴`:t<50?`${Math.round(19+(t-30)*25/20)}%³`:t<60?`${Math.round(44+(t-50)*47/10)}%²`:t<80?`${Math.round(91+(t-60)*5/20)}%¹`:"96-100%¹"}function at(t){return t<1?"<1 ml":t<10?`${t.toFixed(1)} ml`:`${Math.round(t)} ml`}function st(t){if(!t||t<=0)return`
...
`)}static exportAsJSON(){const e=this.getStoredData();return JSON.stringify(e,null,2)}static downloadData(e="csv"){try{const i=e==="csv"?this.exportAsCSV():this.exportAsJSON(),a=`igfap-research-${Date.now()}.${e}`,s=new Blob([i],{type:e==="csv"?"text/csv":"application/json"}),n=URL.createObjectURL(s),r=document.createElement("a");return r.href=n,r.download=a,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(n),console.log(`📥 Downloaded research data: ${a}`),!0}catch(i){return console.error("Failed to download research data:",i),!1}}static clearData(){try{return localStorage.removeItem(this.STORAGE_KEY),console.log("🗑️ Research data cleared"),!0}catch(e){return console.warn("Failed to clear research data:",e),!1}}static getDataSummary(){var n,r;const e=this.getStoredData();if(!e.entries||e.entries.length===0)return{totalEntries:0,dateRange:null,avgDifference:null};const i=e.entries,a=i.map(c=>{var l,d;return(d=(l=c.comparison)==null?void 0:l.differences)==null?void 0:d.absolute}).filter(c=>c!=null),s=a.length>0?a.reduce((c,l)=>c+Math.abs(l),0)/a.length:0;return{totalEntries:i.length,dateRange:{first:(n=i[0])==null?void 0:n.timestamp,last:(r=i[i.length-1])==null?void 0:r.timestamp},avgAbsoluteDifference:Math.round(s*10)/10,storageSize:JSON.stringify(e).length}}static generateEntryId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}static getSessionId(){let e=sessionStorage.getItem("research_session_id");return e||(e="session_"+Date.now().toString(36),sessionStorage.setItem("research_session_id",e)),e}}V(R,"STORAGE_KEY","igfap_research_data"),V(R,"MAX_ENTRIES",1e3);function lt(t,e,i){try{if(!M())return;const a={inputs:{age:i.age_years||i.age,gfap:i.gfap_value||i.gfap,module:t.module||"unknown"},main:{probability:t.probability,module:t.module,confidence:t.confidence},legacy:e,comparison:e?x.compareModels(t,e):null};R.logComparison(a)}catch(a){console.warn("Research logging failed (non-critical):",a)}}function M(t=null){var e;if(t==="coma")return!1;if(t==="limited"||t==="full")return!0;if(typeof window<"u")try{const i=window.store||((e=require("../state/store.js"))==null?void 0:e.store);if(i){const a=i.getState().formData;return a.limited||a.full}}catch{}return!1}function Le(){return""}function we(t,e,i){if(!(e!=null&&e.isValid))return console.log("🔬 Legacy model results invalid:",e),`
    ...
    `;const a=x.compareModels(t,e);return`
    <div class="research-panel" id="researchPanel" style="display: none;">
      <div class="research-header">
        <h4>🔬 Model Comparison (Research)</h4>
        <button class="close-research" id="closeResearch">×</button>
  ...
  `}function ct(t,e){let i=t.probability||0;i<=1&&(i=i*100);const a=e.probability||0;return`
  ...
  `}function dt(t){if(!t.isValid)return'<div class="comparison-error">Unable to compare models</div>';const{differences:e,agreement:i}=t;return`
  ...
  `}function mt(){const t=x.getModelMetadata();return`
  ...
  `:""}function J(t,e,i){if(!e)return"";const a=Math.round((e.probability||0)*100),s=et(a,t),n=a>70,r=a>ve[t].high,c={ich:"🩸",lvo:"🧠"},l={ich:o("ichProbability"),lvo:o("lvoProbability")},d=n?"critical":r?"high":"normal";return`
  ...
  `}function pt(t){const e=t.gfap_value||Z();if(!e||e<=0)return"";const i=Se(e);return`
    <div class="volume-display-container">
      ${st(i.volume)}
    </div>
  `}function Z(){var i;const e=p.getState().formData;for(const a of["coma","limited","full"])if((i=e[a])!=null&&i.gfap_value)return parseFloat(e[a].gfap_value);return 0}function ht(t,e){const{ich:i,lvo:a}=t,s=St(i),n=s!=="coma"?yt():null;console.log("🔬 Research Debug - Always Active:",{module:s,researchEnabled:M(s),mainResults:i,legacyResults:n,patientInputs:F(),legacyCalculationAttempted:s!=="coma"}),n&&M(s)&&lt(i,n,F());const r=(i==null?void 0:i.module)==="Limited"||(i==null?void 0:i.module)==="Coma"||(a==null?void 0:a.notPossible)===!0;i==null||i.module;let c;return r?c=bt(i,t,e,n,s):c=vt(i,a,t,e,n,s),setTimeout(async()=>{nt();try{const{mountIslands:l}=await qe(async()=>{const{mountIslands:d}=await import("./mountIslands-cdRD6v1g.js");return{mountIslands:d}},[]);l()}catch(l){console.warn("React islands not available:",l)}},100),c}function bt(t,e,i,a,s){const n=t&&t.probability>.6?fe():"",r=Math.round(((t==null?void 0:t.probability)||0)*100),c=ke(),l=Ee(),d=M(s)?Le():"",u=a&&M(s)?we(t,a,F()):"",m=(t==null?void 0:t.module)==="Coma"?kt(t.probability):"",b=(t==null?void 0:t.module)!=="Coma"?Te(t.probability):"";return`
    <div class="container">
      ${P(3)}
  ...
  `}function vt(t,e,i,a,s,n){var te,ie,ae,se;const r=Math.round(((t==null?void 0:t.probability)||0)*100),c=Math.round(((e==null?void 0:e.probability)||0)*100),l=t&&t.probability>.6?fe():"",d=ke(),u=Ee(),m=M(n)?Le():"",b=s&&M(n)?we(t,s,F()):"",v=p.getState(),g=parseInt((ie=(te=v.formData)==null?void 0:te.full)==null?void 0:ie.fast_ed_score)||0;console.log("🔍 Debug LVO Display:"),console.log("  Current Module:",n),console.log("  FAST-ED Score:",g),console.log("  FAST-ED Raw:",(se=(ae=v.formData)==null?void 0:ae.full)==null?void 0:se.fast_ed_score),console.log("  LVO Data:",e),console.log("  LVO notPossible:",e==null?void 0:e.notPossible),console.log("  LVO Probability:",e==null?void 0:e.probability),console.log("  ICH Module:",t==null?void 0:t.module);const h=n==="full"||(t==null?void 0:t.module)==="Full",k=e&&typeof e.probability=="number"&&!e.notPossible,f=h&&g>3&&k;console.log("  Conditions: isFullModule:",h),console.log("  Conditions: fastEdScore > 3:",g>3),console.log("  Conditions: hasValidLVO:",k),console.log("  Show LVO Card:",f);const y=r>=50,S=c/Math.max(r,.5),I=S>=.6&&S<=1.7,W=h&&r>=50&&c>=50&&I,H=h&&r>=50&&c>=50&&!I,ee=h&&r>=30&&c>=30;console.log("🎯 Tachometer conditions:",{isFullModule:h,ichPercent:r,lvoPercent:c,ratio:S.toFixed(2),inRatioBand:I,showTachometer:W,showDominanceBanner:H});let O=1;f&&O++,y&&O++;const Pe=O===1?"risk-results-single":O===2?"risk-results-dual":"risk-results-triple",Re=Te(t.probability);return`
    <div class="container">
      ${P(3)}
  ...
  `}function ft(t,e,i){const a=i>1?"LVO":"ICH",s=a==="LVO"?"🧠":"🩸",n=w.getCurrentLanguage()==="de"?a==="LVO"?"LVO-dominant":"ICH-dominant":a==="LVO"?"LVO dominant":"ICH dominant",r=w.getCurrentLanguage()==="de"?`Verhältnis LVO/ICH: ${i.toFixed(2)}`:`LVO/ICH ratio: ${i.toFixed(2)}`;return`
  ...
  `}function Ce(t){if(!t||!t.drivers)return'<p class="no-drivers">No driver data available</p>';const e=t.drivers;if(!e.positive&&!e.negative)return'<p class="no-drivers">Driver format error</p>';const i=e.positive||[],a=e.negative||[];return`
    <div class="drivers-split-view">
      <div class="drivers-column positive-column">
        <div class="column-header">
          <span class="column-icon">⬆</span>
        ...
        <div class="compact-drivers">
          ${i.length>0?i.slice(0,5).map(s=>ge(s,"positive")).join(""):`<p class="no-factors">${o("noFactors")||"Keine Faktoren / No factors"}</p>`}
        </div>
      </div>
      ...
      <div class="drivers-column negative-column">
        ...
        <div class="compact-drivers">
          ${a.length>0?a.slice(0,5).map(s=>ge(s,"negative")).join(""):`<p class="no-factors">${o("noFactors")||"Keine Faktoren / No factors"}</p>`}
        </div>
      </div>
    </div>
  `}function ge(t,e){const i=Math.abs(t.weight*100),a=Math.min(i*2,100);return`
    <div class="compact-driver-item">
      <div class="compact-driver-label">${q(t.label)}</div>
      <div class="compact-driver-bar ${e}" style="width: ${a}%;">
        <span class="compact-driver-value">${i.toFixed(1)}%</span>
      </div>
    </div>
  `}function $e(t){if(!t||!t.probability||Math.round((t.probability||0)*100)<50)return"";const i=Z();return!i||i<=0?"":`
  ...
  `}function yt(t){try{const e=F();if(console.log("🔍 Legacy calculation inputs:",e),!e.age||!e.gfap)return console.warn("🔍 Missing required inputs for legacy model:",{age:e.age,gfap:e.gfap}),null;const i=ot(e);return console.log("🔍 Legacy calculation result:",i),i}catch(e){return console.warn("Legacy model calculation failed (non-critical):",e),null}}function F(){const e=p.getState().formData;console.log("🔍 Debug formData structure:",e);let i=null,a=null;for(const n of["coma","limited","full"])e[n]&&(console.log(`🔍 ${n} module data:`,e[n]),i=i||e[n].age_years,a=a||e[n].gfap_value);const s={age:parseInt(i)||null,gfap:parseFloat(a)||null};return console.log("🔍 Extracted patient inputs:",s),s}function Te(t){return Math.round(t*100)>25?`
    ...
    `:""}function kt(t){const e=Math.round(t*100),i=w.getCurrentLanguage()==="de";return e>25?`
      <div class="alternative-diagnosis-card">
        <div class="diagnosis-header">
          <span class="lightning-icon">⚡</span>
    ...
    `}function St(t){if(!(t!=null&&t.module))return"unknown";const e=t.module.toLowerCase();return e.includes("coma")?"coma":e.includes("limited")?"limited":e.includes("full")?"full":"unknown"}function Ae(t){const e=Z();if(!e||e<=0)return"";const i=Se(e);return Math.round(((t==null?void 0:t.probability)||0)*100),`
    ...
    <div class="tachometer-section">
      <div class="tachometer-card">
        ...
        <div class="tachometer-gauge" id="tachometer-canvas-container">
          <div data-react-tachometer data-ich="${t}" data-lvo="${e}" data-title="${w.getCurrentLanguage()==="de"?"Entscheidungshilfe – LVO/ICH":"Decision Support – LVO/ICH"}"></div>
        </div>
  ...
  `}function wt(t,e,i){const a=[];return i.required&&!e&&e!==0&&a.push("This field is required"),i.min!==void 0&&e!==""&&!isNaN(e)&&parseFloat(e)<i.min&&a.push(`Value must be at least ${i.min}`),i.max!==void 0&&e!==""&&!isNaN(e)&&parseFloat(e)>i.max&&a.push(`Value must be at most ${i.max}`),i.pattern&&!i.pattern.test(e)&&a.push("Invalid format"),a}function Et(t){let e=!0;const i={};return Object.entries(Be).forEach(([a,s])=>{const n=t.elements[a];if(n){const r=wt(a,n.value,s);r.length>0&&(i[a]=r,e=!1)}}),{isValid:e,validationErrors:i}}function Ct(t,e){Object.entries(e).forEach(([i,a])=>{const s=t.querySelector(`[name="${i}"]`);if(s){const n=s.closest(".input-group");if(n){n.classList.add("error"),n.querySelectorAll(".error-message").forEach(c=>c.remove());const r=document.createElement("div");r.className="error-message",r.innerHTML=`<span class="error-icon">⚠️</span> ${a[0]}`,n.appendChild(r)}}})}function $t(t){t.querySelectorAll(".input-group.error").forEach(e=>{e.classList.remove("error"),e.querySelectorAll(".error-message").forEach(i=>i.remove())})}function pe(t,e){var r,c;console.log(`=== EXTRACTING ${e.toUpperCase()} DRIVERS ===`),console.log("Full response:",t);let i=null;if(e==="ICH"?(i=((r=t.ich_prediction)==null?void 0:r.drivers)||null,console.log("🧠 ICH raw drivers extracted:",i)):e==="LVO"&&(i=((c=t.lvo_prediction)==null?void 0:c.drivers)||null,console.log("🩸 LVO raw drivers extracted:",i)),!i)return console.log(`❌ No ${e} drivers found`),null;const a=Tt(i,e);console.log(`✅ ${e} drivers formatted:`,a);const n=[...a.positive,...a.negative].find(l=>l.label&&(l.label.toLowerCase().includes("fast")||l.label.includes("fast_ed")));return n?console.log(`🎯 FAST-ED found in ${e}:`,`${n.label}: ${n.weight>0?"+":""}${n.weight.toFixed(4)}`):console.log(`⚠️  FAST-ED NOT found in ${e} drivers`),a}function Tt(t,e){console.log(`🔄 Formatting ${e} drivers from dictionary:`,t);const i=[],a=[];return Object.entries(t).forEach(([s,n])=>{typeof n=="number"&&(n>0?i.push({label:s,weight:n}):n<0&&a.push({label:s,weight:Math.abs(n)}))}),i.sort((s,n)=>n.weight-s.weight),a.sort((s,n)=>n.weight-s.weight),console.log(`📈 ${e} positive drivers:`,i.slice(0,5)),console.log(`📉 ${e} negative drivers:`,a.slice(0,5)),{kind:"flat_dictionary",units:"logit",positive:i,negative:a,meta:{}}}function he(t,e){var a,s;console.log(`=== EXTRACTING ${e.toUpperCase()} PROBABILITY ===`);let i=0;return e==="ICH"?(i=((a=t.ich_prediction)==null?void 0:a.probability)||0,console.log("🧠 ICH probability extracted:",i)):e==="LVO"&&(i=((s=t.lvo_prediction)==null?void 0:s.probability)||0,console.log("🩸 LVO probability extracted:",i)),i}function be(t,e){var a,s;let i=.85;return e==="ICH"?i=((a=t.ich_prediction)==null?void 0:a.confidence)||.85:e==="LVO"&&(i=((s=t.lvo_prediction)==null?void 0:s.confidence)||.85),i}const At=[.4731,.8623,1.8253,3.6667,2.3495,1,0],Mt=btoa("proprietary-lvo-model-v2"),T=t=>At[t],C=(()=>{const t="intercept",e="coefficients",i="scaling";return{[t]:-T(0),[e]:{gfap:-T(1),fastEd:T(2)},[i]:{gfap:{mean:T(6),std:T(5)},fastEd:{mean:T(3),std:T(4)}}}})(),D={_0x7b2c:(t,e=0)=>t>=0?e===0?Math.log(t+1):(Math.pow(t+1,e)-1)/e:e===2?-Math.log(-t+1):-(Math.pow(-t+1,2-e)-1)/(2-e),_0x9d4e:(t,e,i)=>(t-e)/i,_0x3f8a:t=>{const e=Math.exp;return 1/(1+e(-t))},_0x5c1d:t=>Math.sin(t*1e3)*0+t};function Pt(t,e){try{if(t==null||e==null)throw new Error("Missing required inputs: GFAP and FAST-ED scores");if(t<0)throw new Error("GFAP value must be non-negative");if(e<0||e>9)throw new Error("FAST-ED score must be between 0 and 9");const i="gfap",a="fastEd",s={i:"intercept",c:"coefficients",s:"scaling",m:"mean",d:"std"},n=D._0x7b2c(t,0),r=D._0x5c1d(n),c=D._0x9d4e(n,C[s.s][i][s.m],C[s.s][i][s.d]),l=D._0x9d4e(e,C[s.s][a][s.m],C[s.s][a][s.d]),d=(()=>{const f=C[s.i],y=C[s.c][i]*c,E=C[s.c][a]*l;return f+y+E})(),u=D._0x3f8a(d),m=c,b=l,v=d,g=[],h={f:C[s.c][a]*b,g:C[s.c][i]*m};e>=4?g.push({name:"High FAST-ED Score",value:e,impact:"increase",contribution:h.f}):e<=2&&g.push({name:"Low FAST-ED Score",value:e,impact:"decrease",contribution:h.f});const k=[500,100];return t>k[0]?g.push({name:"Elevated GFAP",value:`${Math.round(t)} pg/mL`,impact:"decrease",contribution:h.g,note:"May indicate hemorrhagic vs ischemic event"}):t<k[1]&&g.push({name:"Low GFAP",value:`${Math.round(t)} pg/mL`,impact:"increase",contribution:Math.abs(h.g),note:"Consistent with ischemic LVO"}),g.sort((f,y)=>Math.abs(y.contribution)-Math.abs(f.contribution)),{probability:u,riskLevel:u>.7?"high":u>.4?"moderate":"low",model:atob(Mt).replace("proprietary-","").replace("-v2",""),inputs:{[i]:t,[a]:e},scaledInputs:{[i]:c,[a]:l},logit:d,riskFactors:g,interpretation:Rt(u,e,t)}}catch(i){return console.error("LVO prediction error:",i),{probability:null,error:i.message,model:"Local LVO Model v2"}}}function Rt(t,e,i){const a=Math.round(t*100);return t>.7?e>=6?`High probability of LVO (${a}%). FAST-ED score of ${e} strongly suggests large vessel occlusion. Consider immediate thrombectomy evaluation.`:`High probability of LVO (${a}%). Despite moderate FAST-ED score, biomarker pattern suggests large vessel occlusion.`:t>.4?i>500?`Moderate LVO probability (${a}%). Elevated GFAP (${i.toFixed(0)} pg/mL) may indicate hemorrhagic component. Further imaging recommended.`:`Moderate LVO probability (${a}%). Clinical correlation and vascular imaging recommended.`:e<=3?`Low probability of LVO (${a}%). FAST-ED score of ${e} suggests small vessel disease or non-vascular etiology.`:`Low probability of LVO (${a}%) despite FAST-ED score. Consider alternative diagnoses.`}function It(t){return(t==null?void 0:t.gfapValue)!=null&&(t==null?void 0:t.fastEdScore)!=null&&(t==null?void 0:t.gfapValue)>=0&&(t==null?void 0:t.fastEdScore)>=0&&(t==null?void 0:t.fastEdScore)<=9}async function Dt(){console.log("Warming up Cloud Functions...");const t=Object.values(A).map(async e=>{try{const i=new AbortController,a=setTimeout(()=>i.abort(),3e3);await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({}),signal:i.signal,mode:"cors"}),clearTimeout(a),console.log(`Warmed up: ${e}`)}catch{console.log(`Warm-up attempt for ${e.split("/").pop()} completed`)}});Promise.all(t).then(()=>{console.log("Cloud Functions warm-up complete")})}class $ extends Error{constructor(e,i,a){super(e),this.name="APIError",this.status=i,this.url=a}}function Q(t){const e={...t};return Object.keys(e).forEach(i=>{const a=e[i];(typeof a=="boolean"||a==="on"||a==="true"||a==="false")&&(e[i]=a===!0||a==="on"||a==="true"?1:0)}),e}function K(t,e=0){const i=parseFloat(t);return isNaN(i)?e:i}async function X(t,e){const i=new AbortController,a=setTimeout(()=>i.abort(),Y.requestTimeout);try{const s=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(e),signal:i.signal,mode:"cors"});if(clearTimeout(a),!s.ok){let r=`HTTP ${s.status}`;try{const c=await s.json();r=c.error||c.message||r}catch{r=`${r}: ${s.statusText}`}throw new $(r,s.status,t)}return await s.json()}catch(s){throw clearTimeout(a),s.name==="AbortError"?new $("Request timeout - please try again",408,t):s instanceof $?s:new $("Network error - please check your connection and try again",0,t)}}async function _t(t){const e=Q(t);console.log("Coma ICH API Payload:",e);try{const i=await X(A.COMA_ICH,e);return console.log("Coma ICH API Response:",i),{probability:K(i.probability||i.ich_probability,0),drivers:i.drivers||null,confidence:K(i.confidence,.75),module:"Coma"}}catch(i){throw console.error("Coma ICH prediction failed:",i),new $(`Failed to get ICH prediction: ${i.message}`,i.status,A.COMA_ICH)}}async function Nt(t){const e={age_years:t.age_years,systolic_bp:t.systolic_bp,diastolic_bp:t.diastolic_bp,gfap_value:t.gfap_value,vigilanzminderung:t.vigilanzminderung||0},i=Q(e);console.log("Limited Data ICH API Payload:",i);try{const a=await X(A.LDM_ICH,i);return console.log("Limited Data ICH API Response:",a),{probability:K(a.probability||a.ich_probability,0),drivers:a.drivers||null,confidence:K(a.confidence,.65),module:"Limited Data"}}catch(a){throw console.error("Limited Data ICH prediction failed:",a),new $(`Failed to get ICH prediction: ${a.message}`,a.status,A.LDM_ICH)}}async function Ft(t){const e={age_years:t.age_years,systolic_bp:t.systolic_bp,diastolic_bp:t.diastolic_bp,gfap_value:t.gfap_value,fast_ed_score:t.fast_ed_score,headache:t.headache||0,vigilanzminderung:t.vigilanzminderung||0,armparese:t.armparese||0,beinparese:t.beinparese||0,eye_deviation:t.eye_deviation||0,atrial_fibrillation:t.atrial_fibrillation||0,anticoagulated_noak:t.anticoagulated_noak||0,antiplatelets:t.antiplatelets||0},i=Q(e);console.log("=== BACKEND DATA MAPPING TEST ==="),console.log("📤 Full Stroke API Payload:",i),console.log("🧪 Clinical Variables Being Sent:"),console.log("  📊 FAST-ED Score:",i.fast_ed_score),console.log("  🩸 Systolic BP:",i.systolic_bp),console.log("  🩸 Diastolic BP:",i.diastolic_bp),console.log("  🧬 GFAP Value:",i.gfap_value),console.log("  👤 Age:",i.age_years),console.log("  🤕 Headache:",i.headache),console.log("  😵 Vigilanz:",i.vigilanzminderung),console.log("  💪 Arm Parese:",i.armparese),console.log("  🦵 Leg Parese:",i.beinparese),console.log("  👁️ Eye Deviation:",i.eye_deviation),console.log("  💓 Atrial Fib:",i.atrial_fibrillation),console.log("  💊 Anticoag NOAK:",i.anticoagulated_noak),console.log("  💊 Antiplatelets:",i.antiplatelets);let a=null;if(It(i)){console.log("🚀 Using local LVO model (GFAP + FAST-ED)");const s=Pt(i.gfap_value,i.fast_ed_score);s.probability!==null&&(a={probability:s.probability,drivers:s.riskFactors.map(n=>({feature:n.name,value:n.value,contribution:n.contribution,impact:n.impact})),confidence:s.riskLevel==="high"?.9:s.riskLevel==="moderate"?.7:.5,module:"Full Stroke (Local LVO)",interpretation:s.interpretation},console.log("✅ Local LVO prediction:",{probability:a.probability,riskLevel:s.riskLevel,inputs:s.inputs}))}try{const s=await X(A.FULL_STROKE,i);console.log("📥 Full Stroke API Response (ICH only):",s);const n=he(s,"ICH"),r=pe(s,"ICH"),c=be(s,"ICH"),l={probability:n,drivers:r,confidence:c,module:"Full Stroke"};if(!a){console.log("⚠️ Falling back to API for LVO prediction");const d=he(s,"LVO"),u=pe(s,"LVO"),m=be(s,"LVO");a={probability:d,drivers:u,confidence:m,module:"Full Stroke (API)"}}return console.log("✅ Combined results:"),console.log("  ICH (API):",{probability:n,hasDrivers:!!r}),console.log("  LVO (Local):",{probability:a.probability,hasDrivers:!!a.drivers}),{ich:l,lvo:a}}catch(s){throw console.error("Full Stroke prediction failed:",s),new $(`Failed to get stroke predictions: ${s.message}`,s.status,A.FULL_STROKE)}}const Bt=()=>[{id:"acute_deficit",checked:!1},{id:"symptom_onset",checked:!1},{id:"no_preexisting",checked:!1},{id:"no_trauma",checked:!1}];function xt(){const t=Bt();return`
  ...
  `}function Ht(){const t=document.getElementById("prerequisitesModal");if(!t){console.error("Prerequisites modal not found");return}console.log("Initializing prerequisites modal");const e=document.getElementById("closePrerequisites"),i=document.getElementById("cancelPrerequisites"),a=document.getElementById("confirmPrerequisites");console.log("Modal buttons found:",{closeBtn:!!e,cancelBtn:!!i,confirmBtn:!!a});const s=()=>{t.remove(),B("welcome")};e==null||e.addEventListener("click",s),i==null||i.addEventListener("click",s),a==null||a.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),console.log("Prerequisites confirm button clicked");const c=t.querySelectorAll(".toggle-input"),l=Array.from(c).every(d=>d.checked);if(console.log("All prerequisites checked:",l),l)console.log("Navigating to triage2"),t.remove(),B("triage2");else{console.log("Showing prerequisites warning");const d=document.getElementById("prerequisitesWarning");d&&(d.style.display="flex",d.classList.add("shake"),setTimeout(()=>d.classList.remove("shake"),500))}});const n=t.querySelectorAll(".toggle-input");n.forEach(r=>{r.addEventListener("change",()=>{const c=Array.from(n).every(d=>d.checked),l=document.getElementById("prerequisitesWarning");c&&l&&(l.style.display="none")})})}function Ot(){const t=document.getElementById("prerequisitesModal");t&&t.remove();const e=document.createElement("div");e.innerHTML=xt();const i=e.firstElementChild;document.body.appendChild(i),Ht()}function Vt(t){p.logEvent("triage1_answer",{comatose:t}),t?B("coma"):Ot()}function zt(t){p.logEvent("triage2_answer",{examinable:t}),B(t?"full":"limited")}function B(t){p.logEvent("navigate",{from:p.getState().currentScreen,to:t}),p.navigate(t),window.scrollTo(0,0)}function qt(){p.hasUnsavedData()&&!confirm("Are you sure you want to start over? All entered data will be lost.")||(p.logEvent("reset"),p.reset())}function Ut(){console.log("goBack() called");const t=p.goBack();console.log("goBack() success:",t),t?(p.logEvent("navigate_back"),window.scrollTo(0,0)):(console.log("No history available, going home instead"),Me())}function Me(){console.log("goHome() called"),p.logEvent("navigate_home"),p.goHome(),window.scrollTo(0,0)}async function Kt(t,e){t.preventDefault();const i=t.target,a=i.dataset.module,s=Et(i);if(!s.isValid){Ct(e,s.validationErrors);try{const l=Object.keys(s.validationErrors)[0];if(l&&i.elements[l]){const m=i.elements[l];m.focus({preventScroll:!0}),m.scrollIntoView({behavior:"smooth",block:"center"})}const d=document.createElement("div");d.className="sr-only",d.setAttribute("role","status"),d.setAttribute("aria-live","polite");const u=Object.keys(s.validationErrors).length;d.textContent=`${u} field${u===1?"":"s"} need attention.`,document.body.appendChild(d),setTimeout(()=>d.remove(),1200)}catch{}return}const n={};Array.from(i.elements).forEach(l=>{if(l.name)if(l.type==="checkbox")n[l.name]=l.checked;else if(l.type==="number"){const d=parseFloat(l.value);n[l.name]=isNaN(d)?0:d}else l.type==="hidden"&&l.name==="armparese"?n[l.name]=l.value==="true":n[l.name]=l.value}),console.log("Collected form inputs:",n),p.setFormData(a,n);const r=i.querySelector("button[type=submit]"),c=r?r.innerHTML:"";r&&(r.disabled=!0,r.innerHTML=`<span class="loading-spinner"></span> ${o("analyzing")}`);try{let l;switch(a){case"coma":l={ich:await _t(n),lvo:null};break;case"limited":l={ich:await Nt(n),lvo:{notPossible:!0}};break;case"full":l=await Ft(n);break;default:throw new Error("Unknown module: "+a)}p.setResults(l),p.logEvent("models_complete",{module:a,results:l}),B("results")}catch(l){console.error("Error running models:",l);let d="An error occurred during analysis. Please try again.";l instanceof $&&(d=l.message),Wt(e,d),r&&(r.disabled=!1,r.innerHTML=c)}}function Wt(t,e){t.querySelectorAll(".critical-alert").forEach(s=>{var n,r;(r=(n=s.querySelector("h4"))==null?void 0:n.textContent)!=null&&r.includes("Error")&&s.remove()});const i=document.createElement("div");i.className="critical-alert",i.innerHTML=`<h4><span class="alert-icon">⚠️</span> Error</h4><p>${e}</p>`;const a=t.querySelector(".container");a?a.prepend(i):t.prepend(i),setTimeout(()=>i.remove(),1e4)}function Gt(t){const e=document.createElement("div");e.className="sr-only",e.setAttribute("role","status"),e.setAttribute("aria-live","polite");const i={triage1:"Coma assessment",triage2:"Examination capability assessment",coma:"Coma module",limited:"Limited data module",full:"Full stroke assessment",results:"Assessment results"};e.textContent=`Navigated to ${i[t]||t}`,document.body.appendChild(e),setTimeout(()=>e.remove(),1e3)}function Yt(t){const e="iGFAP",a={triage1:"Initial Assessment",triage2:"Examination Capability",coma:"Coma Module",limited:"Limited Data Module",full:"Full Stroke Module",results:"Assessment Results"}[t];document.title=a?`${e} — ${a}`:e}function jt(){setTimeout(()=>{const t=document.querySelector("h2");t&&(t.setAttribute("tabindex","-1"),t.focus(),setTimeout(()=>t.removeAttribute("tabindex"),100))},100)}class Jt{constructor(){this.scores={facial_palsy:0,arm_weakness:0,speech_changes:0,eye_deviation:0,denial_neglect:0},this.onApply=null,this.modal=null}getTotal(){return Object.values(this.scores).reduce((e,i)=>e+i,0)}getRiskLevel(){return this.getTotal()>=4?"high":"low"}render(){const e=this.getTotal(),i=this.getRiskLevel();return`
