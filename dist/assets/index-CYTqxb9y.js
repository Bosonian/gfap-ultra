(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function e(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=e(n);fetch(n.href,r)}})();class ee{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{},screenHistory:[]},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}notify(){this.listeners.forEach(t=>t(this.state))}getState(){return{...this.state}}setState(t){this.state={...this.state,...t},this.notify()}navigate(t){console.log(`Navigating from ${this.state.currentScreen} to ${t}`);const e=[...this.state.screenHistory];this.state.currentScreen!==t&&!e.includes(this.state.currentScreen)&&e.push(this.state.currentScreen),this.setState({currentScreen:t,screenHistory:e})}goBack(){const t=[...this.state.screenHistory];if(console.log("goBack() - current history:",t),console.log("goBack() - current screen:",this.state.currentScreen),t.length>0){const e=t.pop();return console.log("goBack() - navigating to:",e),this.setState({currentScreen:e,screenHistory:t}),!0}return console.log("goBack() - no history available"),!1}goHome(){this.setState({currentScreen:"triage1",screenHistory:[]})}setFormData(t,e){const s={...this.state.formData};s[t]={...e},this.setState({formData:s})}getFormData(t){return this.state.formData[t]||{}}setValidationErrors(t){this.setState({validationErrors:t})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(t){this.setState({results:t})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const t={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{},screenHistory:[]};this.setState(t),console.log("Store reset with new session:",t.sessionId)}logEvent(t,e={}){const s={timestamp:Date.now(),session:this.state.sessionId,event:t,data:e};console.log("Event:",s)}getSessionDuration(){return Date.now()-this.state.startTime}}const m=new ee;function y(i){const t=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let e='<div class="progress-indicator">';return t.forEach((s,n)=>{const r=s.id===i,o=s.id<i;e+=`
    ...
    <div class="enhanced-drivers-panel ${e}">
      <div class="panel-header">
        ...
        <div class="panel-title">
          ...
          <span class="panel-subtitle">${a("contributingFactors")} (${r.length} ${a("factorsShown")})</span>
        </div>
      </div>
  ...
  `}function ke(i){const t=document.getElementById("useGpsButton"),e=document.getElementById("manualLocationButton"),s=document.querySelector(".location-manual"),n=document.getElementById("locationInput"),r=document.getElementById("searchLocationButton"),o=document.getElementById("strokeCenterResults");t&&t.addEventListener("click",()=>{Se(i,o)}),e&&e.addEventListener("click",()=>{s.style.display=s.style.display==="none"?"block":"none"}),r&&r.addEventListener("click",()=>{const l=n.value.trim();l&&W(l,i,o)}),n&&n.addEventListener("keypress",l=>{if(l.key==="Enter"){const c=n.value.trim();c&&W(c,i,o)}})}function Se(i,t){if(!navigator.geolocation){P(a("geolocationNotSupported"),t);return}t.innerHTML=`<div class="loading">${a("gettingLocation")}...</div>`,navigator.geolocation.getCurrentPosition(e=>{const{latitude:s,longitude:n}=e.coords;Le(s,n,i,t)},e=>{let s=a("locationError");switch(e.code){case e.PERMISSION_DENIED:s=a("locationPermissionDenied");break;case e.POSITION_UNAVAILABLE:s=a("locationUnavailable");break;case e.TIMEOUT:s=a("locationTimeout");break}P(s,t)},{enableHighAccuracy:!0,timeout:1e4,maximumAge:3e5})}async function W(i,t,e){e.innerHTML=`<div class="loading">${a("searchingLocation")}...</div>`,P(a("geocodingNotImplemented"),e)}async function Le(i,t,e,s){const n=Te(e);s.innerHTML=`
  ...
  `;try{const r=await be(i,t,n),o=`
    ...
    `;s.innerHTML=l}}function E(i,t=!1){return!i||i.length===0?`<p>${a("noCentersFound")}</p>`:i.map(e=>`
  ...
  `:""}function j(i,t,e){if(!t)return"";const s=Math.round((t.probability||0)*100),n=we(s,i),r=s>_[i].critical,o=s>_[i].high,l={ich:"🧠",lvo:"🩸"},c={ich:a("ichProbability"),lvo:a("lvoProbability")};return`
  ...
  `}function Ce(i,t){const{ich:e,lvo:s}=i,n=j("ich",e),r=s!=null&&s.notPossible?Ee():j("lvo",s),o=e&&e.probability>.6?oe():"",l=pe(e,s),c=ye(),u=$e();return`
    <div class="container">
      ${y(3)}
  ...
  `}function De(i,t,e){const s=[];return e.required&&!t&&t!==0&&s.push("This field is required"),e.min!==void 0&&t!==""&&!isNaN(t)&&parseFloat(t)<e.min&&s.push(`Value must be at least ${e.min}`),e.max!==void 0&&t!==""&&!isNaN(t)&&parseFloat(t)>e.max&&s.push(`Value must be at most ${e.max}`),e.pattern&&!e.pattern.test(t)&&s.push("Invalid format"),s}function Ae(i){let t=!0;const e={};return Object.entries(ae).forEach(([s,n])=>{const r=i.elements[s];if(r){const o=De(s,r.value,n);o.length>0&&(e[s]=o,t=!1)}}),{isValid:t,validationErrors:e}}function _e(i,t){Object.entries(t).forEach(([e,s])=>{const n=i.querySelector(`[name="${e}"]`);if(n){const r=n.closest(".input-group");if(r){r.classList.add("error"),r.querySelectorAll(".error-message").forEach(l=>l.remove());const o=document.createElement("div");o.className="error-message",o.innerHTML=`<span class="error-icon">⚠️</span> ${s[0]}`,r.appendChild(o)}}})}function Me(i){i.querySelectorAll(".input-group.error").forEach(t=>{t.classList.remove("error"),t.querySelectorAll(".error-message").forEach(e=>e.remove())})}class v extends Error{constructor(t,e,s){super(t),this.name="APIError",this.status=e,this.url=s}}function N(i){const t={...i};return Object.keys(t).forEach(e=>{const s=t[e];(typeof s=="boolean"||s==="on"||s==="true"||s==="false")&&(t[e]=s===!0||s==="on"||s==="true"?1:0)}),t}function b(i,t=0){const e=parseFloat(i);return isNaN(e)?t:e}async function I(i,t){const e=new AbortController,s=setTimeout(()=>e.abort(),M.requestTimeout);try{const n=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t),signal:e.signal,mode:"cors"});if(clearTimeout(s),!n.ok){let o=`HTTP ${n.status}`;try{const l=await n.json();o=l.error||l.message||o}catch{o=`${o}: ${n.statusText}`}throw new v(o,n.status,i)}return await n.json()}catch(n){throw clearTimeout(s),n.name==="AbortError"?new v("Request timeout - please try again",408,i):n instanceof v?n:new v("Network error - please check your connection and try again",0,i)}}async function Pe(i){const t=N(i);console.log("Coma ICH API Payload:",t);try{const e=await I(f.COMA_ICH,t);return console.log("Coma ICH API Response:",e),{probability:b(e.probability||e.ich_probability,0),drivers:e.drivers||null,confidence:b(e.confidence,.75),module:"Coma"}}catch(e){throw console.error("Coma ICH prediction failed:",e),new v(`Failed to get ICH prediction: ${e.message}`,e.status,f.COMA_ICH)}}async function Ne(i){const t={age_years:i.age_years,systolic_bp:i.systolic_bp,diastolic_bp:i.diastolic_bp,gfap_value:i.gfap_value,vigilanzminderung:i.vigilanzminderung||0},e=N(t);console.log("Limited Data ICH API Payload:",e);try{const s=await I(f.LDM_ICH,e);return console.log("Limited Data ICH API Response:",s),{probability:b(s.probability||s.ich_probability,0),drivers:s.drivers||null,confidence:b(s.confidence,.65),module:"Limited Data"}}catch(s){throw console.error("Limited Data ICH prediction failed:",s),new v(`Failed to get ICH prediction: ${s.message}`,s.status,f.LDM_ICH)}}async function Ie(i){var s,n,r,o,l,c,u,p,h,k,S,L,T,x,R,F,H,z;const t={age_years:i.age_years,systolic_bp:i.systolic_bp,diastolic_bp:i.diastolic_bp,gfap_value:i.gfap_value,fast_ed_score:i.fast_ed_score,headache:i.headache||0,vigilanzminderung:i.vigilanzminderung||0,armparese:i.armparese||0,beinparese:i.beinparese||0,eye_deviation:i.eye_deviation||0,atrial_fibrillation:i.atrial_fibrillation||0,anticoagulated_noak:i.anticoagulated_noak||0,antiplatelets:i.antiplatelets||0},e=N(t);console.log("Full Stroke API Payload:",e);try{const d=await I(f.FULL_STROKE,e);console.log("Full Stroke API Response:",d),console.log("Available keys in response:",Object.keys(d)),console.log("Response type:",typeof d),Object.keys(d).forEach(q=>{const w=d[q];typeof w=="number"&&w>=0&&w<=1&&console.log(`Potential probability field: ${q} = ${w}`)});const O=b(((s=d.ich_prediction)==null?void 0:s.probability)||d.ich_probability||((n=d.ich)==null?void 0:n.probability)||d.ICH_probability||d.ich_prob||((r=d.probability)==null?void 0:r.ich)||((o=d.results)==null?void 0:o.ich_probability),0),G=b(((l=d.lvo_prediction)==null?void 0:l.probability)||d.lvo_probability||((c=d.lvo)==null?void 0:c.probability)||d.LVO_probability||d.lvo_prob||((u=d.probability)==null?void 0:u.lvo)||((p=d.results)==null?void 0:p.lvo_probability),0);console.log("Extracted probabilities:",{ich:O,lvo:G});const Q={probability:O,drivers:((h=d.ich_prediction)==null?void 0:h.drivers)||d.ich_drivers||((k=d.ich)==null?void 0:k.drivers)||((S=d.drivers)==null?void 0:S.ich)||null,confidence:b(((L=d.ich_prediction)==null?void 0:L.confidence)||d.ich_confidence||((T=d.ich)==null?void 0:T.confidence),.85),module:"Full Stroke"},X={probability:G,drivers:((x=d.lvo_prediction)==null?void 0:x.drivers)||d.lvo_drivers||((R=d.lvo)==null?void 0:R.drivers)||((F=d.drivers)==null?void 0:F.lvo)||null,confidence:b(((H=d.lvo_prediction)==null?void 0:H.confidence)||d.lvo_confidence||((z=d.lvo)==null?void 0:z.confidence),.85),module:"Full Stroke"};return{ich:Q,lvo:X}}catch(d){throw console.error("Full Stroke prediction failed:",d),new v(`Failed to get stroke predictions: ${d.message}`,d.status,f.FULL_STROKE)}}function Be(i){m.logEvent("triage1_answer",{comatose:i}),B(i?"coma":"triage2")}function xe(i){m.logEvent("triage2_answer",{examinable:i}),B(i?"full":"limited")}function B(i){m.logEvent("navigate",{from:m.getState().currentScreen,to:i}),m.navigate(i),window.scrollTo(0,0)}function Re(){m.hasUnsavedData()&&!confirm("Are you sure you want to start over? All entered data will be lost.")||(m.logEvent("reset"),m.reset())}function Fe(){console.log("goBack() called");const i=m.goBack();console.log("goBack() success:",i),i?(m.logEvent("navigate_back"),window.scrollTo(0,0)):(console.log("No history available, going home instead"),J())}function J(){console.log("goHome() called"),m.logEvent("navigate_home"),m.goHome(),window.scrollTo(0,0)}async function He(i,t){i.preventDefault();const e=i.target,s=e.dataset.module,n=Ae(e);if(!n.isValid){_e(t,n.validationErrors);return}const r={};Array.from(e.elements).forEach(c=>{if(c.name)if(c.type==="checkbox")r[c.name]=c.checked;else if(c.type==="number"){const u=parseFloat(c.value);r[c.name]=isNaN(u)?0:u}else c.type==="hidden"&&c.name==="armparese"?r[c.name]=c.value==="true":r[c.name]=c.value}),console.log("Collected form inputs:",r),m.setFormData(s,r);const o=e.querySelector("button[type=submit]"),l=o?o.innerHTML:"";o&&(o.disabled=!0,o.innerHTML=`<span class="loading-spinner"></span> ${a("analyzing")}`);try{let c;switch(s){case"coma":c={ich:await Pe(r),lvo:null};break;case"limited":c={ich:await Ne(r),lvo:{notPossible:!0}};break;case"full":c=await Ie(r);break;default:throw new Error("Unknown module: "+s)}m.setResults(c),m.logEvent("models_complete",{module:s,results:c}),B("results")}catch(c){console.error("Error running models:",c);let u="An error occurred during analysis. Please try again.";c instanceof v&&(u=c.message),ze(t,u),o&&(o.disabled=!1,o.innerHTML=l)}}function ze(i,t){i.querySelectorAll(".critical-alert").forEach(n=>{var r,o;(o=(r=n.querySelector("h4"))==null?void 0:r.textContent)!=null&&o.includes("Error")&&n.remove()});const e=document.createElement("div");e.className="critical-alert",e.innerHTML=`<h4><span class="alert-icon">⚠️</span> Error</h4><p>${t}</p>`;const s=i.querySelector(".container");s?s.prepend(e):i.prepend(e),setTimeout(()=>e.remove(),1e4)}function Oe(i){const t=document.createElement("div");t.className="sr-only",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");const e={triage1:"Coma assessment",triage2:"Examination capability assessment",coma:"Coma module",limited:"Limited data module",full:"Full stroke assessment",results:"Assessment results"};t.textContent=`Navigated to ${e[i]||i}`,document.body.appendChild(t),setTimeout(()=>t.remove(),1e3)}function Ge(i){const t={triage1:"Initial Assessment - Stroke Triage Assistant",triage2:"Examination Capability - Stroke Triage Assistant",coma:"Coma Module - Stroke Triage Assistant",limited:"Limited Data Module - Stroke Triage Assistant",full:"Full Stroke Module - Stroke Triage Assistant",results:"Assessment Results - Stroke Triage Assistant"};document.title=t[i]||"Stroke Triage Assistant"}function qe(){setTimeout(()=>{const i=document.querySelector("h2");i&&(i.setAttribute("tabindex","-1"),i.focus(),setTimeout(()=>i.removeAttribute("tabindex"),100))},100)}class Ve{constructor(){this.scores={facial_palsy:0,arm_weakness:0,speech_changes:0,eye_deviation:0,denial_neglect:0},this.onApply=null,this.modal=null}getTotal(){return Object.values(this.scores).reduce((t,e)=>t+e,0)}getRiskLevel(){return this.getTotal()>=4?"high":"low"}render(){const t=this.getTotal(),e=this.getRiskLevel();return`
...
//# sourceMappingURL=index-CYTqxb9y.js.map
