(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();class te{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{},screenHistory:[]},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}notify(){this.listeners.forEach(t=>t(this.state))}getState(){return{...this.state}}setState(t){this.state={...this.state,...t},this.notify()}navigate(t){console.log(`Navigating from ${this.state.currentScreen} to ${t}`);const e=[...this.state.screenHistory];this.state.currentScreen!==t&&!e.includes(this.state.currentScreen)&&e.push(this.state.currentScreen),this.setState({currentScreen:t,screenHistory:e})}goBack(){const t=[...this.state.screenHistory];if(console.log("goBack() - current history:",t),console.log("goBack() - current screen:",this.state.currentScreen),t.length>0){const e=t.pop();return console.log("goBack() - navigating to:",e),this.setState({currentScreen:e,screenHistory:t}),!0}return console.log("goBack() - no history available"),!1}goHome(){this.setState({currentScreen:"triage1",screenHistory:[]})}setFormData(t,e){const i={...this.state.formData};i[t]={...e},this.setState({formData:i})}getFormData(t){return this.state.formData[t]||{}}setValidationErrors(t){this.setState({validationErrors:t})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(t){this.setState({results:t})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const t={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{},screenHistory:[]};this.setState(t),console.log("Store reset with new session:",t.sessionId)}logEvent(t,e={}){const i={timestamp:Date.now(),session:this.state.sessionId,event:t,data:e};console.log("Event:",i)}getSessionDuration(){return Date.now()-this.state.startTime}}const m=new te;function S(a){const t=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let e='<div class="progress-indicator">';return t.forEach((i,s)=>{const n=i.id===a,o=i.id<a;e+=`
  ...
  `}const k={COMA_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_coma_ich",LDM_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_limited_data_ich",FULL_STROKE:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_full_stroke"},N={ich:{medium:25,high:50},lvo:{medium:25,high:50}},b={min:29,max:10001},P={autoSaveInterval:18e4,sessionTimeout:30*60*1e3,requestTimeout:1e4},se={age_years:{required:!0,min:0,max:120},systolic_bp:{required:!0,min:60,max:300},diastolic_bp:{required:!0,min:30,max:200},gfap_value:{required:!0,min:b.min,max:b.max},fast_ed_score:{required:!0,min:0,max:9}};function ne(){return`
    <div class="container">
      ${S(2)}
  ...
  `}function pe(a){const t=document.getElementById("useGpsButton"),e=document.getElementById("manualLocationButton"),i=document.querySelector(".location-manual"),s=document.getElementById("locationInput"),n=document.getElementById("searchLocationButton"),o=document.getElementById("strokeCenterResults");t&&t.addEventListener("click",()=>{he(a,o)}),e&&e.addEventListener("click",()=>{i.style.display=i.style.display==="none"?"block":"none"}),n&&n.addEventListener("click",()=>{const c=s.value.trim();c&&x(c,a,o)}),s&&s.addEventListener("keypress",c=>{if(c.key==="Enter"){const l=s.value.trim();l&&x(l,a,o)}})}function he(a,t){if(!navigator.geolocation){E(r("geolocationNotSupported"),t);return}t.innerHTML=`<div class="loading">${r("gettingLocation")}...</div>`,navigator.geolocation.getCurrentPosition(e=>{const{latitude:i,longitude:s}=e.coords;R(i,s,a,t)},e=>{let i=r("locationError");switch(e.code){case e.PERMISSION_DENIED:i=r("locationPermissionDenied");break;case e.POSITION_UNAVAILABLE:i=r("locationUnavailable");break;case e.TIMEOUT:i=r("locationTimeout");break}E(i,t)},{enableHighAccuracy:!0,timeout:1e4,maximumAge:3e5})}async function x(a,t,e){e.innerHTML=`<div class="loading">${r("searchingLocation")}...</div>`;const i=/^(-?\d+\.?\d*)\s*,\s*(-?\d+\.?\d*)$/,s=a.trim().match(i);if(s){const n=parseFloat(s[1]),o=parseFloat(s[2]);if(n>=47.2&&n<=52.5&&o>=5.9&&o<=15){e.innerHTML=`
        <div class="location-success">
          <p>📍 Coordinates: ${n.toFixed(4)}, ${o.toFixed(4)}</p>
        </div>
      `,setTimeout(()=>{R(n,o,t,e)},500);return}else{E("Coordinates appear to be outside Germany. Please check the values.",e);return}}try{let n=a.trim();!n.toLowerCase().includes("deutschland")&&!n.toLowerCase().includes("germany")&&!n.toLowerCase().includes("bayern")&&!n.toLowerCase().includes("bavaria")&&!n.toLowerCase().includes("nordrhein")&&!n.toLowerCase().includes("baden")&&(n=n+", Deutschland");const c=`https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(n)}&countrycodes=de&format=json&limit=3&addressdetails=1`,l=await fetch(c,{method:"GET",headers:{Accept:"application/json","User-Agent":"iGFAP-StrokeTriage/2.1.0"}});if(!l.ok)throw new Error(`Geocoding API error: ${l.status}`);const d=await l.json();if(d&&d.length>0){let g=d[0];const p=["Bayern","Baden-Württemberg","Nordrhein-Westfalen"];for(const h of d)if(h.address&&p.includes(h.address.state)){g=h;break}const y=parseFloat(g.lat),f=parseFloat(g.lon),u=g.display_name||a;e.innerHTML=`
        <div class="location-success">
          <p>📍 Found: ${u}</p>
          <small style="color: #666;">Lat: ${y.toFixed(4)}, Lng: ${f.toFixed(4)}</small>
        </div>
      `,setTimeout(()=>{R(y,f,t,e)},1e3)}else E(`
    ...
    `,e)}}async function R(a,t,e,i){var c,l;const s={lat:a,lng:t},n=me.routePatient({location:s,ichProbability:((c=e==null?void 0:e.ich)==null?void 0:c.probability)||0,timeFromOnset:(e==null?void 0:e.timeFromOnset)||null,clinicalFactors:(e==null?void 0:e.clinicalFactors)||{}});if(!n||!n.destination){i.innerHTML=`
    ...
    `;return}const o=be(n,e);i.innerHTML=`
  ...
  `;try{const d=Y[n.state],g=[...d.neurosurgicalCenters,...d.comprehensiveStrokeCenters,...d.regionalStrokeUnits,...d.thrombolysisHospitals||[]],p=n.destination;p.distance=C(a,t,p.coordinates.lat,p.coordinates.lng);try{const u=await H(a,t,p.coordinates.lat,p.coordinates.lng);p.travelTime=u.duration,p.travelSource=u.source}catch{p.travelTime=Math.round(p.distance/.8),p.travelSource="estimated"}const y=g.filter(u=>u.id!==p.id).map(u=>({...u,distance:C(a,t,u.coordinates.lat,u.coordinates.lng)})).sort((u,h)=>u.distance-h.distance).slice(0,3);for(const u of y)try{const h=await H(a,t,u.coordinates.lat,u.coordinates.lng);u.travelTime=h.duration,u.travelSource=h.source}catch{u.travelTime=Math.round(u.distance/.8),u.travelSource="estimated"}const f=`
    ...
    `}}function O(a){return{bayern:"Bayern (Bavaria)",badenWuerttemberg:"Baden-Württemberg",nordrheinWestfalen:"Nordrhein-Westfalen (NRW)"}[a]||a}function be(a,t){var s;const e=Math.round((((s=t==null?void 0:t.ich)==null?void 0:s.probability)||0)*100);let i="🏥";return a.urgency==="IMMEDIATE"?i="🚨":a.urgency==="TIME_CRITICAL"?i="⏰":a.urgency==="URGENT"&&(i="⚠️"),`
  ...
  `}function z(a,t,e){const i=[];a.neurosurgery&&i.push("🧠 Neurosurgery"),a.thrombectomy&&i.push("🩸 Thrombectomy"),a.thrombolysis&&i.push("💉 Thrombolysis");const s=a.network?`<span class="network-badge">${a.network}</span>`:"";return`
  ...
  `}function E(a,t){t.innerHTML=`
    <div class="location-error">
      <p>⚠️ ${a}</p>
      <p><small>${r("tryManualEntry")}</small></p>
    </div>
  `}function ye(a,t){const e=Number(a),i=N[t];return e>=i.high?"🔴 HIGH RISK":e>=i.medium?"🟡 MEDIUM RISK":"🟢 LOW RISK"}function J(){const t=m.getState().formData;if(!t||Object.keys(t).length===0)return"";let e="";return Object.entries(t).forEach(([i,s])=>{if(s&&Object.keys(s).length>0){const n=r(`${i}ModuleTitle`)||i.charAt(0).toUpperCase()+i.slice(1);let o="";Object.entries(s).forEach(([c,l])=>{if(l===""||l===null||l===void 0)return;let d=de(c),g=ue(l,c);o+=`
  ...
  `:""}function Z(a,t,e){if(!t)return"";const i=Math.round((t.probability||0)*100),s=ye(i,a),n=i>N[a].critical,o=i>N[a].high,c={ich:"🩸",lvo:"🧠"},l={ich:r("ichProbability"),lvo:r("lvoProbability")},d={ich:"ICH",lvo:T.getCurrentLanguage()==="de"?"Großgefäßverschluss":"Large Vessel Occlusion"};return`
  ...
  `}function ve(a,t){const{ich:e,lvo:i}=a,s=(e==null?void 0:e.module)==="Limited"||(e==null?void 0:e.module)==="Coma"||(i==null?void 0:i.notPossible)===!0;return e==null||e.module,s?fe(e):ke(e,i)}function fe(a,t,e){const i=a&&a.probability>.6?q():"",s=j(),n=J();return`
    <div class="container">
      ${S(3)}
  ...
  `}function ke(a,t,e,i){const s=Math.round(((a==null?void 0:a.probability)||0)*100),n=Math.round(((t==null?void 0:t.probability)||0)*100),o=a&&a.probability>.6?q():"",c=j(),l=J(),d=s<30&&n>50;return`
    <div class="container">
      ${S(3)}
  ...
  `}function Q(a){if(!a||!a.drivers)return'<p class="no-drivers">No driver data available</p>';const t=a.drivers;if(!t.positive&&!t.negative)return'<p class="no-drivers">Driver format error</p>';const e=t.positive||[],i=t.negative||[];return`
    <div class="drivers-split-view">
      <div class="drivers-column positive-column">
        ...
        <div class="compact-drivers">
          ${e.length>0?e.slice(0,5).map(s=>K(s,"positive")).join(""):`<p class="no-factors">${r("noFactors")||"Keine Faktoren / No factors"}</p>`}
        </div>
      </div>
      ...
      <div class="drivers-column negative-column">
        ...
        <div class="compact-drivers">
          ${i.length>0?i.slice(0,5).map(s=>K(s,"negative")).join(""):`<p class="no-factors">${r("noFactors")||"Keine Faktoren / No factors"}</p>`}
        </div>
      </div>
    </div>
  `}function K(a,t){const e=Math.abs(a.weight*100),i=Math.min(e*2,100);return`
    <div class="compact-driver-item">
      <div class="compact-driver-label">${G(a.label)}</div>
      <div class="compact-driver-bar ${t}" style="width: ${i}%;">
        <span class="compact-driver-value">${e.toFixed(1)}%</span>
      </div>
    </div>
  `}function Le(a,t,e){const i=[];return e.required&&!t&&t!==0&&i.push("This field is required"),e.min!==void 0&&t!==""&&!isNaN(t)&&parseFloat(t)<e.min&&i.push(`Value must be at least ${e.min}`),e.max!==void 0&&t!==""&&!isNaN(t)&&parseFloat(t)>e.max&&i.push(`Value must be at most ${e.max}`),e.pattern&&!e.pattern.test(t)&&i.push("Invalid format"),i}function Te(a){let t=!0;const e={};return Object.entries(se).forEach(([i,s])=>{const n=a.elements[i];if(n){const o=Le(i,n.value,s);o.length>0&&(e[i]=o,t=!1)}}),{isValid:t,validationErrors:e}}function Ee(a,t){Object.entries(t).forEach(([e,i])=>{const s=a.querySelector(`[name="${e}"]`);if(s){const n=s.closest(".input-group");if(n){n.classList.add("error"),n.querySelectorAll(".error-message").forEach(c=>c.remove());const o=document.createElement("div");o.className="error-message",o.innerHTML=`<span class="error-icon">⚠️</span> ${i[0]}`,n.appendChild(o)}}})}function we(a){a.querySelectorAll(".input-group.error").forEach(t=>{t.classList.remove("error"),t.querySelectorAll(".error-message").forEach(e=>e.remove())})}function U(a,t){var o,c;console.log(`=== EXTRACTING ${t.toUpperCase()} DRIVERS ===`),console.log("Full response:",a);let e=null;if(t==="ICH"?(e=((o=a.ich_prediction)==null?void 0:o.drivers)||null,console.log("🧠 ICH raw drivers extracted:",e)):t==="LVO"&&(e=((c=a.lvo_prediction)==null?void 0:c.drivers)||null,console.log("🩸 LVO raw drivers extracted:",e)),!e)return console.log(`❌ No ${t} drivers found`),null;const i=Ae(e,t);console.log(`✅ ${t} drivers formatted:`,i);const n=[...i.positive,...i.negative].find(l=>l.label&&(l.label.toLowerCase().includes("fast")||l.label.includes("fast_ed")));return n?console.log(`🎯 FAST-ED found in ${t}:`,`${n.label}: ${n.weight>0?"+":""}${n.weight.toFixed(4)}`):console.log(`⚠️  FAST-ED NOT found in ${t} drivers`),i}function Ae(a,t){console.log(`🔄 Formatting ${t} drivers from dictionary:`,a);const e=[],i=[];return Object.entries(a).forEach(([s,n])=>{typeof n=="number"&&(n>0?e.push({label:s,weight:n}):n<0&&i.push({label:s,weight:Math.abs(n)}))}),e.sort((s,n)=>n.weight-s.weight),i.sort((s,n)=>n.weight-s.weight),console.log(`📈 ${t} positive drivers:`,e.slice(0,5)),console.log(`📉 ${t} negative drivers:`,i.slice(0,5)),{kind:"flat_dictionary",units:"logit",positive:e,negative:i,meta:{}}}function V(a,t){var i,s;console.log(`=== EXTRACTING ${t.toUpperCase()} PROBABILITY ===`);let e=0;return t==="ICH"?(e=((i=a.ich_prediction)==null?void 0:i.probability)||0,console.log("🧠 ICH probability extracted:",e)):t==="LVO"&&(e=((s=a.lvo_prediction)==null?void 0:s.probability)||0,console.log("🩸 LVO probability extracted:",e)),e}function W(a,t){var i,s;let e=.85;return t==="ICH"?e=((i=a.ich_prediction)==null?void 0:i.confidence)||.85:t==="LVO"&&(e=((s=a.lvo_prediction)==null?void 0:s.confidence)||.85),e}async function Ce(){console.log("Warming up Cloud Functions...");const a=Object.values(k).map(async t=>{try{const e=new AbortController,i=setTimeout(()=>e.abort(),3e3);await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({}),signal:e.signal,mode:"cors"}),clearTimeout(i),console.log(`Warmed up: ${t}`)}catch{console.log(`Warm-up attempt for ${t.split("/").pop()} completed`)}});Promise.all(a).then(()=>{console.log("Cloud Functions warm-up complete")})}class v extends Error{constructor(t,e,i){super(t),this.name="APIError",this.status=e,this.url=i}}function M(a){const t={...a};return Object.keys(t).forEach(e=>{const i=t[e];(typeof i=="boolean"||i==="on"||i==="true"||i==="false")&&(t[e]=i===!0||i==="on"||i==="true"?1:0)}),t}function $(a,t=0){const e=parseFloat(a);return isNaN(e)?t:e}async function B(a,t){const e=new AbortController,i=setTimeout(()=>e.abort(),P.requestTimeout);try{const s=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t),signal:e.signal,mode:"cors"});if(clearTimeout(i),!s.ok){let o=`HTTP ${s.status}`;try{const c=await s.json();o=c.error||c.message||o}catch{o=`${o}: ${s.statusText}`}throw new v(o,s.status,a)}return await s.json()}catch(s){throw clearTimeout(i),s.name==="AbortError"?new v("Request timeout - please try again",408,a):s instanceof v?s:new v("Network error - please check your connection and try again",0,a)}}async function $e(a){const t=M(a);console.log("Coma ICH API Payload:",t);try{const e=await B(k.COMA_ICH,t);return console.log("Coma ICH API Response:",e),{probability:$(e.probability||e.ich_probability,0),drivers:e.drivers||null,confidence:$(e.confidence,.75),module:"Coma"}}catch(e){throw console.error("Coma ICH prediction failed:",e),new v(`Failed to get ICH prediction: ${e.message}`,e.status,k.COMA_ICH)}}async function Ne(a){const t={age_years:a.age_years,systolic_bp:a.systolic_bp,diastolic_bp:a.diastolic_bp,gfap_value:a.gfap_value,vigilanzminderung:a.vigilanzminderung||0},e=M(t);console.log("Limited Data ICH API Payload:",e);try{const i=await B(k.LDM_ICH,e);return console.log("Limited Data ICH API Response:",i),{probability:$(i.probability||i.ich_probability,0),drivers:i.drivers||null,confidence:$(i.confidence,.65),module:"Limited Data"}}catch(i){throw console.error("Limited Data ICH prediction failed:",i),new v(`Failed to get ICH prediction: ${i.message}`,i.status,k.LDM_ICH)}}async function Pe(a){var i,s,n,o,c,l;const t={age_years:a.age_years,systolic_bp:a.systolic_bp,diastolic_bp:a.diastolic_bp,gfap_value:a.gfap_value,fast_ed_score:a.fast_ed_score,headache:a.headache||0,vigilanzminderung:a.vigilanzminderung||0,armparese:a.armparese||0,beinparese:a.beinparese||0,eye_deviation:a.eye_deviation||0,atrial_fibrillation:a.atrial_fibrillation||0,anticoagulated_noak:a.anticoagulated_noak||0,antiplatelets:a.antiplatelets||0},e=M(t);console.log("=== BACKEND DATA MAPPING TEST ==="),console.log("📤 Full Stroke API Payload:",e),console.log("🧪 Clinical Variables Being Sent:"),console.log("  📊 FAST-ED Score:",e.fast_ed_score),console.log("  🩸 Systolic BP:",e.systolic_bp),console.log("  🩸 Diastolic BP:",e.diastolic_bp),console.log("  🧬 GFAP Value:",e.gfap_value),console.log("  👤 Age:",e.age_years),console.log("  🤕 Headache:",e.headache),console.log("  😵 Vigilanz:",e.vigilanzminderung),console.log("  💪 Arm Parese:",e.armparese),console.log("  🦵 Leg Parese:",e.beinparese),console.log("  👁️ Eye Deviation:",e.eye_deviation),console.log("  💓 Atrial Fib:",e.atrial_fibrillation),console.log("  💊 Anticoag NOAK:",e.anticoagulated_noak),console.log("  💊 Antiplatelets:",e.antiplatelets);try{const d=await B(k.FULL_STROKE,e);console.log("📥 Full Stroke API Response:",d),console.log("🔑 Available keys in response:",Object.keys(d)),console.log("=== BACKEND MAPPING VERIFICATION ===");const g=JSON.stringify(d).toLowerCase();console.log("🔍 Backend Feature Name Analysis:"),console.log('  Contains "fast":',g.includes("fast")),console.log('  Contains "ed":',g.includes("ed")),console.log('  Contains "fast_ed":',g.includes("fast_ed")),console.log('  Contains "systolic":',g.includes("systolic")),console.log('  Contains "diastolic":',g.includes("diastolic")),console.log('  Contains "gfap":',g.includes("gfap")),console.log('  Contains "age":',g.includes("age")),console.log('  Contains "headache":',g.includes("headache")),console.log("🧠 ICH driver sources:"),console.log("  response.ich_prediction?.drivers:",(i=d.ich_prediction)==null?void 0:i.drivers),console.log("  response.ich_drivers:",d.ich_drivers),console.log("  response.ich?.drivers:",(s=d.ich)==null?void 0:s.drivers),console.log("  response.drivers?.ich:",(n=d.drivers)==null?void 0:n.ich),console.log("🩸 LVO driver sources:"),console.log("  response.lvo_prediction?.drivers:",(o=d.lvo_prediction)==null?void 0:o.drivers),console.log("  response.lvo_drivers:",d.lvo_drivers),console.log("  response.lvo?.drivers:",(c=d.lvo)==null?void 0:c.drivers),console.log("  response.drivers?.lvo:",(l=d.drivers)==null?void 0:l.lvo),Object.keys(d).forEach(D=>{const w=d[D];typeof w=="number"&&w>=0&&w<=1&&console.log(`Potential probability field: ${D} = ${w}`)});const p=V(d,"ICH"),y=V(d,"LVO"),f=U(d,"ICH"),u=U(d,"LVO"),h=W(d,"ICH"),ee=W(d,"LVO");return console.log("✅ Clean extraction results:"),console.log("  ICH:",{probability:p,hasDrivers:!!f}),console.log("  LVO:",{probability:y,hasDrivers:!!u}),{ich:{probability:p,drivers:f,confidence:h,module:"Full Stroke"},lvo:{probability:y,drivers:u,confidence:ee,module:"Full Stroke"}}}catch(d){throw console.error("Full Stroke prediction failed:",d),new v(`Failed to get stroke predictions: ${d.message}`,d.status,k.FULL_STROKE)}}function Re(a){m.logEvent("triage1_answer",{comatose:a}),I(a?"coma":"triage2")}function Me(a){m.logEvent("triage2_answer",{examinable:a}),I(a?"full":"limited")}function I(a){m.logEvent("navigate",{from:m.getState().currentScreen,to:a}),m.navigate(a),window.scrollTo(0,0)}function Be(){m.hasUnsavedData()&&!confirm("Are you sure you want to start over? All entered data will be lost.")||(m.logEvent("reset"),m.reset())}function Ie(){console.log("goBack() called");const a=m.goBack();console.log("goBack() success:",a),a?(m.logEvent("navigate_back"),window.scrollTo(0,0)):(console.log("No history available, going home instead"),X())}function X(){console.log("goHome() called"),m.logEvent("navigate_home"),m.goHome(),window.scrollTo(0,0)}async function De(a,t){a.preventDefault();const e=a.target,i=e.dataset.module,s=Te(e);if(!s.isValid){Ee(t,s.validationErrors);return}const n={};Array.from(e.elements).forEach(l=>{if(l.name)if(l.type==="checkbox")n[l.name]=l.checked;else if(l.type==="number"){const d=parseFloat(l.value);n[l.name]=isNaN(d)?0:d}else l.type==="hidden"&&l.name==="armparese"?n[l.name]=l.value==="true":n[l.name]=l.value}),console.log("Collected form inputs:",n),m.setFormData(i,n);const o=e.querySelector("button[type=submit]"),c=o?o.innerHTML:"";o&&(o.disabled=!0,o.innerHTML=`<span class="loading-spinner"></span> ${r("analyzing")}`);try{let l;switch(i){case"coma":l={ich:await $e(n),lvo:null};break;case"limited":l={ich:await Ne(n),lvo:{notPossible:!0}};break;case"full":l=await Pe(n);break;default:throw new Error("Unknown module: "+i)}m.setResults(l),m.logEvent("models_complete",{module:i,results:l}),I("results")}catch(l){console.error("Error running models:",l);let d="An error occurred during analysis. Please try again.";l instanceof v&&(d=l.message),_e(t,d),o&&(o.disabled=!1,o.innerHTML=c)}}function _e(a,t){a.querySelectorAll(".critical-alert").forEach(s=>{var n,o;(o=(n=s.querySelector("h4"))==null?void 0:n.textContent)!=null&&o.includes("Error")&&s.remove()});const e=document.createElement("div");e.className="critical-alert",e.innerHTML=`<h4><span class="alert-icon">⚠️</span> Error</h4><p>${t}</p>`;const i=a.querySelector(".container");i?i.prepend(e):a.prepend(e),setTimeout(()=>e.remove(),1e4)}function Fe(a){const t=document.createElement("div");t.className="sr-only",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");const e={triage1:"Coma assessment",triage2:"Examination capability assessment",coma:"Coma module",limited:"Limited data module",full:"Full stroke assessment",results:"Assessment results"};t.textContent=`Navigated to ${e[a]||a}`,document.body.appendChild(t),setTimeout(()=>t.remove(),1e3)}function He(a){const t={triage1:"Initial Assessment - Stroke Triage Assistant",triage2:"Examination Capability - Stroke Triage Assistant",coma:"Coma Module - Stroke Triage Assistant",limited:"Limited Data Module - Stroke Triage Assistant",full:"Full Stroke Module - Stroke Triage Assistant",results:"Assessment Results - Stroke Triage Assistant"};document.title=t[a]||"Stroke Triage Assistant"}function xe(){setTimeout(()=>{const a=document.querySelector("h2");a&&(a.setAttribute("tabindex","-1"),a.focus(),setTimeout(()=>a.removeAttribute("tabindex"),100))},100)}class Oe{constructor(){this.scores={facial_palsy:0,arm_weakness:0,speech_changes:0,eye_deviation:0,denial_neglect:0},this.onApply=null,this.modal=null}getTotal(){return Object.values(this.scores).reduce((t,e)=>t+e,0)}getRiskLevel(){return this.getTotal()>=4?"high":"low"}render(){const t=this.getTotal(),e=this.getRiskLevel();return`
    ...
    `,t.appendChild(e),document.body.appendChild(t);const i=t.querySelector("#updateNow"),s=t.querySelector("#updateLater");i.addEventListener("click",()=>{window.location.reload()}),s.addEventListener("click",()=>{t.remove(),setTimeout(()=>this.showUpdateNotification(),5*60*1e3)}),t.addEventListener("click",n=>{n.target===t&&s.click()})}destroy(){this.unsubscribe&&this.unsubscribe()}}const We=new Ve;We.init();
//# sourceMappingURL=index-DmkI3h_x.js.map
