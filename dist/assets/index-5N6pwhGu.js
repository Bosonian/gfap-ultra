var Ie=Object.defineProperty;var De=(t,e,i)=>e in t?Ie(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var V=(t,e,i)=>De(t,typeof e!="symbol"?e+"":e,i);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function i(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(s){if(s.ep)return;s.ep=!0;const n=i(s);fetch(s.href,n)}})();class _e{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{},screenHistory:[]},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}notify(){this.listeners.forEach(e=>e(this.state))}getState(){return{...this.state}}setState(e){this.state={...this.state,...e},this.notify()}navigate(e){console.log(`Navigating from ${this.state.currentScreen} to ${e}`);const i=[...this.state.screenHistory];this.state.currentScreen!==e&&!i.includes(this.state.currentScreen)&&i.push(this.state.currentScreen),this.setState({currentScreen:e,screenHistory:i})}goBack(){const e=[...this.state.screenHistory];if(console.log("goBack() - current history:",e),console.log("goBack() - current screen:",this.state.currentScreen),e.length>0){const i=e.pop();return console.log("goBack() - navigating to:",i),this.setState({currentScreen:i,screenHistory:e}),!0}return console.log("goBack() - no history available"),!1}goHome(){this.setState({currentScreen:"triage1",screenHistory:[]})}setFormData(e,i){const a={...this.state.formData};a[e]={...i},this.setState({formData:a})}getFormData(e){return this.state.formData[e]||{}}setValidationErrors(e){this.setState({validationErrors:e})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(e){this.setState({results:e})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const e={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{},screenHistory:[]};this.setState(e),console.log("Store reset with new session:",e.sessionId)}logEvent(e,i={}){const a={timestamp:Date.now(),session:this.state.sessionId,event:e,data:i};console.log("Event:",a)}getSessionDuration(){return Date.now()-this.state.startTime}}const b=new _e;function P(t){const e=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let i='<div class="progress-indicator">';return e.forEach((a,s)=>{const n=a.id===t,r=a.id<t;i+=`
  ...
  `}const A={COMA_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_coma_ich",LDM_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_limited_data_ich",FULL_STROKE:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_full_stroke"},ve={ich:{medium:25,high:50},lvo:{medium:25,high:50}},w={min:29,max:10001},Y={autoSaveInterval:18e4,sessionTimeout:30*60*1e3,requestTimeout:1e4},Be={age_years:{required:!0,min:0,max:120},systolic_bp:{required:!0,min:60,max:300},diastolic_bp:{required:!0,min:30,max:200},gfap_value:{required:!0,min:w.min,max:w.max},fast_ed_score:{required:!0,min:0,max:9}};function xe(){return`
    <div class="container">
      ${P(2)}
  ...
  `;const p=n.reduce((m,u)=>m+Math.abs(u.weight),0);n.length>0?n.forEach(m=>{const u=p>0?Math.abs(m.weight)/p*100:0,h=Math.abs(m.weight)/d*100,f=q(m.label);g+=`
      ...
      `}):g+=`<div class="no-factors">${o("noPositiveFactors")}</div>`,g+=`
        ...
        <div class="drivers-column negative-column">
          ...
          <div class="compact-drivers">
  `;const v=r.reduce((m,u)=>m+Math.abs(u.weight),0);return r.length>0?r.forEach(m=>{const u=v>0?Math.abs(m.weight)/v*100:0,h=Math.abs(m.weight)/d*100,f=q(m.label);g+=`
        <div class="compact-driver-item">
          <div class="compact-driver-label">${f}</div>
  ...
  `;try{const d=ye[n.state],g=[...d.neurosurgicalCenters,...d.comprehensiveStrokeCenters,...d.regionalStrokeUnits,...d.thrombolysisHospitals||[]],p=n.destination;p.distance=U(t,e,p.coordinates.lat,p.coordinates.lng);try{const u=await ce(t,e,p.coordinates.lat,p.coordinates.lng);p.travelTime=u.duration,p.travelSource=u.source}catch{p.travelTime=Math.round(p.distance/.8),p.travelSource="estimated"}const v=g.filter(u=>u.id!==p.id).map(u=>({...u,distance:U(t,e,u.coordinates.lat,u.coordinates.lng)})).sort((u,h)=>u.distance-h.distance).slice(0,3);for(const u of v)try{const h=await ce(t,e,u.coordinates.lat,u.coordinates.lng);u.travelTime=h.duration,u.travelSource=h.source}catch{u.travelTime=Math.round(u.distance/.8),u.travelSource="estimated"}const m=`
      <div class="location-info">
        <p><strong>${o("yourLocation")}:</strong> ${t.toFixed(4)}, ${e.toFixed(4)}</p>
    ...
    `;a.innerHTML=m}catch(d){console.warn("Enhanced routing failed, using basic display:",d),a.innerHTML=`
      <div class="location-info">
        <p><strong>${o("yourLocation")}:</strong> ${t.toFixed(4)}, ${e.toFixed(4)}</p>
        ${r}
      </div>
...
`)}static exportAsJSON(){const e=this.getStoredData();return JSON.stringify(e,null,2)}static downloadData(e="csv"){try{const i=e==="csv"?this.exportAsCSV():this.exportAsJSON(),a=`igfap-research-${Date.now()}.${e}`,s=new Blob([i],{type:e==="csv"?"text/csv":"application/json"}),n=URL.createObjectURL(s),r=document.createElement("a");return r.href=n,r.download=a,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(n),console.log(`📥 Downloaded research data: ${a}`),!0}catch(i){return console.error("Failed to download research data:",i),!1}}static clearData(){try{return localStorage.removeItem(this.STORAGE_KEY),console.log("🗑️ Research data cleared"),!0}catch(e){return console.warn("Failed to clear research data:",e),!1}}static getDataSummary(){var n,r;const e=this.getStoredData();if(!e.entries||e.entries.length===0)return{totalEntries:0,dateRange:null,avgDifference:null};const i=e.entries,a=i.map(c=>{var l,d;return(d=(l=c.comparison)==null?void 0:l.differences)==null?void 0:d.absolute}).filter(c=>c!=null),s=a.length>0?a.reduce((c,l)=>c+Math.abs(l),0)/a.length:0;return{totalEntries:i.length,dateRange:{first:(n=i[0])==null?void 0:n.timestamp,last:(r=i[i.length-1])==null?void 0:r.timestamp},avgAbsoluteDifference:Math.round(s*10)/10,storageSize:JSON.stringify(e).length}}static generateEntryId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}static getSessionId(){let e=sessionStorage.getItem("research_session_id");return e||(e="session_"+Date.now().toString(36),sessionStorage.setItem("research_session_id",e)),e}}V(R,"STORAGE_KEY","igfap_research_data"),V(R,"MAX_ENTRIES",1e3);function lt(t,e,i){try{if(!M())return;const a={inputs:{age:i.age_years||i.age,gfap:i.gfap_value||i.gfap,module:t.module||"unknown"},main:{probability:t.probability,module:t.module,confidence:t.confidence},legacy:e,comparison:e?x.compareModels(t,e):null};R.logComparison(a)}catch(a){console.warn("Research logging failed (non-critical):",a)}}function M(t=null){var e;if(t==="coma")return!1;if(t==="limited"||t==="full")return!0;if(typeof window<"u")try{const i=window.store||((e=require("../state/store.js"))==null?void 0:e.store);if(i){const a=i.getState().formData;return a.limited||a.full}}catch{}return!1}function we(){return""}function Le(t,e,i){if(!(e!=null&&e.isValid))return console.log("🔬 Legacy model results invalid:",e),`
  ...
  `}function vt(t,e,i,a,s,n){var te,ie,ae,se;const r=Math.round(((t==null?void 0:t.probability)||0)*100),c=Math.round(((e==null?void 0:e.probability)||0)*100),l=t&&t.probability>.6?fe():"",d=ke(),g=Ee(),p=M(n)?we():"",v=s&&M(n)?Le(t,s,F()):"",m=b.getState(),u=parseInt((ie=(te=m.formData)==null?void 0:te.full)==null?void 0:ie.fast_ed_score)||0;console.log("🔍 Debug LVO Display:"),console.log("  Current Module:",n),console.log("  FAST-ED Score:",u),console.log("  FAST-ED Raw:",(se=(ae=m.formData)==null?void 0:ae.full)==null?void 0:se.fast_ed_score),console.log("  LVO Data:",e),console.log("  LVO notPossible:",e==null?void 0:e.notPossible),console.log("  LVO Probability:",e==null?void 0:e.probability),console.log("  ICH Module:",t==null?void 0:t.module);const h=n==="full"||(t==null?void 0:t.module)==="Full",f=e&&typeof e.probability=="number"&&!e.notPossible,y=h&&u>3&&f;console.log("  Conditions: isFullModule:",h),console.log("  Conditions: fastEdScore > 3:",u>3),console.log("  Conditions: hasValidLVO:",f),console.log("  Show LVO Card:",y);const k=r>=50,S=c/Math.max(r,.5),I=S>=.6&&S<=1.7,K=h&&r>=50&&c>=50&&I,H=h&&r>=50&&c>=50&&!I,ee=h&&r>=30&&c>=30;console.log("🎯 Tachometer conditions:",{isFullModule:h,ichPercent:r,lvoPercent:c,ratio:S.toFixed(2),inRatioBand:I,showTachometer:K,showDominanceBanner:H});let O=1;y&&O++,k&&O++;const Pe=O===1?"risk-results-single":O===2?"risk-results-dual":"risk-results-triple",Re=Te(t.probability);return`
    <div class="container">
      ${P(3)}
  ...
  `}function ft(t,e,i){const a=i>1?"LVO":"ICH",s=a==="LVO"?"🧠":"🩸",n=L.getCurrentLanguage()==="de"?a==="LVO"?"LVO-dominant":"ICH-dominant":a==="LVO"?"LVO dominant":"ICH dominant",r=L.getCurrentLanguage()==="de"?`Verhältnis LVO/ICH: ${i.toFixed(2)}`:`LVO/ICH ratio: ${i.toFixed(2)}`;return`
  ...
  `}function yt(t){try{const e=F();if(console.log("🔍 Legacy calculation inputs:",e),!e.age||!e.gfap)return console.warn("🔍 Missing required inputs for legacy model:",{age:e.age,gfap:e.gfap}),null;const i=ot(e);return console.log("🔍 Legacy calculation result:",i),i}catch(e){return console.warn("Legacy model calculation failed (non-critical):",e),null}}function F(){const e=b.getState().formData;console.log("🔍 Debug formData structure:",e);let i=null,a=null;for(const n of["coma","limited","full"])e[n]&&(console.log(`🔍 ${n} module data:`,e[n]),i=i||e[n].age_years,a=a||e[n].gfap_value);const s={age:parseInt(i)||null,gfap:parseFloat(a)||null};return console.log("🔍 Extracted patient inputs:",s),s}function Te(t){return Math.round(t*100)>25?`
    ...
    `:""}function kt(t){const e=Math.round(t*100),i=L.getCurrentLanguage()==="de";return e>25?`
      <div class="alternative-diagnosis-card">
        <div class="diagnosis-header">
          <span class="lightning-icon">⚡</span>
  ...
  `}function wt(t,e){const i=e/Math.max(t,1);return`
    <div class="tachometer-section">
      <div class="tachometer-card">
...
//# sourceMappingURL=index-5N6pwhGu.js.map
