(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function e(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=e(a);fetch(a.href,r)}})();class x{constructor(){this.state={currentScreen:"triage1",results:null,sessionId:null,startTime:null,formData:{},validationErrors:{}},this.listeners=new Set,this.initialize()}initialize(){this.state.sessionId=this.generateSessionId(),this.state.startTime=Date.now(),console.log("Store initialized with session:",this.state.sessionId)}generateSessionId(){return"session_"+Date.now()+"_"+Math.random().toString(36).substr(2,9)}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}notify(){this.listeners.forEach(t=>t(this.state))}getState(){return{...this.state}}setState(t){this.state={...this.state,...t},this.notify()}navigate(t){console.log(`Navigating from ${this.state.currentScreen} to ${t}`),this.setState({currentScreen:t})}setFormData(t,e){const n={...this.state.formData};n[t]={...e},this.setState({formData:n})}getFormData(t){return this.state.formData[t]||{}}setValidationErrors(t){this.setState({validationErrors:t})}clearValidationErrors(){this.setState({validationErrors:{}})}setResults(t){this.setState({results:t})}hasUnsavedData(){return Object.keys(this.state.formData).length>0&&!this.state.results}reset(){const t={currentScreen:"triage1",results:null,sessionId:this.generateSessionId(),startTime:Date.now(),formData:{},validationErrors:{}};this.setState(t),console.log("Store reset with new session:",t.sessionId)}logEvent(t,e={}){const n={timestamp:Date.now(),session:this.state.sessionId,event:t,data:e};console.log("Event:",n)}getSessionDuration(){return Date.now()-this.state.startTime}}const d=new x;function f(i){const t=[{id:1,label:"Triage"},{id:2,label:"Assessment"},{id:3,label:"Results"}];let e='<div class="progress-indicator">';return t.forEach((n,a)=>{const r=n.id===i,s=n.id<i;e+=`
  ...
  `}const b={COMA_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_coma_ich",LDM_ICH:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_limited_data_ich",FULL_STROKE:"https://europe-west3-igfap-452720.cloudfunctions.net/predict_full_stroke"},S={ich:{high:60,critical:80},lvo:{high:50,critical:70}},g={min:29,max:10001},L={autoSaveInterval:3e4,sessionTimeout:30*60*1e3,requestTimeout:1e4},R={age_years:{required:!0,min:0,max:120},systolic_bp:{required:!0,min:60,max:300},diastolic_bp:{required:!0,min:30,max:200},gfap_value:{required:!0,min:g.min,max:g.max},fast_ed_score:{required:!0,min:0,max:9}};function N(){return`
    <div class="container">
      ${f(2)}
      <h2>Coma Module</h2>
  ...
  `}function O(i){return!i||typeof i!="object"?{kind:"unavailable",units:null,positive:[],negative:[],meta:{}}:i.kind?i:i.shap_values||i.kind&&i.kind==="shap_values"?U(i):i.logistic_contributions||i.kind&&i.kind==="logistic_contributions"?q(i):V(i)?K(i):{kind:"unavailable",units:null,positive:[],negative:[],meta:{}}}function U(i){const t=i.shap_values||i,e=[];Array.isArray(t)?t.forEach((s,c)=>{typeof s=="object"&&s.feature&&s.value!==void 0?e.push({label:s.feature,weight:s.value}):typeof s=="number"&&e.push({label:`Feature ${c}`,weight:s})}):typeof t=="object"&&Object.entries(t).forEach(([s,c])=>{typeof c=="number"&&e.push({label:s,weight:c})}),e.sort((s,c)=>Math.abs(c.weight)-Math.abs(s.weight));const n=e.filter(s=>s.weight>0),a=e.filter(s=>s.weight<0),r={};return i.base_value!==void 0&&(r.base_value=i.base_value),i.contrib_sum!==void 0&&(r.contrib_sum=i.contrib_sum),i.logit_total!==void 0&&(r.logit_total=i.logit_total),{kind:"shap_values",units:"logit",positive:n,negative:a,meta:r}}function q(i){const t=i.logistic_contributions||i,e=[];typeof t=="object"&&Object.entries(t).forEach(([s,c])=>{typeof c=="number"&&!["intercept","contrib_sum","logit_total"].includes(s)&&e.push({label:s,weight:c})}),e.sort((s,c)=>Math.abs(c.weight)-Math.abs(s.weight));const n=e.filter(s=>s.weight>0),a=e.filter(s=>s.weight<0),r={};return t.intercept!==void 0&&(r.base_value=t.intercept),t.contrib_sum!==void 0&&(r.contrib_sum=t.contrib_sum),t.logit_total!==void 0&&(r.logit_total=t.logit_total),i.contrib_sum!==void 0&&(r.contrib_sum=i.contrib_sum),{kind:"logistic_contributions",units:"logit",positive:n,negative:a,meta:r}}function K(i){const t=[];Object.entries(i).forEach(([a,r])=>{typeof r=="number"&&t.push({label:a,weight:r})}),t.sort((a,r)=>Math.abs(r.weight)-Math.abs(a.weight));const e=t.filter(a=>a.weight>0),n=t.filter(a=>a.weight<0);return{kind:"raw_weights",units:null,positive:e,negative:n,meta:{}}}function V(i){return Object.values(i).every(t=>typeof t=="number")}function j(i,t){if(!(i!=null&&i.drivers)&&!(t!=null&&t.drivers))return"";let e=`
    <div class="drivers-section">
      <h3>Prediction Drivers</h3>
      <div class="drivers-grid">
  `;return i!=null&&i.drivers&&(e+=I(i.drivers,"ICH","ich")),t!=null&&t.drivers&&!t.notPossible&&(e+=I(t.drivers,"LVO","lvo")),e+=`
      </div>
    </div>
  `,e}function I(i,t,e){if(!i||Object.keys(i).length===0)return`
    ...
    `;const n=O(i);if(n.kind==="unavailable")return`
      <div class="drivers-panel">
        <h4>
          <span class="driver-icon ${e}">${e==="ich"?"I":"L"}</span>
          ${t} Risk Factors
  ...
  `}function X(i){const t=document.getElementById("useGpsButton"),e=document.getElementById("manualLocationButton"),n=document.querySelector(".location-manual"),a=document.getElementById("locationInput"),r=document.getElementById("searchLocationButton"),s=document.getElementById("strokeCenterResults");t&&t.addEventListener("click",()=>{ee(i,s)}),e&&e.addEventListener("click",()=>{n.style.display=n.style.display==="none"?"block":"none"}),r&&r.addEventListener("click",()=>{const c=a.value.trim();c&&$(c,i,s)}),a&&a.addEventListener("keypress",c=>{if(c.key==="Enter"){const m=a.value.trim();m&&$(m,i,s)}})}function ee(i,t){if(!navigator.geolocation){w(o("geolocationNotSupported"),t);return}t.innerHTML=`<div class="loading">${o("gettingLocation")}...</div>`,navigator.geolocation.getCurrentPosition(e=>{const{latitude:n,longitude:a}=e.coords;te(n,a,i,t)},e=>{let n=o("locationError");switch(e.code){case e.PERMISSION_DENIED:n=o("locationPermissionDenied");break;case e.POSITION_UNAVAILABLE:n=o("locationUnavailable");break;case e.TIMEOUT:n=o("locationTimeout");break}w(n,t)},{enableHighAccuracy:!0,timeout:1e4,maximumAge:3e5})}async function $(i,t,e){e.innerHTML=`<div class="loading">${o("searchingLocation")}...</div>`,w(o("geocodingNotImplemented"),e)}function te(i,t,e,n){const a=ie(e),r=J(i,t,a),s=`
  ...
  `;n.innerHTML=s}function M(i,t=!1){return!i||i.length===0?`<p>${o("noCentersFound")}</p>`:i.map(e=>`
  ...
  `}function P(i,t){const e=Number(i),n=S[t];return e>=n.critical?"🔴 CRITICAL RISK":e>=n.high?"🟠 HIGH RISK":e>=30?"🟡 MODERATE RISK":"🟢 LOW RISK"}function ne(i,t){const{ich:e,lvo:n}=i;let a="",r="";if(e){const l=Math.round(e.probability*100);a=`
      <div class="result-card ${l>S.ich.critical?"critical":"ich"}">
        ...
        <p><strong>${o("riskLevel")}:</strong> ${P(l,"ich")}</p>
      </div>
    `}if(n)if(n.notPossible)r=`
      ...
      `;else{const l=Math.round(n.probability*100);r=`
        <div class="result-card ${l>S.lvo.critical?"critical":"lvo"}">
          ...
          <p><strong>${o("riskLevel")}:</strong> ${P(l,"lvo")}</p>
        </div>
      `}const s=e&&e.probability>.6?G():"",c=j(e,n),m=Q();return`
    <div class="container">
      ${f(3)}
  ...
  `}function ae(i,t,e){const n=[];return e.required&&!t&&t!==0&&n.push("This field is required"),e.min!==void 0&&t!==""&&!isNaN(t)&&parseFloat(t)<e.min&&n.push(`Value must be at least ${e.min}`),e.max!==void 0&&t!==""&&!isNaN(t)&&parseFloat(t)>e.max&&n.push(`Value must be at most ${e.max}`),e.pattern&&!e.pattern.test(t)&&n.push("Invalid format"),n}function re(i){let t=!0;const e={};return Object.entries(R).forEach(([n,a])=>{const r=i.elements[n];if(r){const s=ae(n,r.value,a);s.length>0&&(e[n]=s,t=!1)}}),{isValid:t,validationErrors:e}}function se(i,t){Object.entries(t).forEach(([e,n])=>{const a=i.querySelector(`[name="${e}"]`);if(a){const r=a.closest(".input-group");if(r){r.classList.add("error"),r.querySelectorAll(".error-message").forEach(c=>c.remove());const s=document.createElement("div");s.className="error-message",s.innerHTML=`<span class="error-icon">⚠️</span> ${n[0]}`,r.appendChild(s)}}})}function oe(i){i.querySelectorAll(".input-group.error").forEach(t=>{t.classList.remove("error"),t.querySelectorAll(".error-message").forEach(e=>e.remove())})}class p extends Error{constructor(t,e,n){super(t),this.name="APIError",this.status=e,this.url=n}}function E(i){const t={...i};return Object.keys(t).forEach(e=>{const n=t[e];(typeof n=="boolean"||n==="on"||n==="true"||n==="false")&&(t[e]=n===!0||n==="on"||n==="true"?1:0)}),t}async function T(i,t){const e=new AbortController,n=setTimeout(()=>e.abort(),L.requestTimeout);try{const a=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t),signal:e.signal,mode:"cors"});if(clearTimeout(n),!a.ok){let s=`HTTP ${a.status}`;try{const c=await a.json();s=c.error||c.message||s}catch{s=`${s}: ${a.statusText}`}throw new p(s,a.status,i)}return await a.json()}catch(a){throw clearTimeout(n),a.name==="AbortError"?new p("Request timeout - please try again",408,i):a instanceof p?a:new p("Network error - please check your connection and try again",0,i)}}async function le(i){const t=E(i);try{const e=await T(b.COMA_ICH,t);return{probability:e.probability||e.ich_probability,drivers:e.drivers||null,confidence:e.confidence||.75,module:"Coma"}}catch(e){throw console.error("Coma ICH prediction failed:",e),new p(`Failed to get ICH prediction: ${e.message}`,e.status,b.COMA_ICH)}}async function ce(i){const t=E(i);try{const e=await T(b.LDM_ICH,t);return{probability:e.probability||e.ich_probability,drivers:e.drivers||null,confidence:e.confidence||.65,module:"Limited Data"}}catch(e){throw console.error("Limited Data ICH prediction failed:",e),new p(`Failed to get ICH prediction: ${e.message}`,e.status,b.LDM_ICH)}}async function de(i){var n,a,r,s,c,m;const t={age_years:i.age_years,systolic_bp:i.systolic_bp,diastolic_bp:i.diastolic_bp,gfap_value:i.gfap_value,fast_ed_score:i.fast_ed_score,headache:i.headache||0,vigilanzminderung:i.vigilanzminderung||0,armparese:i.armparese||0,beinparese:i.beinparese||0,eye_deviation:i.eye_deviation||0,atrial_fibrillation:i.atrial_fibrillation||0,anticoagulated_noak:i.anticoagulated_noak||0,antiplatelets:i.antiplatelets||0},e=E(t);try{const l=await T(b.FULL_STROKE,e),u={probability:l.ich_probability||((n=l.ich)==null?void 0:n.probability),drivers:l.ich_drivers||((a=l.ich)==null?void 0:a.drivers),confidence:l.ich_confidence||((r=l.ich)==null?void 0:r.confidence)||.85,module:"Full Stroke"},h={probability:l.lvo_probability||((s=l.lvo)==null?void 0:s.probability),drivers:l.lvo_drivers||((c=l.lvo)==null?void 0:c.drivers),confidence:l.lvo_confidence||((m=l.lvo)==null?void 0:m.confidence)||.85,module:"Full Stroke"};return{ich:u,lvo:h}}catch(l){throw console.error("Full Stroke prediction failed:",l),new p(`Failed to get stroke predictions: ${l.message}`,l.status,b.FULL_STROKE)}}function ue(i){d.logEvent("triage1_answer",{comatose:i}),D(i?"coma":"triage2")}function me(i){d.logEvent("triage2_answer",{examinable:i}),D(i?"full":"limited")}function D(i){d.logEvent("navigate",{from:d.getState().currentScreen,to:i}),d.navigate(i),window.scrollTo(0,0)}function ge(){d.hasUnsavedData()&&!confirm("Are you sure you want to start over? All entered data will be lost.")||(d.logEvent("reset"),d.reset())}async function pe(i,t){i.preventDefault();const e=i.target,n=e.dataset.module,a=re(e);if(!a.isValid){se(t,a.validationErrors);return}const r=new FormData(e),s={};r.forEach((l,u)=>{const h=e.elements[u];if(h&&h.type==="checkbox")s[u]=h.checked;else{const C=parseFloat(l);s[u]=isNaN(C)?l:C}}),d.setFormData(n,s);const c=e.querySelector("button[type=submit]"),m=c?c.innerHTML:"";c&&(c.disabled=!0,c.innerHTML=`<span class="loading-spinner"></span> ${o("analyzing")}`);try{let l;switch(n){case"coma":l={ich:await le(s),lvo:null};break;case"limited":l={ich:await ce(s),lvo:{notPossible:!0}};break;case"full":l=await de(s);break;default:throw new Error("Unknown module: "+n)}d.setResults(l),d.logEvent("models_complete",{module:n,results:l}),D("results")}catch(l){console.error("Error running models:",l);let u="An error occurred during analysis. Please try again.";l instanceof p&&(u=l.message),he(t,u),c&&(c.disabled=!1,c.innerHTML=m)}}function he(i,t){i.querySelectorAll(".critical-alert").forEach(a=>{var r,s;(s=(r=a.querySelector("h4"))==null?void 0:r.textContent)!=null&&s.includes("Error")&&a.remove()});const e=document.createElement("div");e.className="critical-alert",e.innerHTML=`<h4><span class="alert-icon">⚠️</span> Error</h4><p>${t}</p>`;const n=i.querySelector(".container");n?n.prepend(e):i.prepend(e),setTimeout(()=>e.remove(),1e4)}function be(i){const t=document.createElement("div");t.className="sr-only",t.setAttribute("role","status"),t.setAttribute("aria-live","polite");const e={triage1:"Coma assessment",triage2:"Examination capability assessment",coma:"Coma module",limited:"Limited data module",full:"Full stroke assessment",results:"Assessment results"};t.textContent=`Navigated to ${e[i]||i}`,document.body.appendChild(t),setTimeout(()=>t.remove(),1e3)}function fe(i){const t={triage1:"Initial Assessment - Stroke Triage Assistant",triage2:"Examination Capability - Stroke Triage Assistant",coma:"Coma Module - Stroke Triage Assistant",limited:"Limited Data Module - Stroke Triage Assistant",full:"Full Stroke Module - Stroke Triage Assistant",results:"Assessment Results - Stroke Triage Assistant"};document.title=t[i]||"Stroke Triage Assistant"}function ve(){setTimeout(()=>{const i=document.querySelector("h2");i&&(i.setAttribute("tabindex","-1"),i.focus(),setTimeout(()=>i.removeAttribute("tabindex"),100))},100)}function y(i){const t=d.getState(),{currentScreen:e,results:n,startTime:a}=t;i.innerHTML="";let r="";switch(e){case"triage1":r=_();break;case"triage2":r=F();break;case"coma":r=N();break;case"limited":r=H();break;case"full":r=z();break;case"results":r=ne(n);break;default:r=_()}i.innerHTML=r;const s=i.querySelector("form[data-module]");if(s){const c=s.dataset.module;ye(s,c)}ke(i),e==="results"&&n&&setTimeout(()=>{X(n)},100),be(e),fe(e),ve()}function ye(i,t){const e=d.getFormData(t);!e||Object.keys(e).length===0||Object.entries(e).forEach(([n,a])=>{const r=i.elements[n];r&&(r.type==="checkbox"?r.checked=a===!0||a==="on"||a==="true":r.value=a)})}function ke(i){i.querySelectorAll('input[type="number"]').forEach(e=>{e.addEventListener("blur",()=>{oe(i)})}),i.querySelectorAll("[data-action]").forEach(e=>{e.addEventListener("click",n=>{const{action:a,value:r}=n.currentTarget.dataset,s=r==="true";switch(a){case"triage1":ue(s);break;case"triage2":me(s);break;case"reset":ge();break}})}),i.querySelectorAll("form[data-module]").forEach(e=>{e.addEventListener("submit",n=>{pe(n,i)})});const t=i.querySelector("#printResults");t&&t.addEventListener("click",()=>window.print())}class Se{constructor(){this.container=null,this.unsubscribe=null}async init(){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.init());return}if(this.container=document.getElementById("appContainer"),!this.container){console.error("App container not found");return}this.unsubscribe=d.subscribe(()=>{y(this.container)}),window.addEventListener("languageChanged",()=>{this.updateUILanguage(),y(this.container)}),this.setupGlobalEventListeners(),this.initializeTheme(),this.updateUILanguage(),this.startAutoSave(),this.setupSessionTimeout(),this.setCurrentYear(),y(this.container),console.log("Stroke Triage Assistant initialized")}setupGlobalEventListeners(){const t=document.getElementById("languageToggle");t&&t.addEventListener("click",()=>this.toggleLanguage());const e=document.getElementById("darkModeToggle");e&&e.addEventListener("click",()=>this.toggleDarkMode()),this.setupHelpModal(),this.setupFooterLinks(),document.addEventListener("keydown",n=>{if(n.key==="Escape"){const a=document.getElementById("helpModal");a&&a.classList.contains("show")&&(a.classList.remove("show"),a.setAttribute("aria-hidden","true"))}}),window.addEventListener("beforeunload",n=>{d.hasUnsavedData()&&(n.preventDefault(),n.returnValue="You have unsaved data. Are you sure you want to leave?")})}setupHelpModal(){const t=document.getElementById("helpButton"),e=document.getElementById("helpModal"),n=e==null?void 0:e.querySelector(".modal-close");t&&e&&(t.addEventListener("click",()=>{e.classList.add("show"),e.setAttribute("aria-hidden","false")}),n==null||n.addEventListener("click",()=>{e.classList.remove("show"),e.setAttribute("aria-hidden","true")}),e.addEventListener("click",a=>{a.target===e&&(e.classList.remove("show"),e.setAttribute("aria-hidden","true"))}))}setupFooterLinks(){var t,e;(t=document.getElementById("privacyLink"))==null||t.addEventListener("click",n=>{n.preventDefault(),this.showPrivacyPolicy()}),(e=document.getElementById("disclaimerLink"))==null||e.addEventListener("click",n=>{n.preventDefault(),this.showDisclaimer()})}initializeTheme(){const t=localStorage.getItem("theme"),e=document.getElementById("darkModeToggle");(t==="dark"||!t&&window.matchMedia("(prefers-color-scheme: dark)").matches)&&(document.body.classList.add("dark-mode"),e&&(e.textContent="☀️"))}toggleLanguage(){k.toggleLanguage(),this.updateUILanguage()}updateUILanguage(){document.documentElement.lang=k.getCurrentLanguage();const t=document.querySelector(".app-header h1");t&&(t.textContent=o("appTitle"));const e=document.querySelector(".emergency-badge");e&&(e.textContent=o("emergencyBadge"));const n=document.getElementById("languageToggle");n&&(n.title=o("languageToggle"),n.setAttribute("aria-label",o("languageToggle")));const a=document.getElementById("helpButton");a&&(a.title=o("helpButton"),a.setAttribute("aria-label",o("helpButton")));const r=document.getElementById("darkModeToggle");r&&(r.title=o("darkModeButton"),r.setAttribute("aria-label",o("darkModeButton")));const s=document.getElementById("modalTitle");s&&(s.textContent=o("helpTitle"))}toggleDarkMode(){const t=document.getElementById("darkModeToggle");document.body.classList.toggle("dark-mode");const e=document.body.classList.contains("dark-mode");t&&(t.textContent=e?"☀️":"🌙"),localStorage.setItem("theme",e?"dark":"light")}startAutoSave(){setInterval(()=>{this.saveCurrentFormData()},L.autoSaveInterval)}saveCurrentFormData(){this.container.querySelectorAll("form[data-module]").forEach(e=>{const n=new FormData(e),a=e.dataset.module;if(a){const r={};n.forEach((m,l)=>{const u=e.elements[l];u&&u.type==="checkbox"?r[l]=u.checked:r[l]=m});const s=d.getFormData(a);JSON.stringify(s)!==JSON.stringify(r)&&d.setFormData(a,r)}})}setupSessionTimeout(){setTimeout(()=>{confirm("Your session has been idle for 30 minutes. Would you like to continue?")?this.setupSessionTimeout():d.reset()},L.sessionTimeout)}setCurrentYear(){const t=document.getElementById("currentYear");t&&(t.textContent=new Date().getFullYear())}showPrivacyPolicy(){alert("Privacy Policy: This tool processes data locally. No patient data is stored or transmitted.")}showDisclaimer(){alert("Medical Disclaimer: This tool is for clinical decision support only. Always use clinical judgment and follow local protocols.")}destroy(){this.unsubscribe&&this.unsubscribe()}}const Le=new Se;Le.init();
//# sourceMappingURL=index-Bvo1vHae.js.map
