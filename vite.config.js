    ...
    rollupOptions: {
      output: {
        ...
        manualChunks: id => {
          ...
          if (
            id.includes("src/state/store.js") ||
          ...
          if (
            id.includes("src/logic/ich-volume-calculator.js") ||
          ...
          if (
            id.includes("src/ui/components/brain-visualization.js") ||
          ...
          if (id.includes("src/research/") || id.includes("src/analytics/")) {
            return "research-tools";
          }

          // Security and performance chunk
          if (
            id.includes("src/security/") ||
