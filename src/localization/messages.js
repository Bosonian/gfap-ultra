...
export const messages = {
  en: {
    ...
    legalStatusResearchPrototype: "Research prototype without CE marking",
    legalStatusNotDiagnostic: "Not for diagnostic or therapeutic decisions",
    dataPrivacySecurity: "Data Privacy & Security",
    dataPrivacyNoStorage: "No storage of personal data",
    dataPrivacyLocalProcessing: "Local processing in compliance with GDPR",
    dataPrivacyEncryption: "End-to-end encryption",
    scientificSupervision: "Scientific Supervision",
    scientificSupervisorForech: "Prof. Dr. Christian Förch (Neurology)",
    clinicalCollaboration: "Clinical Collaboration",
    clinicalCollaboratorKalra: "Dr. Lovepreet Kalra (Assistant Physician, Neurology)",
    developmentResponsibility: "Development & Responsibility",
    developmentDeveloperBos: "Deepak Bos, Assistant Physician (bosdeepak@gmail.com)",
    contact: "Contact",
  ...
  de: {
    ...
    legalStatusResearchPrototype: "Forschungsprototyp ohne CE-Kennzeichnung",
    legalStatusNotDiagnostic: "Nicht für diagnostische oder therapeutische Entscheidungen",
    dataPrivacySecurity: "Datenschutz & Sicherheit",
    dataPrivacyNoStorage: "Keine Speicherung personenbezogener Daten",
    dataPrivacyLocalProcessing: "Lokale Verarbeitung gemäß DSGVO",
    dataPrivacyEncryption: "Ende-zu-Ende-Verschlüsselung",
    scientificSupervision: "Wissenschaftliche Aufsicht",
    scientificSupervisorForech: "Prof. Dr. Christian Förch (Neurologie)",
    clinicalCollaboration: "Klinische Mitarbeit",
    clinicalCollaboratorKalra: "Dr. Lovepreet Kalra (Assistenzärztin, Neurologie)",
    developmentResponsibility: "Entwicklung & Verantwortung",
    developmentDeveloperBos: "Deepak Bos, Assistenzarzt (bosdeepak@gmail.com)",
    contact: "Kontakt",
    ...
    rememberThisDevice: "Dieses Gerät merken",
    ...
    backToCaseList: "Zurück zur Fallliste",
    ...
    selectHospital: "Zielkrankenhaus auswählen",
